...
Create Function [fnFactureFournisseur_Details_Full]
...
From [dbo].[FactureFournisseur_Details] [FactureFournisseur_Details]
    Inner Join [dbo].[FactureFournisseur] [FactureFournisseur1] On [FactureFournisseur_Details].[FactureID] = [FactureFournisseur1].[ID]
        Left Outer Join [dbo].[Compte] [Compte2] On [FactureFournisseur_Details].[Compte] = [Compte2].[ID]

Where

    ((@FactureID Is Null) Or ([FactureFournisseur_Details].[FactureID] = @FactureID))
And ((@Ligne Is Null) Or ([FactureFournisseur_Details].[Ligne] = @Ligne))
And ((@Compte Is Null) Or ([FactureFournisseur_Details].[Compte] = @Compte))
)
