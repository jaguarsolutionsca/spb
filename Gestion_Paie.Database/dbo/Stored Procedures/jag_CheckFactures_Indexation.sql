...
CREATE PROCEDURE dbo.jag_CheckFactures_Indexation
	(
		@Annee int,
...
IF (LEN(@Erreurs) > 0)
BEGIN
	SET @Erreurs = '[PARAMÊTRES SYSTÈME]%1' + @Erreurs
END

INSERT INTO @Usines
SELECT DISTINCT
INF.[UsineID]
FROM dbo.jag_GetIndexationsNonFactures (@UsineID, @IndexationID) INF
