...
CREATE PROCEDURE dbo.jag_GetNext_ContingentementID
	(
		@ID int = NULL output
...
If @ContingentUsine = 1
	Begin
		...
		ORDER BY UsineID ASC, EssenceID ASC, UniteMesureID ASC, PeriodeContingentement ASC
...
Begin
		...
		AND ([ContingentUsine] = @ContingentUsine)
		ORDER BY RegroupementID ASC, UniteMesureID ASC, PeriodeContingentement ASC
