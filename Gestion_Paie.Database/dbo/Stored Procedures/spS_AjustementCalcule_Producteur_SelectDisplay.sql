...
Create Procedure [spS_AjustementCalcule_Producteur_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[AjustementCalcule_Producteur_Records].[AjustementID_Display]
		,[AjustementCalcule_Producteur_Records].[EssenceID]
		,[AjustementCalcule_Producteur_Records].[EssenceID_Display]
		,[AjustementCalcule_Producteur_Records].[UniteID]
		,[AjustementCalcule_Producteur_Records].[UniteID_Display]
		,[AjustementCalcule_Producteur_Records].[LivraisonDetailID]
		,[AjustementCalcule_Producteur_Records].[LivraisonDetailID_Display]
		,[AjustementCalcule_Producteur_Records].[ProducteurID]
		,[AjustementCalcule_Producteur_Records].[ProducteurID_Display]
		...
		,[AjustementCalcule_Producteur_Records].[FactureID_Display]
		...
		,[AjustementCalcule_Producteur_Records].[Code_Display]

		From [fnAjustementCalcule_Producteur_SelectDisplay](@ID, @AjustementID, @EssenceID, @UniteID, @LivraisonDetailID, @ProducteurID, @FactureID, @Code) As [AjustementCalcule_Producteur_Records]
	End
