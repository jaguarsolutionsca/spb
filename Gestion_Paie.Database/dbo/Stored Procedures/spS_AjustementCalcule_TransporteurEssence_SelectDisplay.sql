Create Procedure [dbo].[spS_AjustementCalcule_TransporteurEssence_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[AjustementCalcule_TransporteurEssence_Records].[AjustementID_Display]
		,[AjustementCalcule_TransporteurEssence_Records].[EssenceID]
		,[AjustementCalcule_TransporteurEssence_Records].[EssenceID_Display]
		,[AjustementCalcule_TransporteurEssence_Records].[UniteID]
		,[AjustementCalcule_TransporteurEssence_Records].[UniteID_Display]
		,[AjustementCalcule_TransporteurEssence_Records].[LivraisonDetailID]
		,[AjustementCalcule_TransporteurEssence_Records].[LivraisonDetailID_Display]
		,[AjustementCalcule_TransporteurEssence_Records].[TransporteurID]
		,[AjustementCalcule_TransporteurEssence_Records].[TransporteurID_Display]
		...
		,[AjustementCalcule_TransporteurEssence_Records].[FactureID_Display]
		...
		,[AjustementCalcule_TransporteurEssence_Records].[Code_Display]

		From [fnAjustementCalcule_TransporteurEssence_SelectDisplay](@ID, @AjustementID, @EssenceID, @UniteID, @LivraisonDetailID, @TransporteurID, @FactureID, @Code) As [AjustementCalcule_TransporteurEssence_Records]
	End
