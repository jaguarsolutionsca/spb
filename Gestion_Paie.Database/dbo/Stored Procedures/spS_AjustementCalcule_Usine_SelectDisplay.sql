...
Create Procedure [spS_AjustementCalcule_Usine_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[AjustementCalcule_Usine_Records].[AjustementID_Display]
		,[AjustementCalcule_Usine_Records].[EssenceID]
		,[AjustementCalcule_Usine_Records].[EssenceID_Display]
		,[AjustementCalcule_Usine_Records].[UniteID]
		,[AjustementCalcule_Usine_Records].[UniteID_Display]
		,[AjustementCalcule_Usine_Records].[LivraisonDetailID]
		,[AjustementCalcule_Usine_Records].[LivraisonDetailID_Display]
		,[AjustementCalcule_Usine_Records].[UsineID]
		,[AjustementCalcule_Usine_Records].[UsineID_Display]
		...
		,[AjustementCalcule_Usine_Records].[FactureID_Display]
		...
		,[AjustementCalcule_Usine_Records].[Code_Display]

		From [fnAjustementCalcule_Usine_SelectDisplay](@ID, @AjustementID, @EssenceID, @UniteID, @LivraisonDetailID, @UsineID, @FactureID, @Code) As [AjustementCalcule_Usine_Records]
	End
