CREATE Procedure [dbo].[spS_Ajustement_EssenceUnite_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Ajustement_EssenceUnite_Records].[AjustementID_Display]
		,[Ajustement_EssenceUnite_Records].[EssenceID]
		,[Ajustement_EssenceUnite_Records].[EssenceID_Display]
		,[Ajustement_EssenceUnite_Records].[UniteID]
		,[Ajustement_EssenceUnite_Records].[UniteID_Display]
		,[Ajustement_EssenceUnite_Records].[ContratID]
		,[Ajustement_EssenceUnite_Records].[ContratID_Display]
		...
		,[Ajustement_EssenceUnite_Records].[Code_Display]

		From [fnAjustement_EssenceUnite_SelectDisplay](@AjustementID, @EssenceID, @UniteID, @Code, @ContratID) As [Ajustement_EssenceUnite_Records]
	End
