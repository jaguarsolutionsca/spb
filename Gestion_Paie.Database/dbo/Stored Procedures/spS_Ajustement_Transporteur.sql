...
Create Procedure [spS_Ajustement_Transporteur]
...
If @ReturnXML = 0
	Begin
		...
		From [fnAjustement_Transporteur](@AjustementID, @UniteID, @MunicipaliteID, @ZoneID, @ContratID) As [Ajustement_Transporteur_Records]
	End
