CREATE PROCEDURE [dbo].[spS_Cert_Proprietaire_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Cert_Proprietaire_Records].[FournisseurID_Display]
		,[Cert_Proprietaire_Records].[FournisseurNom]
		,[Cert_Proprietaire_Records].[Traite]
		,[Cert_Proprietaire_Records].[Methode]

		From [fnCert_Proprietaire_SelectDisplay](@Agence, @NO_ACT, @FournisseurID) As [Cert_Proprietaire_Records]
	End
