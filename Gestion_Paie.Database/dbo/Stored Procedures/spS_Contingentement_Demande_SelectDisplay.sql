...
CREATE Procedure [spS_Contingentement_Demande_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Contingentement_Demande_Records].[ProducteurID_Display]
		,[Contingentement_Demande_Records].[TransporteurID]
		,[Contingentement_Demande_Records].[TransporteurID_Display]
		...
		From [fnContingentement_Demande_SelectDisplay](@ID, @ProducteurID, @TransporteurID) As [Contingentement_Demande_Records]
	End
