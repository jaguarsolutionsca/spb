CREATE PROCEDURE [dbo].[spS_Contingentement_Producteur]
...
If @ReturnXML = 0
	Begin
		...
		From [fnContingentement_Producteur](@ContingentementID, @ProducteurID) As [Contingentement_Producteur_Records]
	End
