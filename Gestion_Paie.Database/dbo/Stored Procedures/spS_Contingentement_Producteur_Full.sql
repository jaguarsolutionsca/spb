CREATE PROCEDURE [dbo].[spS_Contingentement_Producteur_Full]
...
If @ReturnXML = 0
	Begin
		...
		From [fnContingentement_Producteur_Full](@ContingentementID, @ProducteurID) As [Contingentement_Producteur_Records]
	End
