...
Create Procedure [spS_Contingentement_Unite_Full]

/*
Retrieve specific records from the [Contingentement_Unite] table, as well as all its foreign tables, depending on the input parameters you supply:
...
If @ReturnXML = 0
	Begin
		...
		From [fnContingentement_Unite_Full](@ContingentementID, @UniteID) As [Contingentement_Unite_Records]
	End
