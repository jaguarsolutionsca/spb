...
Create Procedure [spS_Contingentement_Unite_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Contingentement_Unite_Records].[ContingentementID_Display]
		,[Contingentement_Unite_Records].[UniteID]
		,[Contingentement_Unite_Records].[UniteID_Display]
		,[Contingentement_Unite_Records].[Facteur]

		From [fnContingentement_Unite_SelectDisplay](@ContingentementID, @UniteID) As [Contingentement_Unite_Records]
	End
