...
CREATE Procedure [spS_Contingentement_VolumeFixe]
...
If @ReturnXML = 0
	Begin
		...
		From [fnContingentement_VolumeFixe](@ContingentementID, @Superficie_Min) As [Contingentement_VolumeFixe_Records]
	End
