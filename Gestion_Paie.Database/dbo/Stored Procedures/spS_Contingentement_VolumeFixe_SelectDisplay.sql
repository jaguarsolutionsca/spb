...
Create Procedure [spS_Contingentement_VolumeFixe_SelectDisplay]

-- Retrieve specific records from the [Contingentement_VolumeFixe] table depending on the input parameters you supply.
...
If @ReturnXML = 0
	Begin
		...
		,[Contingentement_VolumeFixe_Records].[ContingentementID_Display]
		...
		From [fnContingentement_VolumeFixe_SelectDisplay](@ContingentementID, @Superficie_Min) As [Contingentement_VolumeFixe_Records]
	End
