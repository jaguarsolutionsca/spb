...
Create Procedure [spS_Contrat_EssenceUnite_SelectDisplay]

-- Retrieve specific records from the [Contrat_EssenceUnite] table depending on the input parameters you supply.
...
If @ReturnXML = 0
	Begin
		...
		,[Contrat_EssenceUnite_Records].[ContratID_Display]
		,[Contrat_EssenceUnite_Records].[EssenceID]
		,[Contrat_EssenceUnite_Records].[EssenceID_Display]
		,[Contrat_EssenceUnite_Records].[UniteID]
		,[Contrat_EssenceUnite_Records].[UniteID_Display]
		...
		From [fnContrat_EssenceUnite_SelectDisplay](@ContratID, @EssenceID, @UniteID, @Code) As [Contrat_EssenceUnite_Records]
	End
