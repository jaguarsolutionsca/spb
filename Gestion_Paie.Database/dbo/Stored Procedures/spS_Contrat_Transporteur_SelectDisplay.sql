...
Create Procedure [spS_Contrat_Transporteur_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Contrat_Transporteur_Records].[ContratID_Display]
		,[Contrat_Transporteur_Records].[UniteID]
		,[Contrat_Transporteur_Records].[UniteID_Display]
		,[Contrat_Transporteur_Records].[MunicipaliteID]
		,[Contrat_Transporteur_Records].[MunicipaliteID_Display]
		...
		,[Contrat_Transporteur_Records].[ZoneID_Display]

		From [fnContrat_Transporteur_SelectDisplay](@ContratID, @UniteID, @MunicipaliteID, @ZoneID) As [Contrat_Transporteur_Records]
	End
