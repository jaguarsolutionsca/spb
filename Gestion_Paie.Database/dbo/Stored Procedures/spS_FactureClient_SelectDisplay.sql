...
Create Procedure [spS_FactureClient_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[FactureClient_Records].[TypeFacture_Display]
		,[FactureClient_Records].[TypeInvoiceClientAcomba]
		,[FactureClient_Records].[TypeInvoiceClientAcomba_Display]
		,[FactureClient_Records].[ClientID]
		,[FactureClient_Records].[ClientID_Display]
		,[FactureClient_Records].[PayerAID]
		,[FactureClient_Records].[PayerAID_Display]
		...
		,[FactureClient_Records].[Status_Display]
		,[FactureClient_Records].[StatusDescription]
		,[FactureClient_Records].[DateFactureAcomba]

		From [fnFactureClient_SelectDisplay](@ID, @TypeFacture, @TypeInvoiceClientAcomba, @ClientID, @PayerAID, @Status) As [FactureClient_Records]
	End
