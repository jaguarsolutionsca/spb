...
Create Procedure [spS_FactureFournisseur]
...
If @ReturnXML = 0
	Begin
		...
		From [fnFactureFournisseur](@ID, @TypeFactureFournisseur, @TypeFacture, @TypeInvoiceAcomba, @FournisseurID, @PayerAID) As [FactureFournisseur_Records]
	End
