...
Create Procedure [spS_FactureFournisseur_Sommaire_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[FactureFournisseur_Sommaire_Records].[FactureID_Display]
		,[FactureFournisseur_Sommaire_Records].[Ligne]
		,[FactureFournisseur_Sommaire_Records].[Compte]
		,[FactureFournisseur_Sommaire_Records].[Compte_Display]
		...
		From [fnFactureFournisseur_Sommaire_SelectDisplay](@FactureID, @Ligne, @Compte) As [FactureFournisseur_Sommaire_Records]
	End
