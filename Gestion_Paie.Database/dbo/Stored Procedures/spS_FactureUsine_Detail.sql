CREATE PROCEDURE [dbo].[spS_FactureUsine_Detail]
...
If @ReturnXML = 0
	Begin
		...
		From [fnFactureUsine_Detail](@ID, @FactureUsineID, @ProducteurID, @ProducteurEntentePaiementID, @ZoneID, @MunicipaliteID, @LotID, @UniteMesureID, @LivraisonID, @EssenceID) As [FactureUsine_Detail_Records]
	End
