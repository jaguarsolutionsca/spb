...
Create Procedure [spS_FactureUsine_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[FactureUsine_Records].[Annee_Display]
		,[FactureUsine_Records].[Periode]
		,[FactureUsine_Records].[Periode_Display]
		,[FactureUsine_Records].[ContratID]
		,[FactureUsine_Records].[ContratID_Display]
		...
		From [fnFactureUsine_SelectDisplay](@ID, @Annee, @Periode, @ContratID) As [FactureUsine_Records]
	End
