CREATE Procedure [dbo].[spS_Fournisseur_SelectDisplay]

-- Retrieve specific records from the [Fournisseur] table depending on the input parameters you supply.
...
If @ReturnXML = 0
	Begin
		...
		,[Fournisseur_Records].[PaysID_Display]
		...
		,[Fournisseur_Records].[InstitutionBanquaireID_Display]
		...
		From [fnFournisseur_SelectDisplay](@ID, @PaysID, @InstitutionBanquaireID) As [Fournisseur_Records]
	End
