...
Create Procedure [spS_IndexationCalcule_Producteur]
...
If @ReturnXML = 0
	Begin
		...
		From [fnIndexationCalcule_Producteur](@ID, @TypeIndexation, @IndexationID, @IndexationDetailID, @LivraisonID, @LivraisonDetailID, @ProducteurID, @ContratID, @EssenceID, @Code, @UniteID, @FactureID) As [IndexationCalcule_Producteur_Records]
	End
