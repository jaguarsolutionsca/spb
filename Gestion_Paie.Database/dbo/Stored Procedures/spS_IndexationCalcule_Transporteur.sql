...
Create Procedure [spS_IndexationCalcule_Transporteur]
...
If @ReturnXML = 0
	Begin
		...
		From [fnIndexationCalcule_Transporteur](@ID, @TypeIndexation, @IndexationID, @IndexationDetailID, @LivraisonID, @TransporteurID, @FactureID) As [IndexationCalcule_Transporteur_Records]
	End
