...
CREATE Procedure [spS_Indexation_EssenceUnite]
...
If @ReturnXML = 0
	Begin
		...
		From [fnIndexation_EssenceUnite](@ID, @IndexationID, @ContratID, @EssenceID, @Code, @UniteID) As [Indexation_EssenceUnite_Records]
	End
