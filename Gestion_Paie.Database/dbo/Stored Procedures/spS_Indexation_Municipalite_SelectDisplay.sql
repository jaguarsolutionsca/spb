...
CREATE Procedure [spS_Indexation_Municipalite_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Indexation_Municipalite_Records].[IndexationID_Display]
		,[Indexation_Municipalite_Records].[MunicipaliteID]
		,[Indexation_Municipalite_Records].[MunicipaliteID_Display]
		,[Indexation_Municipalite_Records].[Montant]
		,[Indexation_Municipalite_Records].[ZoneID]
		,[Indexation_Municipalite_Records].[ZoneID_Display]

		From [fnIndexation_Municipalite_SelectDisplay](@ID, @IndexationID, @MunicipaliteID, @ZoneID) As [Indexation_Municipalite_Records]
	End
