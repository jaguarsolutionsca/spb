...
Create Procedure [spS_Indexation_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		From [fnIndexation_SelectDisplay](@ID, @ContratID, @TypeIndexation) As [Indexation_Records]
	End
