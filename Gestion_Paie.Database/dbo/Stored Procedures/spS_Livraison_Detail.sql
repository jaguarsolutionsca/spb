...
Create Procedure [spS_Livraison_Detail]
...
If @ReturnXML = 0
	Begin
		...
		From [fnLivraison_Detail](@ID, @LivraisonID, @ContratID, @EssenceID, @UniteMesureID, @ProducteurID, @ContingentementID, @Code) As [Livraison_Detail_Records]
	End
