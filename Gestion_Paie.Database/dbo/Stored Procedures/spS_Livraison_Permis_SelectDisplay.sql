...
Create Procedure [spS_Livraison_Permis_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Livraison_Permis_Records].[LivraisonID_Display]
		,[Livraison_Permis_Records].[PermisID]
		,[Livraison_Permis_Records].[PermisID_Display]
		,[Livraison_Permis_Records].[NumeroFactureUsine]

		From [fnLivraison_Permis_SelectDisplay](@LivraisonID, @PermisID) As [Livraison_Permis_Records]
	End
