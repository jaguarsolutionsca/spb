CREATE PROCEDURE [dbo].[spS_Livraison_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Livraison_Records].[Annee_Display]
		,[Livraison_Records].[Periode]
		,[Livraison_Records].[Periode_Display]
		...
		,[Livraison_Records].[Producteur1_FactureID_Display]
		,[Livraison_Records].[Producteur2_FactureID]
		,[Livraison_Records].[Producteur2_FactureID_Display]
		,[Livraison_Records].[Transporteur_FactureID]
		,[Livraison_Records].[Transporteur_FactureID_Display]
		,[Livraison_Records].[Usine_FactureID]
		,[Livraison_Records].[Usine_FactureID_Display]
		,[Livraison_Records].[ErreurCalcul]
		,[Livraison_Records].[ErreurDescription]
		,[Livraison_Records].[LotID]
		,[Livraison_Records].[LotID_Display]
		...
		,[Livraison_Records].[ZoneID_Display]
		,[Livraison_Records].[MunicipaliteID]
		,[Livraison_Records].[MunicipaliteID_Display]
		,[Livraison_Records].[ChargeurID]
		,[Livraison_Records].[ChargeurID_Display]
		...
		,[Livraison_Records].[Chargeur_FactureID_Display]
		...
		From [fnLivraison_SelectDisplay](@ID, @ContratID, @UniteMesureID, @EssenceID, @DroitCoupeID, @EntentePaiementID, @TransporteurID, @Annee, @Periode, @Producteur1_FactureID, @Producteur2_FactureID, @Transporteur_FactureID, @Usine_FactureID, @LotID, @ZoneID, @MunicipaliteID, @ChargeurID, @Chargeur_FactureID) As [Livraison_Records]
	End
