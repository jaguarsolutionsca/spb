...
Create Procedure [spS_Lot_Proprietaire_Full]

/*
Retrieve specific records from the [Lot_Proprietaire] table, as well as all its foreign tables, depending on the input parameters you supply:
...
If @ReturnXML = 0
	Begin
		...
		From [fnLot_Proprietaire_Full](@ProprietaireID, @DateDebut, @LotID) As [Lot_Proprietaire_Records]
	End
