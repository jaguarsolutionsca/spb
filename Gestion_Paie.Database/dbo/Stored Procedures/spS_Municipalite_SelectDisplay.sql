...
Create Procedure [spS_Municipalite_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Municipalite_Records].[MrcID_Display]
		,[Municipalite_Records].[AgenceID]
		,[Municipalite_Records].[AgenceID_Display]
		,[Municipalite_Records].[Actif]

		From [fnMunicipalite_SelectDisplay](@ID, @MrcID, @AgenceID) As [Municipalite_Records]
	End
