...
Create Procedure [spS_Municipalite_Zone_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Municipalite_Zone_Records].[MunicipaliteID_Display]
		,[Municipalite_Zone_Records].[Description]
		,[Municipalite_Zone_Records].[Actif]

		From [fnMunicipalite_Zone_SelectDisplay](@ID, @MunicipaliteID) As [Municipalite_Zone_Records]
	End
