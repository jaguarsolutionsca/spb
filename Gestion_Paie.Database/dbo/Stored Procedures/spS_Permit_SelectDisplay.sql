...
Create Procedure [spS_Permit_SelectDisplay]
...
If @ReturnXML = 0
	Begin
		...
		,[Permit_Records].[ContratID_Display]
		,[Permit_Records].[EssenceID]
		,[Permit_Records].[EssenceID_Display]
		,[Permit_Records].[PermitSciage]
		,[Permit_Records].[TransporteurID]
		,[Permit_Records].[TransporteurID_Display]
		,[Permit_Records].[VR]
		,[Permit_Records].[ProducteurDroitCoupeID]
		,[Permit_Records].[ProducteurDroitCoupeID_Display]
		,[Permit_Records].[ProducteurEntentePaiementID]
		,[Permit_Records].[ProducteurEntentePaiementID_Display]
		,[Permit_Records].[PermitLivre]
		,[Permit_Records].[PermitImprime]
		,[Permit_Records].[PermitAnnule]
		,[Permit_Records].[LotID]
		,[Permit_Records].[LotID_Display]
		,[Permit_Records].[EssenceSciage]
		,[Permit_Records].[Code]
		,[Permit_Records].[Remarques]
		,[Permit_Records].[ChargeurID]
		,[Permit_Records].[ChargeurID_Display]
		,[Permit_Records].[ZoneID]
		,[Permit_Records].[ZoneID_Display]
		,[Permit_Records].[MunicipaliteID]
		,[Permit_Records].[MunicipaliteID_Display]

		From [fnPermit_SelectDisplay](@ID, @ContratID, @EssenceID, @TransporteurID, @ProducteurDroitCoupeID, @ProducteurEntentePaiementID, @LotID, @ChargeurID, @ZoneID, @MunicipaliteID) As [Permit_Records]
	End
