...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [Agence] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_Agence {

		Params.spS_Agence Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_Agence class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_Agence(string connectionString) {
			...
			this.Param = new Params.spS_Agence(true);
		...
		public Abstract_Agence(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_Agence(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [Agence] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_ID) {
			...
			SPs.spS_Agence SP = new SPs.spS_Agence(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_Agence.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_Agence.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Agence.Resultset1.Fields.Column_Actif.ColumnIndex)) {

						this.col_Actif = DR.GetSqlBoolean(SPs.spS_Agence.Resultset1.Fields.Column_Actif.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_Agence", "Refresh");
			}
		}
	}
}
