...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [AjustementCalcule_Usine] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_AjustementCalcule_Usine {

		Params.spS_AjustementCalcule_Usine Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_AjustementCalcule_Usine class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_AjustementCalcule_Usine(string connectionString) {
			...
			this.Param = new Params.spS_AjustementCalcule_Usine(true);
		...
		public Abstract_AjustementCalcule_Usine(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_AjustementCalcule_Usine(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [AjustementCalcule_Usine] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_AjustementCalcule_Usine SP = new SPs.spS_AjustementCalcule_Usine(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_DateCalcul.ColumnIndex)) {

						this.col_DateCalcul = DR.GetSqlDateTime(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_DateCalcul.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_AjustementID.ColumnIndex)) {

						this.col_AjustementID = DR.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_AjustementID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_EssenceID.ColumnIndex)) {

						this.col_EssenceID = DR.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_EssenceID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UniteID.ColumnIndex)) {

						this.col_UniteID = DR.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UniteID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_LivraisonDetailID.ColumnIndex)) {

						this.col_LivraisonDetailID = DR.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_LivraisonDetailID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UsineID.ColumnIndex)) {

						this.col_UsineID = DR.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UsineID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Volume.ColumnIndex)) {

						this.col_Volume = DR.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Volume.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Taux.ColumnIndex)) {

						this.col_Taux = DR.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Taux.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Montant.ColumnIndex)) {

						this.col_Montant = DR.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Montant.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Facture.ColumnIndex)) {

						this.col_Facture = DR.GetSqlBoolean(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Facture.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_FactureID.ColumnIndex)) {

						this.col_FactureID = DR.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_FactureID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex)) {

						this.col_ErreurCalcul = DR.GetSqlBoolean(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurDescription.ColumnIndex)) {

						this.col_ErreurDescription = DR.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurDescription.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Code.ColumnIndex)) {

						this.col_Code = DR.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Code.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_AjustementCalcule_Usine", "Refresh");
			}
		}
	}
}
