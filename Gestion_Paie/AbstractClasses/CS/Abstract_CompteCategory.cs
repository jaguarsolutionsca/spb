...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [CompteCategory] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_CompteCategory {

		Params.spS_CompteCategory Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_CompteCategory class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_CompteCategory(string connectionString) {
			...
			this.Param = new Params.spS_CompteCategory(true);
		...
		public Abstract_CompteCategory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_CompteCategory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [CompteCategory] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_CompteCategory SP = new SPs.spS_CompteCategory(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_CompteCategory.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_CompteCategory.Resultset1.Fields.Column_Description.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_CompteCategory", "Refresh");
			}
		}
	}
}
