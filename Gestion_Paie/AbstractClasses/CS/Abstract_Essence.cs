...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [Essence] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_Essence {

		Params.spS_Essence Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_Essence class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_Essence(string connectionString) {
			...
			this.Param = new Params.spS_Essence(true);
		...
		public Abstract_Essence(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_Essence(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		private System.Data.SqlTypes.SqlInt32 col_ContingentID;
		/// <summary>
		...
		private System.Data.SqlTypes.SqlInt32 col_RepartitionID;
		/// <summary>
		/// Returns the value of the RepartitionID column.
		/// More info on this column: Update this description in the &quot;Olymars/Description&quot; extended property of the &quot;RepartitionID&quot; column.
		/// </summary>
		...
		/// <summary>
		/// Allows you to load a specific record of the [Essence] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_ID) {
			...
			SPs.spS_Essence SP = new SPs.spS_Essence(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_Essence.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_Essence.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Essence.Resultset1.Fields.Column_RegroupementID.ColumnIndex)) {

						this.col_RegroupementID = DR.GetSqlInt32(SPs.spS_Essence.Resultset1.Fields.Column_RegroupementID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Essence.Resultset1.Fields.Column_ContingentID.ColumnIndex)) {

						this.col_ContingentID = DR.GetSqlInt32(SPs.spS_Essence.Resultset1.Fields.Column_ContingentID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Essence.Resultset1.Fields.Column_RepartitionID.ColumnIndex)) {

						this.col_RepartitionID = DR.GetSqlInt32(SPs.spS_Essence.Resultset1.Fields.Column_RepartitionID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Essence.Resultset1.Fields.Column_Actif.ColumnIndex)) {

						this.col_Actif = DR.GetSqlBoolean(SPs.spS_Essence.Resultset1.Fields.Column_Actif.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_Essence", "Refresh");
			}
		}
	}
}
