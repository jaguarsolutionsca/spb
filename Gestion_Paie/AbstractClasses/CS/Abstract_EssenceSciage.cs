...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [EssenceSciage] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_EssenceSciage {

		Params.spS_EssenceSciage Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_EssenceSciage class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_EssenceSciage(string connectionString) {
			...
			this.Param = new Params.spS_EssenceSciage(true);
		...
		public Abstract_EssenceSciage(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_EssenceSciage(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [EssenceSciage] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_EssenceSciage SP = new SPs.spS_EssenceSciage(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_EssenceSciage.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_EssenceSciage.Resultset1.Fields.Column_Description.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_EssenceSciage", "Refresh");
			}
		}
	}
}
