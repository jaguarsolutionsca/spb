...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [FactureClient_Sommaire] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_FactureClient_Sommaire {

		Params.spS_FactureClient_Sommaire Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_FactureClient_Sommaire class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_FactureClient_Sommaire(string connectionString) {
			...
			this.Param = new Params.spS_FactureClient_Sommaire(true);
		...
		public Abstract_FactureClient_Sommaire(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_FactureClient_Sommaire(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [FactureClient_Sommaire] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_FactureID, System.Data.SqlTypes.SqlInt32 col_Ligne) {
			...
			SPs.spS_FactureClient_Sommaire SP = new SPs.spS_FactureClient_Sommaire(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Compte.ColumnIndex)) {

						this.col_Compte = DR.GetSqlInt32(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Compte.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Montant.ColumnIndex)) {

						this.col_Montant = DR.GetSqlDouble(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Montant.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_isTaxe.ColumnIndex)) {

						this.col_isTaxe = DR.GetSqlBoolean(SPs.spS_FactureClient_Sommaire.Resultset1.Fields.Column_isTaxe.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_FactureClient_Sommaire", "Refresh");
			}
		}
	}
}
