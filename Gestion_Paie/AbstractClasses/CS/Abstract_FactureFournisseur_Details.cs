...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [FactureFournisseur_Details] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_FactureFournisseur_Details {

		Params.spS_FactureFournisseur_Details Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_FactureFournisseur_Details class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_FactureFournisseur_Details(string connectionString) {
			...
			this.Param = new Params.spS_FactureFournisseur_Details(true);
		...
		public Abstract_FactureFournisseur_Details(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_FactureFournisseur_Details(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [FactureFournisseur_Details] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_FactureID, System.Data.SqlTypes.SqlInt32 col_Ligne) {
			...
			SPs.spS_FactureFournisseur_Details SP = new SPs.spS_FactureFournisseur_Details(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_Compte.ColumnIndex)) {

						this.col_Compte = DR.GetSqlInt32(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_Compte.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_Montant.ColumnIndex)) {

						this.col_Montant = DR.GetSqlDouble(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_Montant.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_RefID.ColumnIndex)) {

						this.col_RefID = DR.GetSqlInt32(SPs.spS_FactureFournisseur_Details.Resultset1.Fields.Column_RefID.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_FactureFournisseur_Details", "Refresh");
			}
		}
	}
}
