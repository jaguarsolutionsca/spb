...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [GestionVolume] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_GestionVolume {

		Params.spS_GestionVolume Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_GestionVolume class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_GestionVolume(string connectionString) {
			...
			this.Param = new Params.spS_GestionVolume(true);
		...
		public Abstract_GestionVolume(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_GestionVolume(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		private System.Data.SqlTypes.SqlDateTime col_DateEntree;
		/// <summary>
		/// Returns the value of the DateEntree column.
		/// More info on this column: Update this description in the &quot;Olymars/Description&quot; extended property of the &quot;DateEntree&quot; column.
		/// </summary>
		...
		/// <summary>
		/// Allows you to load a specific record of the [GestionVolume] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_GestionVolume SP = new SPs.spS_GestionVolume(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_DateLivraison.ColumnIndex)) {

						this.col_DateLivraison = DR.GetSqlDateTime(SPs.spS_GestionVolume.Resultset1.Fields.Column_DateLivraison.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_UsineID.ColumnIndex)) {

						this.col_UsineID = DR.GetSqlString(SPs.spS_GestionVolume.Resultset1.Fields.Column_UsineID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_UniteMesureID.ColumnIndex)) {

						this.col_UniteMesureID = DR.GetSqlString(SPs.spS_GestionVolume.Resultset1.Fields.Column_UniteMesureID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_ProducteurID.ColumnIndex)) {

						this.col_ProducteurID = DR.GetSqlString(SPs.spS_GestionVolume.Resultset1.Fields.Column_ProducteurID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_Annee.ColumnIndex)) {

						this.col_Annee = DR.GetSqlInt32(SPs.spS_GestionVolume.Resultset1.Fields.Column_Annee.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_Periode.ColumnIndex)) {

						this.col_Periode = DR.GetSqlInt32(SPs.spS_GestionVolume.Resultset1.Fields.Column_Periode.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_LotID.ColumnIndex)) {

						this.col_LotID = DR.GetSqlInt32(SPs.spS_GestionVolume.Resultset1.Fields.Column_LotID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_GestionVolume.Resultset1.Fields.Column_DateEntree.ColumnIndex)) {

						this.col_DateEntree = DR.GetSqlDateTime(SPs.spS_GestionVolume.Resultset1.Fields.Column_DateEntree.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_GestionVolume", "Refresh");
			}
		}
	}
}
