...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [IndexationCalcule_Transporteur] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_IndexationCalcule_Transporteur {

		Params.spS_IndexationCalcule_Transporteur Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_IndexationCalcule_Transporteur class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_IndexationCalcule_Transporteur(string connectionString) {
			...
			this.Param = new Params.spS_IndexationCalcule_Transporteur(true);
		...
		public Abstract_IndexationCalcule_Transporteur(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_IndexationCalcule_Transporteur(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [IndexationCalcule_Transporteur] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_IndexationCalcule_Transporteur SP = new SPs.spS_IndexationCalcule_Transporteur(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_DateCalcul.ColumnIndex)) {

						this.col_DateCalcul = DR.GetSqlDateTime(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_DateCalcul.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_TypeIndexation.ColumnIndex)) {

						this.col_TypeIndexation = DR.GetSqlString(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_TypeIndexation.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_IndexationID.ColumnIndex)) {

						this.col_IndexationID = DR.GetSqlInt32(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_IndexationID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_IndexationDetailID.ColumnIndex)) {

						this.col_IndexationDetailID = DR.GetSqlInt32(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_IndexationDetailID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_LivraisonID.ColumnIndex)) {

						this.col_LivraisonID = DR.GetSqlInt32(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_LivraisonID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_TransporteurID.ColumnIndex)) {

						this.col_TransporteurID = DR.GetSqlString(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_TransporteurID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_MontantDejaPaye.ColumnIndex)) {

						this.col_MontantDejaPaye = DR.GetSqlDouble(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_MontantDejaPaye.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_PourcentageDuMontant.ColumnIndex)) {

						this.col_PourcentageDuMontant = DR.GetSqlDouble(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_PourcentageDuMontant.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_Montant.ColumnIndex)) {

						this.col_Montant = DR.GetSqlDouble(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_Montant.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_Facture.ColumnIndex)) {

						this.col_Facture = DR.GetSqlBoolean(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_Facture.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_FactureID.ColumnIndex)) {

						this.col_FactureID = DR.GetSqlInt32(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_FactureID.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex)) {

						this.col_ErreurCalcul = DR.GetSqlBoolean(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_ErreurDescription.ColumnIndex)) {

						this.col_ErreurDescription = DR.GetSqlString(SPs.spS_IndexationCalcule_Transporteur.Resultset1.Fields.Column_ErreurDescription.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_IndexationCalcule_Transporteur", "Refresh");
			}
		}
	}
}
