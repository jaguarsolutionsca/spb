...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [MRC] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_MRC {

		Params.spS_MRC Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_MRC class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_MRC(string connectionString) {
			...
			this.Param = new Params.spS_MRC(true);
		...
		public Abstract_MRC(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_MRC(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [MRC] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_ID) {
			...
			SPs.spS_MRC SP = new SPs.spS_MRC(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_MRC.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_MRC.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_MRC.Resultset1.Fields.Column_Actif.ColumnIndex)) {

						this.col_Actif = DR.GetSqlBoolean(SPs.spS_MRC.Resultset1.Fields.Column_Actif.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_MRC", "Refresh");
			}
		}
	}
}
