...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [Municipalite_Zone] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_Municipalite_Zone {

		Params.spS_Municipalite_Zone Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_Municipalite_Zone class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_Municipalite_Zone(string connectionString) {
			...
			this.Param = new Params.spS_Municipalite_Zone(true);
		...
		public Abstract_Municipalite_Zone(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_Municipalite_Zone(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [Municipalite_Zone] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_ID, System.Data.SqlTypes.SqlString col_MunicipaliteID) {
			...
			SPs.spS_Municipalite_Zone SP = new SPs.spS_Municipalite_Zone(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_Municipalite_Zone.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_Municipalite_Zone.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_Municipalite_Zone.Resultset1.Fields.Column_Actif.ColumnIndex)) {

						this.col_Actif = DR.GetSqlBoolean(SPs.spS_Municipalite_Zone.Resultset1.Fields.Column_Actif.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_Municipalite_Zone", "Refresh");
			}
		}
	}
}
