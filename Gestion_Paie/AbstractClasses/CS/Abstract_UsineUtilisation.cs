...
namespace Gestion_Paie.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [UsineUtilisation] table.
	/// </summary>
	[Serializable()]
	public sealed class Abstract_UsineUtilisation {

		Params.spS_UsineUtilisation Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_UsineUtilisation class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_UsineUtilisation(string connectionString) {
			...
			this.Param = new Params.spS_UsineUtilisation(true);
		...
		public Abstract_UsineUtilisation(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_UsineUtilisation(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [UsineUtilisation] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlInt32 col_ID) {
			...
			SPs.spS_UsineUtilisation SP = new SPs.spS_UsineUtilisation(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_UsineUtilisation.Resultset1.Fields.Column_Description.ColumnIndex)) {

						this.col_Description = DR.GetSqlString(SPs.spS_UsineUtilisation.Resultset1.Fields.Column_Description.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_UsineUtilisation.Resultset1.Fields.Column_Actif.ColumnIndex)) {

						this.col_Actif = DR.GetSqlBoolean(SPs.spS_UsineUtilisation.Resultset1.Fields.Column_Actif.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(this.Param, "Gestion_Paie.AbstractClasses.Abstract_UsineUtilisation", "Refresh");
			}
		}
	}
}
