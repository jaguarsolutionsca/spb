...
namespace Gestion_Paie.BusinessComponents {
	...
	/// <summary>
	/// This class is an abstract class that represents the [AjustementCalcule_Usine] table. With this class
	/// you can load or update a record from the database. If you need to add or delete a record,
	/// you must use the <see cref="Gestion_Paie.BusinessComponents.AjustementCalcule_Usine_Collection"/> class to do so.
	/// </summary>
	public sealed class AjustementCalcule_Usine_Record : IBusinessComponentRecord {
		...
		/// <summary>
		/// Initializes a new instance of the AjustementCalcule_Usine_Record class. Use this contructor to add
		/// a new record. Then call the Add method of the Gestion_Paie.BusinessComponents.AjustementCalcule_Usine_Collection class to actually
		/// add the record in the database.
		/// </summary>
		public AjustementCalcule_Usine_Record() {
		...
		public AjustementCalcule_Usine_Record(string connectionString, System.Data.SqlTypes.SqlInt32 col_ID) {
		...
		public bool Refresh() {
			...
			Params.spS_AjustementCalcule_Usine Param = new Params.spS_AjustementCalcule_Usine(true);
			...
			SPs.spS_AjustementCalcule_Usine Sp = new SPs.spS_AjustementCalcule_Usine();
			if (Sp.Execute(ref Param, out sqlDataReader)) {

				if (sqlDataReader.Read()) {

					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_DateCalcul.ColumnIndex)) {

						this.col_DateCalcul = sqlDataReader.GetSqlDateTime(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_DateCalcul.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_AjustementID.ColumnIndex)) {

						this.col_AjustementID = sqlDataReader.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_AjustementID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_EssenceID.ColumnIndex)) {

						this.col_EssenceID = sqlDataReader.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_EssenceID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UniteID.ColumnIndex)) {

						this.col_UniteID = sqlDataReader.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UniteID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_LivraisonDetailID.ColumnIndex)) {

						this.col_LivraisonDetailID = sqlDataReader.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_LivraisonDetailID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UsineID.ColumnIndex)) {

						this.col_UsineID = sqlDataReader.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_UsineID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Volume.ColumnIndex)) {

						this.col_Volume = sqlDataReader.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Volume.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Taux.ColumnIndex)) {

						this.col_Taux = sqlDataReader.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Taux.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Montant.ColumnIndex)) {

						this.col_Montant = sqlDataReader.GetSqlDouble(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Montant.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Facture.ColumnIndex)) {

						this.col_Facture = sqlDataReader.GetSqlBoolean(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Facture.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_FactureID.ColumnIndex)) {

						this.col_FactureID = sqlDataReader.GetSqlInt32(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_FactureID.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex)) {

						this.col_ErreurCalcul = sqlDataReader.GetSqlBoolean(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurCalcul.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurDescription.ColumnIndex)) {

						this.col_ErreurDescription = sqlDataReader.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_ErreurDescription.ColumnIndex);
					}
					if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Code.ColumnIndex)) {

						this.col_Code = sqlDataReader.GetSqlString(SPs.spS_AjustementCalcule_Usine.Resultset1.Fields.Column_Code.ColumnIndex);
					}
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.AjustementCalcule_Usine_Record", "Refresh");
			}
		}
		...
		public void Update() {
			...
			Params.spU_AjustementCalcule_Usine Param = new Params.spU_AjustementCalcule_Usine(false);
			Param.SetUpConnection(this.connectionString);
			Param.Param_ID = this.col_ID;
			...
			SPs.spU_AjustementCalcule_Usine Sp = new SPs.spU_AjustementCalcule_Usine();
			if (Sp.Execute(ref Param)) {
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.AjustementCalcule_Usine_Record", "Update");
			}		
		}
			...
			if (this.displayName == null) {
				...
				if (Sp.Execute(ref Param, out sqlDataReader)) {
					...
					if (sqlDataReader.Read()) {
						...
						if (!sqlDataReader.IsDBNull(SPs.spS_AjustementCalcule_Usine_Display.Resultset1.Fields.Column_Display.ColumnIndex)) {

							this.displayName = "spS_AjustementCalcule_Usine_Display";
						}
					}
					...
					throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.AjustementCalcule_Usine_Record", "ToString");
				}				
			}
