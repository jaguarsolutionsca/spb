...
namespace Gestion_Paie.BusinessComponents {
	...
	public sealed class FactureClient_Sommaire_Collection : IBusinessComponentCollection, System.Collections.IEnumerable, System.ComponentModel.IListSource {
		...
		public FactureClient_Sommaire_Collection(string connectionString) {
		...
		public FactureClient_Sommaire_Collection(string connectionString, System.Data.SqlTypes.SqlInt32 col_Compte) {
		...
		public IBusinessComponentRecord Add(IBusinessComponentRecord record) {
			...
			FactureClient_Sommaire_Record recordToAdd = record as FactureClient_Sommaire_Record;

			if (recordToAdd == null) {

				throw new ArgumentException("Invalid record type. Must be 'Gestion_Paie.BusinessComponents.FactureClient_Sommaire_Record'.", "record");
			}

			Params.spI_FactureClient_Sommaire Param = new Params.spI_FactureClient_Sommaire();
			...
			SPs.spI_FactureClient_Sommaire Sp = new SPs.spI_FactureClient_Sommaire();
			if (Sp.Execute(ref Param)) {

				FactureClient_Sommaire_Record newRecord = new FactureClient_Sommaire_Record(this.connectionString, Param.Param_FactureID, Param.Param_Ligne);				if (internalRecords != null) {
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.FactureClient_Sommaire_Collection", "Add");
			}	
		}
		...
		public void Remove(System.Data.SqlTypes.SqlInt32 Col_FactureID, System.Data.SqlTypes.SqlInt32 Col_Ligne) {
			...
			Params.spD_FactureClient_Sommaire Param = new Params.spD_FactureClient_Sommaire(true);
			Param.SetUpConnection(this.connectionString);
			...
			SPs.spD_FactureClient_Sommaire Sp = new SPs.spD_FactureClient_Sommaire(true);
		...
		public void Remove(IBusinessComponentRecord record) {
			...
			FactureClient_Sommaire_Record recordToDelete = record as FactureClient_Sommaire_Record;
		...
		public void Refresh() {
			...
			if (Sp.Execute(ref Param, out sqlDataReader)) {
				...
				while (sqlDataReader.Read()) {
					...
					FactureClient_Sommaire_Record record = new FactureClient_Sommaire_Record(this.connectionString, sqlDataReader.GetSqlInt32(SPs.spS_FactureClient_Sommaire_Display.Resultset1.Fields.Column_ID1.ColumnIndex), sqlDataReader.GetSqlInt32(SPs.spS_FactureClient_Sommaire_Display.Resultset1.Fields.Column_ID2.ColumnIndex));

					record.displayName = "spS_FactureClient_Sommaire_Display";
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.FactureClient_Sommaire_Collection", "Refresh");
			}
		}
		...
		public FactureClient_Sommaire_Record this[int index] {

			get {
				
				return((FactureClient_Sommaire_Record)internalRecords[index]);
			}
		}
		...
		public FactureClient_Sommaire_Record this[System.Data.SqlTypes.SqlInt32 col_FactureID, System.Data.SqlTypes.SqlInt32 col_Ligne] {

			get {

				foreach(FactureClient_Sommaire_Record record in internalRecords) {
