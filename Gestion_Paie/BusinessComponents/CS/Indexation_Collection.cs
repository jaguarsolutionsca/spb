...
namespace Gestion_Paie.BusinessComponents {
	...
	public sealed class Indexation_Collection : IBusinessComponentCollection, System.Collections.IEnumerable, System.ComponentModel.IListSource {
		...
		public Indexation_Collection(string connectionString) {
		...
		public Indexation_Collection(string connectionString, System.Data.SqlTypes.SqlString col_ContratID, System.Data.SqlTypes.SqlString col_TypeIndexation) {
		...
		public IBusinessComponentRecord Add(IBusinessComponentRecord record) {
			...
			Indexation_Record recordToAdd = record as Indexation_Record;

			if (recordToAdd == null) {

				throw new ArgumentException("Invalid record type. Must be 'Gestion_Paie.BusinessComponents.Indexation_Record'.", "record");
			}

			Params.spI_Indexation Param = new Params.spI_Indexation();
			Param.SetUpConnection(this.connectionString);

			Param.Param_ID = recordToAdd.Col_ID;
			Param.Param_DateIndexation = recordToAdd.Col_DateIndexation;
			...
			Param.Param_IndexationTransporteur = recordToAdd.Col_IndexationTransporteur;
			Param.Param_Date_Debut = recordToAdd.Col_Date_Debut;
			Param.Param_Date_Fin = recordToAdd.Col_Date_Fin;
			Param.Param_IndexationManuelle = recordToAdd.Col_IndexationManuelle;

			SPs.spI_Indexation Sp = new SPs.spI_Indexation();
			if (Sp.Execute(ref Param)) {

				Indexation_Record newRecord = new Indexation_Record(this.connectionString, Param.Param_ID);				if (internalRecords != null) {
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.Indexation_Collection", "Add");
			}	
		}
		...
		public void Remove(System.Data.SqlTypes.SqlInt32 Col_ID) {
			...
			Params.spD_Indexation Param = new Params.spD_Indexation(true);
			Param.SetUpConnection(this.connectionString);

			Param.Param_ID = Col_ID;


			SPs.spD_Indexation Sp = new SPs.spD_Indexation(true);
		...
		public void Remove(IBusinessComponentRecord record) {
			...
			Indexation_Record recordToDelete = record as Indexation_Record;
		...
		public void Refresh() {
			...
			if (Sp.Execute(ref Param, out sqlDataReader)) {
				...
				while (sqlDataReader.Read()) {
					...
					Indexation_Record record = new Indexation_Record(this.connectionString, sqlDataReader.GetSqlInt32(SPs.spS_Indexation_Display.Resultset1.Fields.Column_ID1.ColumnIndex));

					record.displayName = "spS_Indexation_Display";
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.Indexation_Collection", "Refresh");
			}
		}
		...
		public Indexation_Record this[int index] {

			get {
				
				return((Indexation_Record)internalRecords[index]);
			}
		}

		/// <param name="col_ID">[To be supplied.]</param>
		/// <returns>[To be supplied.]</returns>
		public Indexation_Record this[System.Data.SqlTypes.SqlInt32 col_ID] {

			get {

				foreach(Indexation_Record record in internalRecords) {
