...
namespace Gestion_Paie.BusinessComponents {
	...
	public sealed class Indexation_EssenceUnite_Collection : IBusinessComponentCollection, System.Collections.IEnumerable, System.ComponentModel.IListSource {
		...
		public Indexation_EssenceUnite_Collection(string connectionString) {
		...
		public Indexation_EssenceUnite_Collection(string connectionString, System.Data.SqlTypes.SqlInt32 col_IndexationID, System.Data.SqlTypes.SqlString col_ContratID, System.Data.SqlTypes.SqlString col_EssenceID, System.Data.SqlTypes.SqlString col_Code, System.Data.SqlTypes.SqlString col_UniteID) {
		...
		public IBusinessComponentRecord Add(IBusinessComponentRecord record) {
			...
			Indexation_EssenceUnite_Record recordToAdd = record as Indexation_EssenceUnite_Record;

			if (recordToAdd == null) {

				throw new ArgumentException("Invalid record type. Must be 'Gestion_Paie.BusinessComponents.Indexation_EssenceUnite_Record'.", "record");
			}

			Params.spI_Indexation_EssenceUnite Param = new Params.spI_Indexation_EssenceUnite();
			...
			SPs.spI_Indexation_EssenceUnite Sp = new SPs.spI_Indexation_EssenceUnite();
			if (Sp.Execute(ref Param)) {

				Indexation_EssenceUnite_Record newRecord = new Indexation_EssenceUnite_Record(this.connectionString, Param.Param_ID);				if (internalRecords != null) {
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.Indexation_EssenceUnite_Collection", "Add");
			}	
		}
		...
		public void Remove(System.Data.SqlTypes.SqlInt32 Col_ID) {
			...
			Params.spD_Indexation_EssenceUnite Param = new Params.spD_Indexation_EssenceUnite(true);
			Param.SetUpConnection(this.connectionString);

			Param.Param_ID = Col_ID;


			SPs.spD_Indexation_EssenceUnite Sp = new SPs.spD_Indexation_EssenceUnite(true);
		...
		public void Remove(IBusinessComponentRecord record) {
			...
			Indexation_EssenceUnite_Record recordToDelete = record as Indexation_EssenceUnite_Record;
		...
		public void Refresh() {
			...
			if (Sp.Execute(ref Param, out sqlDataReader)) {
				...
				while (sqlDataReader.Read()) {
					...
					Indexation_EssenceUnite_Record record = new Indexation_EssenceUnite_Record(this.connectionString, sqlDataReader.GetSqlInt32(SPs.spS_Indexation_EssenceUnite_Display.Resultset1.Fields.Column_ID1.ColumnIndex));

					record.displayName = "spS_Indexation_EssenceUnite_Display";
				...
				throw new Gestion_Paie.DataClasses.CustomException(Param, "Gestion_Paie.BusinessComponents.Indexation_EssenceUnite_Collection", "Refresh");
			}
		}
		...
		public Indexation_EssenceUnite_Record this[int index] {

			get {
				
				return((Indexation_EssenceUnite_Record)internalRecords[index]);
			}
		}

		/// <param name="col_ID">[To be supplied.]</param>
		/// <returns>[To be supplied.]</returns>
		public Indexation_EssenceUnite_Record this[System.Data.SqlTypes.SqlInt32 col_ID] {

			get {

				foreach(Indexation_EssenceUnite_Record record in internalRecords) {
