...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_AutorisationDesLivraisons'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_AutorisationDesLivraisons : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_AutorisationDesLivraisons class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_AutorisationDesLivraisons() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_AutorisationDesLivraisons class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_AutorisationDesLivraisons(bool useDefaultValue) {
			...
			this.internal_Param_UpdateImprime_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_AutorisationDesLivraisons'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_UpdateImprime = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~jag_AutorisationDesLivraisons() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_AutorisationDesLivraisons'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_AutorisationDesLivraisons");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_UpdateImprime;
		internal bool internal_Param_UpdateImprime_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@UpdateImprime'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_UpdateImprime_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_UpdateImprime {

			get {

				if (this.internal_Param_UpdateImprime_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_UpdateImprime);
			}

			set {

				this.internal_Param_UpdateImprime_UseDefaultValue = false;
				this.internal_Param_UpdateImprime = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@UpdateImprime' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_UpdateImprime_UseDefaultValue() {

			this.internal_Param_UpdateImprime_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_AutorisationDesLivraisons' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_AutorisationDesLivraisons : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_AutorisationDesLivraisons() : this(false) {
		...
		public jag_AutorisationDesLivraisons(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons)");
						}
				...
				sqlCommand.CommandText = "jag_AutorisationDesLivraisons";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@UpdateImprime", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_UpdateImprime_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_UpdateImprime.IsNull) {

					sqlParameter.Value = parameters.Param_UpdateImprime;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_AutorisationDesLivraisons] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_AutorisationDesLivraisons'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_AutorisationDesLivraisons", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_AutorisationDesLivraisons", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_AutorisationDesLivraisons parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_AutorisationDesLivraisons' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Superficie_Contingente via shared members
				/// </summary>
				public sealed class Column_Superficie_Contingente {

					/// <summary>
					/// Returns "Superficie_Contingente"
					/// </summary>
					public const System.String ColumnName = "Superficie_Contingente";
					/// <summary>
					/// Returns 9
					/// </summary>
		...
		public sealed class Resultset2 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Alloue via shared members
				/// </summary>
				public sealed class Column_Volume_Alloue {

					/// <summary>
					/// Returns "Volume_Alloue"
					/// </summary>
					public const System.String ColumnName = "Volume_Alloue";
					/// <summary>
					/// Returns 4
					/// </summary>
					public const System.Int32 ColumnIndex = 4;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_A_Livre via shared members
				/// </summary>
				public sealed class Column_Volume_A_Livre {

					/// <summary>
					/// Returns "Volume_A_Livre"
					/// </summary>
					public const System.String ColumnName = "Volume_A_Livre";
					/// <summary>
					/// Returns 6
					/// </summary>
					public const System.Int32 ColumnIndex = 6;
		...
		public sealed class Resultset3 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Regroupement via shared members
				/// </summary>
				public sealed class Column_Regroupement {

					/// <summary>
					/// Returns "Regroupement"
					/// </summary>
					public const System.String ColumnName = "Regroupement";
					/// <summary>
					/// Returns 0
					/// </summary>
					public const System.Int32 ColumnIndex = 0;
		...
		public sealed class Resultset4 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Message via shared members
				/// </summary>
				public sealed class Column_Message {

					/// <summary>
					/// Returns "Message"
					/// </summary>
					public const System.String ColumnName = "Message";
					/// <summary>
					/// Returns 0
					/// </summary>
					public const System.Int32 ColumnIndex = 0;
