/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/10/2006 11:15:18 AM
...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Calculate_Indexation_DetailsForCalculs'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/10/11 15:15:19", SqlObjectDependancyName="jag_Calculate_Indexation_DetailsForCalculs", SqlObjectDependancyRevision=272)]
#endif
	public sealed class jag_Calculate_Indexation_DetailsForCalculs : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Calculate_Indexation_DetailsForCalculs class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Calculate_Indexation_DetailsForCalculs() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Calculate_Indexation_DetailsForCalculs class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Calculate_Indexation_DetailsForCalculs(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Calculate_Indexation_DetailsForCalculs'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "jag_Calculate_Indexation_DetailsForCalculs", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~jag_Calculate_Indexation_DetailsForCalculs() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Calculate_Indexation_DetailsForCalculs'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Calculate_Indexation_DetailsForCalculs");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Calculate_Indexation_DetailsForCalculs' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/10/11 15:15:19", SqlObjectDependancyName="jag_Calculate_Indexation_DetailsForCalculs", SqlObjectDependancyRevision=272)]
#endif
	public sealed class jag_Calculate_Indexation_DetailsForCalculs : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Calculate_Indexation_DetailsForCalculs() : this(false) {
		...
		public jag_Calculate_Indexation_DetailsForCalculs(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs)");
						}
				...
				sqlCommand.CommandText = "jag_Calculate_Indexation_DetailsForCalculs";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Calculate_Indexation_DetailsForCalculs] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Calculate_Indexation_DetailsForCalculs'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Calculate_Indexation_DetailsForCalculs", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Calculate_Indexation_DetailsForCalculs", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Calculate_Indexation_DetailsForCalculs parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Calculate_Indexation_DetailsForCalculs' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field NewRow via shared members
				/// </summary>
				public sealed class Column_NewRow {

					/// <summary>
					/// Returns "NewRow"
					/// </summary>
					public const System.String ColumnName = "NewRow";
					/// <summary>
					/// Returns 0
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Inclure via shared members
				/// </summary>
				public sealed class Column_Inclure {

					/// <summary>
					/// Returns "Inclure"
					/// </summary>
					public const System.String ColumnName = "Inclure";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ProducteurNom via shared members
				/// </summary>
				public sealed class Column_ProducteurNom {

					/// <summary>
					/// Returns "ProducteurNom"
					/// </summary>
					public const System.String ColumnName = "ProducteurNom";
					/// <summary>
					/// Returns 8
					/// </summary>
