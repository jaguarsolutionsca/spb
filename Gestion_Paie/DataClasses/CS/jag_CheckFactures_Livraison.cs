...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_CheckFactures_Livraison'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_CheckFactures_Livraison : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_CheckFactures_Livraison class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_CheckFactures_Livraison() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_CheckFactures_Livraison class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_CheckFactures_Livraison(bool useDefaultValue) {
			...
			this.internal_Param_Erreurs_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_CheckFactures_Livraison'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_Erreurs = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		~jag_CheckFactures_Livraison() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_CheckFactures_Livraison'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_CheckFactures_Livraison");
			}
		}
		...
		private System.Data.SqlTypes.SqlString internal_Param_Erreurs;
		internal bool internal_Param_Erreurs_UseDefaultValue = true;
		...
		private void RetrieveOutputParameters() {
			...
			if (this.sqlCommand.Parameters["@Erreurs"].Value != System.DBNull.Value) {

					try {
						this.Param_Erreurs = ( System.Data.SqlTypes.SqlString)this.sqlCommand.Parameters["@Erreurs"].Value;
					}
				...
				this.Param_Erreurs = System.Data.SqlTypes.SqlString.Null;
			}
			this.internal_Param_Erreurs_UseDefaultValue = false;
		...
		/// <summary>
		/// Sets or returns the value of the stored procedure OUTPUT parameter '@Erreurs'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		/// <description>
		/// In SQL Server, this parameter is of type: [varchar](5000)
		/// </description>
		/// </item>
		/// <item>
		/// <description>
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Erreurs_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlString Param_Erreurs {
			...
			get {
					...
					switch (this.currentExecution) {
						...
						case CurrentExecution.SqlDataReader:
							if (this.sqlDataReader.IsClosed) {
								...
								throw new System.InvalidOperationException("The stored procedure output parameter '@Erreurs' has not been populated. You must close the underlying SqlDataReader first !");
							}
							break;
				...
				if (this.internal_Param_Erreurs_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Erreurs);
			}

			set {

				this.internal_Param_Erreurs_UseDefaultValue = false;
				this.internal_Param_Erreurs = value;
			}
		}

		/// <summary>
		/// Indicates that the '@Erreurs' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Erreurs_UseDefaultValue() {

			this.internal_Param_Erreurs_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_CheckFactures_Livraison' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_CheckFactures_Livraison : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_CheckFactures_Livraison() : this(false) {
		...
		public jag_CheckFactures_Livraison(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison)");
						}
				...
				sqlCommand.CommandText = "jag_CheckFactures_Livraison";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Erreurs", System.Data.SqlDbType.VarChar, 5000);
				sqlParameter.Direction = System.Data.ParameterDirection.InputOutput;
				if (parameters.internal_Param_Erreurs_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Erreurs.IsNull) {

					sqlParameter.Value = parameters.Param_Erreurs;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				if (sqlCommand.Parameters["@Erreurs"].Value != System.DBNull.Value) {

						try {

							parameters.Param_Erreurs = (System.Data.SqlTypes.SqlString)sqlCommand.Parameters["@Erreurs"].Value;
						}
						catch (System.InvalidCastException) {

							parameters.Param_Erreurs = (System.String)sqlCommand.Parameters["@Erreurs"].Value;
						}
				}
				else {

					parameters.Param_Erreurs = System.Data.SqlTypes.SqlString.Null;
				}
				parameters.internal_Param_Erreurs_UseDefaultValue = false;
		...
		/// <summary>
		/// This method allows you to execute the [jag_CheckFactures_Livraison] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_CheckFactures_Livraison'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_CheckFactures_Livraison", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_CheckFactures_Livraison", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_CheckFactures_Livraison parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_CheckFactures_Livraison' class.
		/// </summary>
