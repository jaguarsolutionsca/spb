...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Facture_LongueuilUsine'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_Facture_LongueuilUsine : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Facture_LongueuilUsine class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Facture_LongueuilUsine() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Facture_LongueuilUsine class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Facture_LongueuilUsine(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Facture_LongueuilUsine'";
		...
		/// </summary>
		~jag_Facture_LongueuilUsine() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Facture_LongueuilUsine'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Facture_LongueuilUsine");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Facture_LongueuilUsine' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_Facture_LongueuilUsine : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Facture_LongueuilUsine() : this(false) {
		...
		public jag_Facture_LongueuilUsine(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine)");
						}
				...
				sqlCommand.CommandText = "jag_Facture_LongueuilUsine";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Facture_LongueuilUsine] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Facture_LongueuilUsine'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Facture_LongueuilUsine", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Facture_LongueuilUsine", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Facture_LongueuilUsine parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Facture_LongueuilUsine' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantProducteurBrut via shared members
				/// </summary>
				public sealed class Column_MontantProducteurBrut {

					/// <summary>
					/// Returns "MontantProducteurBrut"
					/// </summary>
					public const System.String ColumnName = "MontantProducteurBrut";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantTransport via shared members
				/// </summary>
				public sealed class Column_MontantTransport {

					/// <summary>
					/// Returns "MontantTransport"
					/// </summary>
					public const System.String ColumnName = "MontantTransport";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantCompensationDeplacement via shared members
				/// </summary>
				public sealed class Column_MontantCompensationDeplacement {

					/// <summary>
					/// Returns "MontantCompensationDeplacement"
					/// </summary>
					public const System.String ColumnName = "MontantCompensationDeplacement";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantPreleve via shared members
				/// </summary>
				public sealed class Column_MontantPreleve {

					/// <summary>
					/// Returns "MontantPreleve"
					/// </summary>
					public const System.String ColumnName = "MontantPreleve";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantProducteurNet via shared members
				/// </summary>
				public sealed class Column_MontantProducteurNet {

					/// <summary>
					/// Returns "MontantProducteurNet"
					/// </summary>
					public const System.String ColumnName = "MontantProducteurNet";
					/// <summary>
					/// Returns 15
					/// </summary>
		...
		public sealed class Resultset2 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TauxProducteur via shared members
				/// </summary>
				public sealed class Column_TauxProducteur {

					/// <summary>
					/// Returns "TauxProducteur"
					/// </summary>
					public const System.String ColumnName = "TauxProducteur";
					/// <summary>
					/// Returns 9
					/// </summary>
					public const System.Int32 ColumnIndex = 9;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TauxTransport via shared members
				/// </summary>
				public sealed class Column_TauxTransport {

					/// <summary>
					/// Returns "TauxTransport"
					/// </summary>
					public const System.String ColumnName = "TauxTransport";
					/// <summary>
					/// Returns 11
					/// </summary>
					public const System.Int32 ColumnIndex = 11;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TauxPreleves via shared members
				/// </summary>
				public sealed class Column_TauxPreleves {

					/// <summary>
					/// Returns "TauxPreleves"
					/// </summary>
					public const System.String ColumnName = "TauxPreleves";
					/// <summary>
					/// Returns 13
					/// </summary>
					public const System.Int32 ColumnIndex = 13;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantPreleves via shared members
				/// </summary>
				public sealed class Column_MontantPreleves {

					/// <summary>
					/// Returns "MontantPreleves"
					/// </summary>
					public const System.String ColumnName = "MontantPreleves";
					/// <summary>
					/// Returns 14
					/// </summary>
					public const System.Int32 ColumnIndex = 14;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TauxProducteurNet via shared members
				/// </summary>
				public sealed class Column_TauxProducteurNet {

					/// <summary>
					/// Returns "TauxProducteurNet"
					/// </summary>
					public const System.String ColumnName = "TauxProducteurNet";
					/// <summary>
					/// Returns 15
					/// </summary>
					public const System.Int32 ColumnIndex = 15;
		...
		public sealed class Resultset3 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TauxTransporteur via shared members
				/// </summary>
				public sealed class Column_TauxTransporteur {

					/// <summary>
					/// Returns "TauxTransporteur"
					/// </summary>
					public const System.String ColumnName = "TauxTransporteur";
					/// <summary>
					/// Returns 8
					/// </summary>
					public const System.Int32 ColumnIndex = 8;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantTransporteurBrut via shared members
				/// </summary>
				public sealed class Column_MontantTransporteurBrut {

					/// <summary>
					/// Returns "MontantTransporteurBrut"
					/// </summary>
					public const System.String ColumnName = "MontantTransporteurBrut";
					/// <summary>
					/// Returns 9
					/// </summary>
					public const System.Int32 ColumnIndex = 9;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantCompensation via shared members
				/// </summary>
				public sealed class Column_MontantCompensation {

					/// <summary>
					/// Returns "MontantCompensation"
					/// </summary>
					public const System.String ColumnName = "MontantCompensation";
					/// <summary>
					/// Returns 12
					/// </summary>
					public const System.Int32 ColumnIndex = 12;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantTransporteurNet via shared members
				/// </summary>
				public sealed class Column_MontantTransporteurNet {

					/// <summary>
					/// Returns "MontantTransporteurNet"
					/// </summary>
					public const System.String ColumnName = "MontantTransporteurNet";
					/// <summary>
					/// Returns 14
					/// </summary>
					public const System.Int32 ColumnIndex = 14;
		...
		public sealed class Resultset4 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantParProducteur via shared members
				/// </summary>
				public sealed class Column_MontantParProducteur {

					/// <summary>
					/// Returns "MontantParProducteur"
					/// </summary>
					public const System.String ColumnName = "MontantParProducteur";
					/// <summary>
					/// Returns 5
					/// </summary>
					public const System.Int32 ColumnIndex = 5;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MontantParTransporteur via shared members
				/// </summary>
				public sealed class Column_MontantParTransporteur {

					/// <summary>
					/// Returns "MontantParTransporteur"
					/// </summary>
					public const System.String ColumnName = "MontantParTransporteur";
					/// <summary>
					/// Returns 6
					/// </summary>
					public const System.Int32 ColumnIndex = 6;
