...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_FeuilletDomtar_Creer_PermitLivraison'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_FeuilletDomtar_Creer_PermitLivraison : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_FeuilletDomtar_Creer_PermitLivraison class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_FeuilletDomtar_Creer_PermitLivraison() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_FeuilletDomtar_Creer_PermitLivraison class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_FeuilletDomtar_Creer_PermitLivraison(bool useDefaultValue) {
			...
			this.internal_Param_PourcentSecMoyen_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_FeuilletDomtar_Creer_PermitLivraison'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_PourcentSecMoyen = System.Data.SqlTypes.SqlDouble.Null;
		...
		/// </summary>
		~jag_FeuilletDomtar_Creer_PermitLivraison() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_FeuilletDomtar_Creer_PermitLivraison'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_FeuilletDomtar_Creer_PermitLivraison");
			}
		}
		...
		private System.Data.SqlTypes.SqlDouble internal_Param_PourcentSecMoyen;
		internal bool internal_Param_PourcentSecMoyen_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@PourcentSecMoyen'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_PourcentSecMoyen_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_PourcentSecMoyen {

			get {

				if (this.internal_Param_PourcentSecMoyen_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_PourcentSecMoyen);
			}

			set {

				this.internal_Param_PourcentSecMoyen_UseDefaultValue = false;
				this.internal_Param_PourcentSecMoyen = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@PourcentSecMoyen' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_PourcentSecMoyen_UseDefaultValue() {

			this.internal_Param_PourcentSecMoyen_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_FeuilletDomtar_Creer_PermitLivraison' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_FeuilletDomtar_Creer_PermitLivraison : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_FeuilletDomtar_Creer_PermitLivraison() : this(false) {
		...
		public jag_FeuilletDomtar_Creer_PermitLivraison(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison)");
						}
				...
				sqlCommand.CommandText = "jag_FeuilletDomtar_Creer_PermitLivraison";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@PourcentSecMoyen", System.Data.SqlDbType.Float, 8);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_PourcentSecMoyen_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_PourcentSecMoyen.IsNull) {

					sqlParameter.Value = parameters.Param_PourcentSecMoyen;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_FeuilletDomtar_Creer_PermitLivraison] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_FeuilletDomtar_Creer_PermitLivraison parameters) {
