...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Get_VolumeLivreNonContingente'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:51", SqlObjectDependancyName="jag_Get_VolumeLivreNonContingente", SqlObjectDependancyRevision=3312)]
#endif
	public sealed class jag_Get_VolumeLivreNonContingente : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Get_VolumeLivreNonContingente class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Get_VolumeLivreNonContingente() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Get_VolumeLivreNonContingente class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Get_VolumeLivreNonContingente(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Get_VolumeLivreNonContingente'";
		...
		/// </summary>
		~jag_Get_VolumeLivreNonContingente() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Get_VolumeLivreNonContingente'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Get_VolumeLivreNonContingente");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Get_VolumeLivreNonContingente' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:51", SqlObjectDependancyName="jag_Get_VolumeLivreNonContingente", SqlObjectDependancyRevision=3312)]
#endif
	public sealed class jag_Get_VolumeLivreNonContingente : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Get_VolumeLivreNonContingente() : this(false) {
		...
		public jag_Get_VolumeLivreNonContingente(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente)");
						}
				...
				sqlCommand.CommandText = "jag_Get_VolumeLivreNonContingente";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Get_VolumeLivreNonContingente] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Get_VolumeLivreNonContingente parameters) {
