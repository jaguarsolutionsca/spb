...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Rapport_Contingentement_Irregularites'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_Rapport_Contingentement_Irregularites : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Contingentement_Irregularites class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Rapport_Contingentement_Irregularites() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Contingentement_Irregularites class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Rapport_Contingentement_Irregularites(bool useDefaultValue) {
			...
			this.internal_Param_FouDebut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_FouFin_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Rapport_Contingentement_Irregularites'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_FouDebut = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_FouFin = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		~jag_Rapport_Contingentement_Irregularites() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Rapport_Contingentement_Irregularites'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Rapport_Contingentement_Irregularites");
			}
		}
		...
		private System.Data.SqlTypes.SqlString internal_Param_FouDebut;
		internal bool internal_Param_FouDebut_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_FouFin;
		internal bool internal_Param_FouFin_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@FouDebut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_FouDebut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlString Param_FouDebut {

			get {

				if (this.internal_Param_FouDebut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_FouDebut);
			}

			set {

				this.internal_Param_FouDebut_UseDefaultValue = false;
				this.internal_Param_FouDebut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@FouDebut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_FouDebut_UseDefaultValue() {

			this.internal_Param_FouDebut_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@FouFin'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_FouFin_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlString Param_FouFin {

			get {

				if (this.internal_Param_FouFin_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_FouFin);
			}

			set {

				this.internal_Param_FouFin_UseDefaultValue = false;
				this.internal_Param_FouFin = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@FouFin' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_FouFin_UseDefaultValue() {

			this.internal_Param_FouFin_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Rapport_Contingentement_Irregularites' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_Rapport_Contingentement_Irregularites : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Rapport_Contingentement_Irregularites() : this(false) {
		...
		public jag_Rapport_Contingentement_Irregularites(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites)");
						}
				...
				sqlCommand.CommandText = "jag_Rapport_Contingentement_Irregularites";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@FouDebut", System.Data.SqlDbType.VarChar, 15);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_FouDebut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_FouDebut.IsNull) {

					sqlParameter.Value = parameters.Param_FouDebut;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@FouFin", System.Data.SqlDbType.VarChar, 15);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_FouFin_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_FouFin.IsNull) {

					sqlParameter.Value = parameters.Param_FouFin;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Rapport_Contingentement_Irregularites] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Rapport_Contingentement_Irregularites'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Contingentement_Irregularites", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Contingentement_Irregularites", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contingentement_Irregularites parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Rapport_Contingentement_Irregularites' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LivraisonAnnee via shared members
				/// </summary>
				public sealed class Column_LivraisonAnnee {

					/// <summary>
					/// Returns "LivraisonAnnee"
					/// </summary>
					public const System.String ColumnName = "LivraisonAnnee";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LivraisonPeriode via shared members
				/// </summary>
				public sealed class Column_LivraisonPeriode {

					/// <summary>
					/// Returns "LivraisonPeriode"
					/// </summary>
					public const System.String ColumnName = "LivraisonPeriode";
					/// <summary>
					/// Returns 2
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ContingentPeriode via shared members
				/// </summary>
				public sealed class Column_ContingentPeriode {

					/// <summary>
					/// Returns "ContingentPeriode"
					/// </summary>
					public const System.String ColumnName = "ContingentPeriode";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Livre via shared members
				/// </summary>
				public sealed class Column_Volume_Livre {

					/// <summary>
					/// Returns "Volume_Livre"
					/// </summary>
					public const System.String ColumnName = "Volume_Livre";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PasDeContingent via shared members
				/// </summary>
				public sealed class Column_PasDeContingent {

					/// <summary>
					/// Returns "PasDeContingent"
					/// </summary>
					public const System.String ColumnName = "PasDeContingent";
					/// <summary>
					/// Returns 15
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MauvaiseProvenance via shared members
				/// </summary>
				public sealed class Column_MauvaiseProvenance {

					/// <summary>
					/// Returns "MauvaiseProvenance"
					/// </summary>
					public const System.String ColumnName = "MauvaiseProvenance";
					/// <summary>
					/// Returns 16
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field MauvaisTransporteur via shared members
				/// </summary>
				public sealed class Column_MauvaisTransporteur {

					/// <summary>
					/// Returns "MauvaisTransporteur"
					/// </summary>
					public const System.String ColumnName = "MauvaisTransporteur";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ContingentDepasse via shared members
				/// </summary>
				public sealed class Column_ContingentDepasse {

					/// <summary>
					/// Returns "ContingentDepasse"
					/// </summary>
					public const System.String ColumnName = "ContingentDepasse";
					/// <summary>
					/// Returns 18
					/// </summary>
