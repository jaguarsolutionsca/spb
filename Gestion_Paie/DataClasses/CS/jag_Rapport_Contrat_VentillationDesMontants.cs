...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Rapport_Contrat_VentillationDesMontants'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:56", SqlObjectDependancyName="jag_Rapport_Contrat_VentillationDesMontants", SqlObjectDependancyRevision=5008)]
#endif
	public sealed class jag_Rapport_Contrat_VentillationDesMontants : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Contrat_VentillationDesMontants class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Rapport_Contrat_VentillationDesMontants() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Contrat_VentillationDesMontants class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Rapport_Contrat_VentillationDesMontants(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Rapport_Contrat_VentillationDesMontants'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "jag_Rapport_Contrat_VentillationDesMontants", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~jag_Rapport_Contrat_VentillationDesMontants() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Rapport_Contrat_VentillationDesMontants'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Rapport_Contrat_VentillationDesMontants");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Rapport_Contrat_VentillationDesMontants' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:56", SqlObjectDependancyName="jag_Rapport_Contrat_VentillationDesMontants", SqlObjectDependancyRevision=5008)]
#endif
	public sealed class jag_Rapport_Contrat_VentillationDesMontants : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Rapport_Contrat_VentillationDesMontants() : this(false) {
		...
		public jag_Rapport_Contrat_VentillationDesMontants(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants)");
						}
				...
				sqlCommand.CommandText = "jag_Rapport_Contrat_VentillationDesMontants";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Rapport_Contrat_VentillationDesMontants] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Rapport_Contrat_VentillationDesMontants'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Contrat_VentillationDesMontants", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Contrat_VentillationDesMontants", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Contrat_VentillationDesMontants parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Rapport_Contrat_VentillationDesMontants' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Reduction via shared members
				/// </summary>
				public sealed class Column_Volume_Reduction {

					/// <summary>
					/// Returns "Volume_Reduction"
					/// </summary>
					public const System.String ColumnName = "Volume_Reduction";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Montant_Ajustement_Usine via shared members
				/// </summary>
				public sealed class Column_Montant_Ajustement_Usine {

					/// <summary>
					/// Returns "Montant_Ajustement_Usine"
					/// </summary>
					public const System.String ColumnName = "Montant_Ajustement_Usine";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Montant_Ajustement_Producteur via shared members
				/// </summary>
				public sealed class Column_Montant_Ajustement_Producteur {

					/// <summary>
					/// Returns "Montant_Ajustement_Producteur"
					/// </summary>
					public const System.String ColumnName = "Montant_Ajustement_Producteur";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Montant_MEC via shared members
				/// </summary>
				public sealed class Column_Montant_MEC {

					/// <summary>
					/// Returns "Montant_MEC"
					/// </summary>
					public const System.String ColumnName = "Montant_MEC";
					/// <summary>
					/// Returns 16
					/// </summary>
		...
		public sealed class Resultset2 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Colonne via shared members
				/// </summary>
				public sealed class Column_Colonne {

					/// <summary>
					/// Returns "Colonne"
					/// </summary>
					public const System.String ColumnName = "Colonne";
					/// <summary>
					/// Returns 0
					/// </summary>
					public const System.Int32 ColumnIndex = 0;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Montant_Livraison via shared members
				/// </summary>
				public sealed class Column_Montant_Livraison {

					/// <summary>
					/// Returns "Montant_Livraison"
					/// </summary>
					public const System.String ColumnName = "Montant_Livraison";
					/// <summary>
					/// Returns 1
					/// </summary>
					public const System.Int32 ColumnIndex = 1;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Frais_Chargeur via shared members
				/// </summary>
				public sealed class Column_Frais_Chargeur {

					/// <summary>
					/// Returns "Frais_Chargeur"
					/// </summary>
					public const System.String ColumnName = "Frais_Chargeur";
					/// <summary>
					/// Returns 2
					/// </summary>
					public const System.Int32 ColumnIndex = 2;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Frais_Autres via shared members
				/// </summary>
				public sealed class Column_Frais_Autres {

					/// <summary>
					/// Returns "Frais_Autres"
					/// </summary>
					public const System.String ColumnName = "Frais_Autres";
					/// <summary>
					/// Returns 3
					/// </summary>
					public const System.Int32 ColumnIndex = 3;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Frais_CompensationDeplacement via shared members
				/// </summary>
				public sealed class Column_Frais_CompensationDeplacement {

					/// <summary>
					/// Returns "Frais_CompensationDeplacement"
					/// </summary>
					public const System.String ColumnName = "Frais_CompensationDeplacement";
					/// <summary>
					/// Returns 4
					/// </summary>
					public const System.Int32 ColumnIndex = 4;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Frais_AutresRevenus via shared members
				/// </summary>
				public sealed class Column_Frais_AutresRevenus {

					/// <summary>
					/// Returns "Frais_AutresRevenus"
					/// </summary>
					public const System.String ColumnName = "Frais_AutresRevenus";
					/// <summary>
					/// Returns 5
					/// </summary>
					public const System.Int32 ColumnIndex = 5;
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Montant_Ajustement via shared members
				/// </summary>
				public sealed class Column_Montant_Ajustement {

					/// <summary>
					/// Returns "Montant_Ajustement"
					/// </summary>
					public const System.String ColumnName = "Montant_Ajustement";
					/// <summary>
					/// Returns 6
					/// </summary>
					public const System.Int32 ColumnIndex = 6;
