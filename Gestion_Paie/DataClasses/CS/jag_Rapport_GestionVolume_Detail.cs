...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Rapport_GestionVolume_Detail'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:57", SqlObjectDependancyName="jag_Rapport_GestionVolume_Detail", SqlObjectDependancyRevision=1536)]
#endif
	public sealed class jag_Rapport_GestionVolume_Detail : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Rapport_GestionVolume_Detail class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Rapport_GestionVolume_Detail() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Rapport_GestionVolume_Detail class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Rapport_GestionVolume_Detail(bool useDefaultValue) {
			...
			this.internal_Param_DateEntreeDebut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DateEntreeFin_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Rapport_GestionVolume_Detail'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_DateEntreeDebut = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_DateEntreeFin = System.Data.SqlTypes.SqlDateTime.Null;
		...
		/// </summary>
		~jag_Rapport_GestionVolume_Detail() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Rapport_GestionVolume_Detail'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Rapport_GestionVolume_Detail");
			}
		}
		...
		private System.Data.SqlTypes.SqlDateTime internal_Param_DateEntreeDebut;
		internal bool internal_Param_DateEntreeDebut_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDateTime internal_Param_DateEntreeFin;
		internal bool internal_Param_DateEntreeFin_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateEntreeDebut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateEntreeDebut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateEntreeDebut {

			get {

				if (this.internal_Param_DateEntreeDebut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateEntreeDebut);
			}

			set {

				this.internal_Param_DateEntreeDebut_UseDefaultValue = false;
				this.internal_Param_DateEntreeDebut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateEntreeDebut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateEntreeDebut_UseDefaultValue() {

			this.internal_Param_DateEntreeDebut_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateEntreeFin'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateEntreeFin_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateEntreeFin {

			get {

				if (this.internal_Param_DateEntreeFin_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateEntreeFin);
			}

			set {

				this.internal_Param_DateEntreeFin_UseDefaultValue = false;
				this.internal_Param_DateEntreeFin = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateEntreeFin' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateEntreeFin_UseDefaultValue() {

			this.internal_Param_DateEntreeFin_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Rapport_GestionVolume_Detail' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:57", SqlObjectDependancyName="jag_Rapport_GestionVolume_Detail", SqlObjectDependancyRevision=1536)]
#endif
	public sealed class jag_Rapport_GestionVolume_Detail : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Rapport_GestionVolume_Detail() : this(false) {
		...
		public jag_Rapport_GestionVolume_Detail(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail)");
						}
				...
				sqlCommand.CommandText = "jag_Rapport_GestionVolume_Detail";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateEntreeDebut", System.Data.SqlDbType.SmallDateTime, 16);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateEntreeDebut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateEntreeDebut.IsNull) {

					sqlParameter.Value = parameters.Param_DateEntreeDebut;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateEntreeFin", System.Data.SqlDbType.SmallDateTime, 16);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateEntreeFin_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateEntreeFin.IsNull) {

					sqlParameter.Value = parameters.Param_DateEntreeFin;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Rapport_GestionVolume_Detail] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Rapport_GestionVolume_Detail'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_GestionVolume_Detail", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_GestionVolume_Detail", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_GestionVolume_Detail parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Rapport_GestionVolume_Detail' class.
		/// </summary>
