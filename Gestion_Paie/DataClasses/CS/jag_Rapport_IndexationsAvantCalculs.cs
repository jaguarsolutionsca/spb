...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Rapport_IndexationsAvantCalculs'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:57", SqlObjectDependancyName="jag_Rapport_IndexationsAvantCalculs", SqlObjectDependancyRevision=3200)]
#endif
	public sealed class jag_Rapport_IndexationsAvantCalculs : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Rapport_IndexationsAvantCalculs class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Rapport_IndexationsAvantCalculs() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Rapport_IndexationsAvantCalculs class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Rapport_IndexationsAvantCalculs(bool useDefaultValue) {
			...
			this.internal_Param_DateIndexationDebut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DateIndexationFin_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Rapport_IndexationsAvantCalculs'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_DateIndexationDebut = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_DateIndexationFin = System.Data.SqlTypes.SqlDateTime.Null;
		...
		/// </summary>
		~jag_Rapport_IndexationsAvantCalculs() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Rapport_IndexationsAvantCalculs'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Rapport_IndexationsAvantCalculs");
			}
		}
		...
		private System.Data.SqlTypes.SqlDateTime internal_Param_DateIndexationDebut;
		internal bool internal_Param_DateIndexationDebut_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDateTime internal_Param_DateIndexationFin;
		internal bool internal_Param_DateIndexationFin_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateIndexationDebut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateIndexationDebut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateIndexationDebut {

			get {

				if (this.internal_Param_DateIndexationDebut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateIndexationDebut);
			}

			set {

				this.internal_Param_DateIndexationDebut_UseDefaultValue = false;
				this.internal_Param_DateIndexationDebut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateIndexationDebut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateIndexationDebut_UseDefaultValue() {

			this.internal_Param_DateIndexationDebut_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateIndexationFin'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateIndexationFin_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateIndexationFin {

			get {

				if (this.internal_Param_DateIndexationFin_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateIndexationFin);
			}

			set {

				this.internal_Param_DateIndexationFin_UseDefaultValue = false;
				this.internal_Param_DateIndexationFin = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateIndexationFin' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateIndexationFin_UseDefaultValue() {

			this.internal_Param_DateIndexationFin_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Rapport_IndexationsAvantCalculs' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:57", SqlObjectDependancyName="jag_Rapport_IndexationsAvantCalculs", SqlObjectDependancyRevision=3200)]
#endif
	public sealed class jag_Rapport_IndexationsAvantCalculs : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Rapport_IndexationsAvantCalculs() : this(false) {
		...
		public jag_Rapport_IndexationsAvantCalculs(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs)");
						}
				...
				sqlCommand.CommandText = "jag_Rapport_IndexationsAvantCalculs";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateIndexationDebut", System.Data.SqlDbType.SmallDateTime, 16);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateIndexationDebut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateIndexationDebut.IsNull) {

					sqlParameter.Value = parameters.Param_DateIndexationDebut;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateIndexationFin", System.Data.SqlDbType.SmallDateTime, 16);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateIndexationFin_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateIndexationFin.IsNull) {

					sqlParameter.Value = parameters.Param_DateIndexationFin;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@TypeFournisseur", System.Data.SqlDbType.Char, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Rapport_IndexationsAvantCalculs] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Rapport_IndexationsAvantCalculs'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_IndexationsAvantCalculs", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_IndexationsAvantCalculs", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_IndexationsAvantCalculs parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Rapport_IndexationsAvantCalculs' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field _FournisseurID via shared members
				/// </summary>
				public sealed class Column__FournisseurID {

					/// <summary>
					/// Returns "_FournisseurID"
					/// </summary>
					public const System.String ColumnName = "_FournisseurID";
					/// <summary>
					/// Returns 3
					/// </summary>
