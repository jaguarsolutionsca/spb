...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_Rapport_Proprietaire_ListeSuperficiesLot'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:58", SqlObjectDependancyName="jag_Rapport_Proprietaire_ListeSuperficiesLot", SqlObjectDependancyRevision=5280)]
#endif
	public sealed class jag_Rapport_Proprietaire_ListeSuperficiesLot : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Proprietaire_ListeSuperficiesLot class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_Rapport_Proprietaire_ListeSuperficiesLot() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_Rapport_Proprietaire_ListeSuperficiesLot class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_Rapport_Proprietaire_ListeSuperficiesLot(bool useDefaultValue) {
			...
			this.internal_Param_SuperficieTotalMin_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_SuperficieTotalMax_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_Rapport_Proprietaire_ListeSuperficiesLot'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "jag_Rapport_Proprietaire_ListeSuperficiesLot", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_SuperficieTotalMin = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_SuperficieTotalMax = System.Data.SqlTypes.SqlDouble.Null;
		...
		/// </summary>
		~jag_Rapport_Proprietaire_ListeSuperficiesLot() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_Rapport_Proprietaire_ListeSuperficiesLot'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_Rapport_Proprietaire_ListeSuperficiesLot");
			}
		}
		...
		private System.Data.SqlTypes.SqlDouble internal_Param_SuperficieTotalMin;
		internal bool internal_Param_SuperficieTotalMin_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_SuperficieTotalMax;
		internal bool internal_Param_SuperficieTotalMax_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@SuperficieTotalMin'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_SuperficieTotalMin_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_SuperficieTotalMin {

			get {

				if (this.internal_Param_SuperficieTotalMin_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_SuperficieTotalMin);
			}

			set {

				this.internal_Param_SuperficieTotalMin_UseDefaultValue = false;
				this.internal_Param_SuperficieTotalMin = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@SuperficieTotalMin' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_SuperficieTotalMin_UseDefaultValue() {

			this.internal_Param_SuperficieTotalMin_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@SuperficieTotalMax'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_SuperficieTotalMax_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_SuperficieTotalMax {

			get {

				if (this.internal_Param_SuperficieTotalMax_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_SuperficieTotalMax);
			}

			set {

				this.internal_Param_SuperficieTotalMax_UseDefaultValue = false;
				this.internal_Param_SuperficieTotalMax = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@SuperficieTotalMax' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_SuperficieTotalMax_UseDefaultValue() {

			this.internal_Param_SuperficieTotalMax_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_Rapport_Proprietaire_ListeSuperficiesLot' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:56:58", SqlObjectDependancyName="jag_Rapport_Proprietaire_ListeSuperficiesLot", SqlObjectDependancyRevision=5280)]
#endif
	public sealed class jag_Rapport_Proprietaire_ListeSuperficiesLot : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_Rapport_Proprietaire_ListeSuperficiesLot() : this(false) {
		...
		public jag_Rapport_Proprietaire_ListeSuperficiesLot(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot)");
						}
				...
				sqlCommand.CommandText = "jag_Rapport_Proprietaire_ListeSuperficiesLot";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@SuperficieTotalMin", System.Data.SqlDbType.Float, 8);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_SuperficieTotalMin_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_SuperficieTotalMin.IsNull) {

					sqlParameter.Value = parameters.Param_SuperficieTotalMin;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@SuperficieTotalMax", System.Data.SqlDbType.Float, 8);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_SuperficieTotalMax_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_SuperficieTotalMax.IsNull) {

					sqlParameter.Value = parameters.Param_SuperficieTotalMax;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_Rapport_Proprietaire_ListeSuperficiesLot] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'jag_Rapport_Proprietaire_ListeSuperficiesLot'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Proprietaire_ListeSuperficiesLot", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "jag_Rapport_Proprietaire_ListeSuperficiesLot", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_Rapport_Proprietaire_ListeSuperficiesLot parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
		...
		/// the Execute method of the 'jag_Rapport_Proprietaire_ListeSuperficiesLot' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field SupTotal via shared members
				/// </summary>
				public sealed class Column_SupTotal {

					/// <summary>
					/// Returns "SupTotal"
					/// </summary>
					public const System.String ColumnName = "SupTotal";
					/// <summary>
					/// Returns 6
					/// </summary>
