...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'jag_spI_Permit_Maniwaki'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class jag_spI_Permit_Maniwaki : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the jag_spI_Permit_Maniwaki class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public jag_spI_Permit_Maniwaki() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the jag_spI_Permit_Maniwaki class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public jag_spI_Permit_Maniwaki(bool useDefaultValue) {

			this.useDefaultValue = useDefaultValue;

			this.internal_Param_PermitID_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'jag_spI_Permit_Maniwaki'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "jag_spI_Permit_Maniwaki", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_PermitID = System.Data.SqlTypes.SqlInt32.Null;
		...
		/// </summary>
		~jag_spI_Permit_Maniwaki() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'jag_spI_Permit_Maniwaki'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("jag_spI_Permit_Maniwaki");
			}
		}

		private System.Data.SqlTypes.SqlInt32 internal_Param_RETURN_VALUE;

		private System.Data.SqlTypes.SqlInt32 internal_Param_PermitID;
		internal bool internal_Param_PermitID_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@PermitID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// the parameter default value, consider calling the Param_PermitID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlInt32 Param_PermitID {

			get {

				if (this.internal_Param_PermitID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_PermitID);
			}

			set {

				this.internal_Param_PermitID_UseDefaultValue = false;
				this.internal_Param_PermitID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@PermitID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_PermitID_UseDefaultValue() {

			this.internal_Param_PermitID_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'jag_spI_Permit_Maniwaki' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class jag_spI_Permit_Maniwaki : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public jag_spI_Permit_Maniwaki() : this(false) {
		...
		public jag_spI_Permit_Maniwaki(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki)");
						}
				...
				sqlCommand.CommandText = "jag_spI_Permit_Maniwaki";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@PermitID", System.Data.SqlDbType.Int, 4);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_PermitID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_PermitID.IsNull) {

					sqlParameter.Value = parameters.Param_PermitID;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [jag_spI_Permit_Maniwaki] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.jag_spI_Permit_Maniwaki parameters) {
