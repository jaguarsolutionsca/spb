...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spD_FactureUsine_Detail'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spD_FactureUsine_Detail : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spD_FactureUsine_Detail class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spD_FactureUsine_Detail() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spD_FactureUsine_Detail class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spD_FactureUsine_Detail(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spD_FactureUsine_Detail'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spD_FactureUsine_Detail", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spD_FactureUsine_Detail() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spD_FactureUsine_Detail'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spD_FactureUsine_Detail");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spD_FactureUsine_Detail' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spD_FactureUsine_Detail : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spD_FactureUsine_Detail() : this(false) {
		...
		public spD_FactureUsine_Detail(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail)");
						}
				...
				sqlCommand.CommandText = "spD_FactureUsine_Detail";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spD_FactureUsine_Detail] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spD_FactureUsine_Detail parameters) {
