...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spS_Contingentement_Producteur_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spS_Contingentement_Producteur_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_Contingentement_Producteur_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_Contingentement_Producteur_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_Contingentement_Producteur_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_Contingentement_Producteur_SelectDisplay(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_Contingentement_Producteur_SelectDisplay'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_Contingentement_Producteur_SelectDisplay", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_Contingentement_Producteur_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_Contingentement_Producteur_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_Contingentement_Producteur_SelectDisplay");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_Contingentement_Producteur_SelectDisplay' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spS_Contingentement_Producteur_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_Contingentement_Producteur_SelectDisplay() : this(false) {
		...
		public spS_Contingentement_Producteur_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_Contingentement_Producteur_SelectDisplay";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_Contingentement_Producteur_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_Contingentement_Producteur_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_Contingentement_Producteur_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_Contingentement_Producteur_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["ContingentementID_Display"].Caption = "Contingentement_Record";
				...
				dataset.Tables[tableName].Columns["Superficie_Contingentee"].Caption = "Superficie_Contingentee (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Superficie_Contingentee\" column)";
				dataset.Tables[tableName].Columns["Volume_Demande"].Caption = "Volume_Demande (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Volume_Demande\" column)";
				dataset.Tables[tableName].Columns["Volume_Facteur"].Caption = "Volume_Facteur (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Volume_Facteur\" column)";
				...
				dataset.Tables[tableName].Columns["Volume_Supplementaire"].Caption = "Volume_Supplementaire (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Volume_Supplementaire\" column)";
				dataset.Tables[tableName].Columns["Volume_Accorde"].Caption = "Volume_Accorde (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Volume_Accorde\" column)";
				dataset.Tables[tableName].Columns["Date_Modification"].Caption = "Date_Modification (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Date_Modification\" column)";
				dataset.Tables[tableName].Columns["Volume_Inventaire"].Caption = "Volume_Inventaire (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Volume_Inventaire\" column)";
				dataset.Tables[tableName].Columns["LastLivraison"].Caption = "LastLivraison (update this label in the \"Olymars/ColumnLabel\" extended property of the \"LastLivraison\" column)";
				dataset.Tables[tableName].Columns["VolumeMaximum"].Caption = "VolumeMaximum (update this label in the \"Olymars/ColumnLabel\" extended property of the \"VolumeMaximum\" column)";
				dataset.Tables[tableName].Columns["Imprime"].Caption = "Imprime (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Imprime\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Contingentement_Producteur_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_Contingentement_Producteur_SelectDisplay' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ContingentementID_Display via shared members
				/// </summary>
				public sealed class Column_ContingentementID_Display {

					/// <summary>
					/// Returns "ContingentementID_Display"
					/// </summary>
					public const System.String ColumnName = "ContingentementID_Display";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Superficie_Contingentee via shared members
				/// </summary>
				public sealed class Column_Superficie_Contingentee {

					/// <summary>
					/// Returns "Superficie_Contingentee"
					/// </summary>
					public const System.String ColumnName = "Superficie_Contingentee";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Demande via shared members
				/// </summary>
				public sealed class Column_Volume_Demande {

					/// <summary>
					/// Returns "Volume_Demande"
					/// </summary>
					public const System.String ColumnName = "Volume_Demande";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Facteur via shared members
				/// </summary>
				public sealed class Column_Volume_Facteur {

					/// <summary>
					/// Returns "Volume_Facteur"
					/// </summary>
					public const System.String ColumnName = "Volume_Facteur";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Supplementaire via shared members
				/// </summary>
				public sealed class Column_Volume_Supplementaire {

					/// <summary>
					/// Returns "Volume_Supplementaire"
					/// </summary>
					public const System.String ColumnName = "Volume_Supplementaire";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Accorde via shared members
				/// </summary>
				public sealed class Column_Volume_Accorde {

					/// <summary>
					/// Returns "Volume_Accorde"
					/// </summary>
					public const System.String ColumnName = "Volume_Accorde";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Date_Modification via shared members
				/// </summary>
				public sealed class Column_Date_Modification {

					/// <summary>
					/// Returns "Date_Modification"
					/// </summary>
					public const System.String ColumnName = "Date_Modification";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Volume_Inventaire via shared members
				/// </summary>
				public sealed class Column_Volume_Inventaire {

					/// <summary>
					/// Returns "Volume_Inventaire"
					/// </summary>
					public const System.String ColumnName = "Volume_Inventaire";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LastLivraison via shared members
				/// </summary>
				public sealed class Column_LastLivraison {

					/// <summary>
					/// Returns "LastLivraison"
					/// </summary>
					public const System.String ColumnName = "LastLivraison";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field VolumeMaximum via shared members
				/// </summary>
				public sealed class Column_VolumeMaximum {

					/// <summary>
					/// Returns "VolumeMaximum"
					/// </summary>
					public const System.String ColumnName = "VolumeMaximum";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Imprime via shared members
				/// </summary>
				public sealed class Column_Imprime {

					/// <summary>
					/// Returns "Imprime"
					/// </summary>
					public const System.String ColumnName = "Imprime";
					/// <summary>
					/// Returns 14
					/// </summary>
