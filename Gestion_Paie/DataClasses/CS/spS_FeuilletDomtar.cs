...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spS_FeuilletDomtar'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spS_FeuilletDomtar : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_FeuilletDomtar class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_FeuilletDomtar() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_FeuilletDomtar class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_FeuilletDomtar(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_FeuilletDomtar'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_FeuilletDomtar", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_FeuilletDomtar'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_FeuilletDomtar");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_FeuilletDomtar' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spS_FeuilletDomtar : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_FeuilletDomtar() : this(false) {
		...
		public spS_FeuilletDomtar(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar)");
						}
				...
				sqlCommand.CommandText = "spS_FeuilletDomtar";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_FeuilletDomtar] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_FeuilletDomtar'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_FeuilletDomtar", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_FeuilletDomtar", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["Transaction"].Caption = "Transaction (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Transaction\" column)";
				dataset.Tables[tableName].Columns["TransactionType"].Caption = "TransactionType (update this label in the \"Olymars/ColumnLabel\" extended property of the \"TransactionType\" column)";
				dataset.Tables[tableName].Columns["Fournisseur"].Caption = "Fournisseur (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Fournisseur\" column)";
				dataset.Tables[tableName].Columns["Contrat"].Caption = "Contrat (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Contrat\" column)";
				dataset.Tables[tableName].Columns["Produit"].Caption = "Produit (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Produit\" column)";
				...
				dataset.Tables[tableName].Columns["Carte"].Caption = "Carte (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Carte\" column)";
				dataset.Tables[tableName].Columns["License"].Caption = "License (update this label in the \"Olymars/ColumnLabel\" extended property of the \"License\" column)";
				dataset.Tables[tableName].Columns["Transporteur_Camion"].Caption = "Transporteur_Camion (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Transporteur_Camion\" column)";
				dataset.Tables[tableName].Columns["Producteur"].Caption = "Producteur (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Producteur\" column)";
				dataset.Tables[tableName].Columns["Municipalite"].Caption = "Municipalite (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Municipalite\" column)";
				dataset.Tables[tableName].Columns["Brut"].Caption = "Brut (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Brut\" column)";
				dataset.Tables[tableName].Columns["Tare"].Caption = "Tare (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Tare\" column)";
				dataset.Tables[tableName].Columns["Net"].Caption = "Net (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Net\" column)";
				dataset.Tables[tableName].Columns["Rejets"].Caption = "Rejets (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Rejets\" column)";
				...
				dataset.Tables[tableName].Columns["Pourcent_Sec"].Caption = "Pourcent_Sec (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Pourcent_Sec\" column)";
				dataset.Tables[tableName].Columns["KgSec_Paye"].Caption = "KgSec_Paye (update this label in the \"Olymars/ColumnLabel\" extended property of the \"KgSec_Paye\" column)";
				dataset.Tables[tableName].Columns["Validation"].Caption = "Validation (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Validation\" column)";
				dataset.Tables[tableName].Columns["Transfert"].Caption = "Transfert (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Transfert\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_FeuilletDomtar parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_FeuilletDomtar' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Transaction via shared members
				/// </summary>
				public sealed class Column_Transaction {

					/// <summary>
					/// Returns "Transaction"
					/// </summary>
					public const System.String ColumnName = "Transaction";
					/// <summary>
					/// Returns 0
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TransactionType via shared members
				/// </summary>
				public sealed class Column_TransactionType {

					/// <summary>
					/// Returns "TransactionType"
					/// </summary>
					public const System.String ColumnName = "TransactionType";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Contrat via shared members
				/// </summary>
				public sealed class Column_Contrat {

					/// <summary>
					/// Returns "Contrat"
					/// </summary>
					public const System.String ColumnName = "Contrat";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Produit via shared members
				/// </summary>
				public sealed class Column_Produit {

					/// <summary>
					/// Returns "Produit"
					/// </summary>
					public const System.String ColumnName = "Produit";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Carte via shared members
				/// </summary>
				public sealed class Column_Carte {

					/// <summary>
					/// Returns "Carte"
					/// </summary>
					public const System.String ColumnName = "Carte";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field License via shared members
				/// </summary>
				public sealed class Column_License {

					/// <summary>
					/// Returns "License"
					/// </summary>
					public const System.String ColumnName = "License";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Transporteur_Camion via shared members
				/// </summary>
				public sealed class Column_Transporteur_Camion {

					/// <summary>
					/// Returns "Transporteur_Camion"
					/// </summary>
					public const System.String ColumnName = "Transporteur_Camion";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Brut via shared members
				/// </summary>
				public sealed class Column_Brut {

					/// <summary>
					/// Returns "Brut"
					/// </summary>
					public const System.String ColumnName = "Brut";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Tare via shared members
				/// </summary>
				public sealed class Column_Tare {

					/// <summary>
					/// Returns "Tare"
					/// </summary>
					public const System.String ColumnName = "Tare";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Net via shared members
				/// </summary>
				public sealed class Column_Net {

					/// <summary>
					/// Returns "Net"
					/// </summary>
					public const System.String ColumnName = "Net";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Rejets via shared members
				/// </summary>
				public sealed class Column_Rejets {

					/// <summary>
					/// Returns "Rejets"
					/// </summary>
					public const System.String ColumnName = "Rejets";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Pourcent_Sec via shared members
				/// </summary>
				public sealed class Column_Pourcent_Sec {

					/// <summary>
					/// Returns "Pourcent_Sec"
					/// </summary>
					public const System.String ColumnName = "Pourcent_Sec";
					/// <summary>
					/// Returns 16
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field KgSec_Paye via shared members
				/// </summary>
				public sealed class Column_KgSec_Paye {

					/// <summary>
					/// Returns "KgSec_Paye"
					/// </summary>
					public const System.String ColumnName = "KgSec_Paye";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Validation via shared members
				/// </summary>
				public sealed class Column_Validation {

					/// <summary>
					/// Returns "Validation"
					/// </summary>
					public const System.String ColumnName = "Validation";
					/// <summary>
					/// Returns 18
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Transfert via shared members
				/// </summary>
				public sealed class Column_Transfert {

					/// <summary>
					/// Returns "Transfert"
					/// </summary>
					public const System.String ColumnName = "Transfert";
					/// <summary>
					/// Returns 19
					/// </summary>
