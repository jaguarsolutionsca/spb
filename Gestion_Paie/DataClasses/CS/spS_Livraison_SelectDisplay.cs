...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spS_Livraison_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spS_Livraison_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_Livraison_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_Livraison_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_Livraison_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_Livraison_SelectDisplay(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_Livraison_SelectDisplay'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_Livraison_SelectDisplay", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_Livraison_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_Livraison_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_Livraison_SelectDisplay");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_Livraison_SelectDisplay' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spS_Livraison_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_Livraison_SelectDisplay() : this(false) {
		...
		public spS_Livraison_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_Livraison_SelectDisplay";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_Livraison_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_Livraison_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_Livraison_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_Livraison_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["ID_Display"].Caption = "Permit_Record";
				...
				dataset.Tables[tableName].Columns["ContratID_Display"].Caption = "Contrat_Record";
				...
				dataset.Tables[tableName].Columns["UniteMesureID_Display"].Caption = "UniteMesure_Record";
				...
				dataset.Tables[tableName].Columns["DroitCoupeID_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["EntentePaiementID_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["TransporteurID_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Annee_Display"].Caption = "Periode_Record";
				...
				dataset.Tables[tableName].Columns["Periode_Display"].Caption = "Periode_Record";
				...
				dataset.Tables[tableName].Columns["Producteur1_FactureID_Display"].Caption = "FactureFournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Producteur2_FactureID_Display"].Caption = "FactureFournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Transporteur_FactureID_Display"].Caption = "FactureFournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Usine_FactureID_Display"].Caption = "FactureClient_Record";
				...
				dataset.Tables[tableName].Columns["LotID_Display"].Caption = "Lot_Record";
				...
				dataset.Tables[tableName].Columns["ChargeurID_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Chargeur_FactureID_Display"].Caption = "FactureFournisseur_Record";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Livraison_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_Livraison_SelectDisplay' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ID_Display via shared members
				/// </summary>
				public sealed class Column_ID_Display {

					/// <summary>
					/// Returns "ID_Display"
					/// </summary>
					public const System.String ColumnName = "ID_Display";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field UniteMesureID_Display via shared members
				/// </summary>
				public sealed class Column_UniteMesureID_Display {

					/// <summary>
					/// Returns "UniteMesureID_Display"
					/// </summary>
					public const System.String ColumnName = "UniteMesureID_Display";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field DroitCoupeID_Display via shared members
				/// </summary>
				public sealed class Column_DroitCoupeID_Display {

					/// <summary>
					/// Returns "DroitCoupeID_Display"
					/// </summary>
					public const System.String ColumnName = "DroitCoupeID_Display";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field EntentePaiementID_Display via shared members
				/// </summary>
				public sealed class Column_EntentePaiementID_Display {

					/// <summary>
					/// Returns "EntentePaiementID_Display"
					/// </summary>
					public const System.String ColumnName = "EntentePaiementID_Display";
					/// <summary>
					/// Returns 15
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field TransporteurID_Display via shared members
				/// </summary>
				public sealed class Column_TransporteurID_Display {

					/// <summary>
					/// Returns "TransporteurID_Display"
					/// </summary>
					public const System.String ColumnName = "TransporteurID_Display";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Annee_Display via shared members
				/// </summary>
				public sealed class Column_Annee_Display {

					/// <summary>
					/// Returns "Annee_Display"
					/// </summary>
					public const System.String ColumnName = "Annee_Display";
					/// <summary>
					/// Returns 26
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Periode_Display via shared members
				/// </summary>
				public sealed class Column_Periode_Display {

					/// <summary>
					/// Returns "Periode_Display"
					/// </summary>
					public const System.String ColumnName = "Periode_Display";
					/// <summary>
					/// Returns 28
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Producteur1_FactureID_Display via shared members
				/// </summary>
				public sealed class Column_Producteur1_FactureID_Display {

					/// <summary>
					/// Returns "Producteur1_FactureID_Display"
					/// </summary>
					public const System.String ColumnName = "Producteur1_FactureID_Display";
					/// <summary>
					/// Returns 43
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Producteur2_FactureID_Display via shared members
				/// </summary>
				public sealed class Column_Producteur2_FactureID_Display {

					/// <summary>
					/// Returns "Producteur2_FactureID_Display"
					/// </summary>
					public const System.String ColumnName = "Producteur2_FactureID_Display";
					/// <summary>
					/// Returns 45
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Transporteur_FactureID_Display via shared members
				/// </summary>
				public sealed class Column_Transporteur_FactureID_Display {

					/// <summary>
					/// Returns "Transporteur_FactureID_Display"
					/// </summary>
					public const System.String ColumnName = "Transporteur_FactureID_Display";
					/// <summary>
					/// Returns 47
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Usine_FactureID_Display via shared members
				/// </summary>
				public sealed class Column_Usine_FactureID_Display {

					/// <summary>
					/// Returns "Usine_FactureID_Display"
					/// </summary>
					public const System.String ColumnName = "Usine_FactureID_Display";
					/// <summary>
					/// Returns 49
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LotID_Display via shared members
				/// </summary>
				public sealed class Column_LotID_Display {

					/// <summary>
					/// Returns "LotID_Display"
					/// </summary>
					public const System.String ColumnName = "LotID_Display";
					/// <summary>
					/// Returns 53
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ChargeurID_Display via shared members
				/// </summary>
				public sealed class Column_ChargeurID_Display {

					/// <summary>
					/// Returns "ChargeurID_Display"
					/// </summary>
					public const System.String ColumnName = "ChargeurID_Display";
					/// <summary>
					/// Returns 65
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Chargeur_FactureID_Display via shared members
				/// </summary>
				public sealed class Column_Chargeur_FactureID_Display {

					/// <summary>
					/// Returns "Chargeur_FactureID_Display"
					/// </summary>
					public const System.String ColumnName = "Chargeur_FactureID_Display";
					/// <summary>
					/// Returns 75
					/// </summary>
