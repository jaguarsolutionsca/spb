...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spS_Usine_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:23", SqlObjectDependancyName="spS_Usine_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spS_Usine_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_Usine_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_Usine_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_Usine_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_Usine_SelectDisplay(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_Usine_SelectDisplay'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_Usine_SelectDisplay", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_Usine_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_Usine_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_Usine_SelectDisplay");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_Usine_SelectDisplay' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:23", SqlObjectDependancyName="spS_Usine_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spS_Usine_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_Usine_SelectDisplay() : this(false) {
		...
		public spS_Usine_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_Usine_SelectDisplay";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_Usine_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_Usine_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_Usine_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_Usine_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["UtilisationID_Display"].Caption = "UsineUtilisation_Record";
				...
				dataset.Tables[tableName].Columns["Compte_a_recevoir_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_ajustement_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_transporteur_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_producteur_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_preleve_plan_conjoint_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_preleve_fond_roulement_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_preleve_fond_forestier_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_preleve_divers_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_mise_en_commun_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_surcharge_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_indexation_carburant_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["PaysID_Display"].Caption = "Pays_Record";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_Usine_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_Usine_SelectDisplay' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field UtilisationID_Display via shared members
				/// </summary>
				public sealed class Column_UtilisationID_Display {

					/// <summary>
					/// Returns "UtilisationID_Display"
					/// </summary>
					public const System.String ColumnName = "UtilisationID_Display";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_a_recevoir_Display via shared members
				/// </summary>
				public sealed class Column_Compte_a_recevoir_Display {

					/// <summary>
					/// Returns "Compte_a_recevoir_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_a_recevoir_Display";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_ajustement_Display via shared members
				/// </summary>
				public sealed class Column_Compte_ajustement_Display {

					/// <summary>
					/// Returns "Compte_ajustement_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_ajustement_Display";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_transporteur_Display via shared members
				/// </summary>
				public sealed class Column_Compte_transporteur_Display {

					/// <summary>
					/// Returns "Compte_transporteur_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_transporteur_Display";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_producteur_Display via shared members
				/// </summary>
				public sealed class Column_Compte_producteur_Display {

					/// <summary>
					/// Returns "Compte_producteur_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_producteur_Display";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_preleve_plan_conjoint_Display via shared members
				/// </summary>
				public sealed class Column_Compte_preleve_plan_conjoint_Display {

					/// <summary>
					/// Returns "Compte_preleve_plan_conjoint_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_preleve_plan_conjoint_Display";
					/// <summary>
					/// Returns 16
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_preleve_fond_roulement_Display via shared members
				/// </summary>
				public sealed class Column_Compte_preleve_fond_roulement_Display {

					/// <summary>
					/// Returns "Compte_preleve_fond_roulement_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_preleve_fond_roulement_Display";
					/// <summary>
					/// Returns 18
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_preleve_fond_forestier_Display via shared members
				/// </summary>
				public sealed class Column_Compte_preleve_fond_forestier_Display {

					/// <summary>
					/// Returns "Compte_preleve_fond_forestier_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_preleve_fond_forestier_Display";
					/// <summary>
					/// Returns 20
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_preleve_divers_Display via shared members
				/// </summary>
				public sealed class Column_Compte_preleve_divers_Display {

					/// <summary>
					/// Returns "Compte_preleve_divers_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_preleve_divers_Display";
					/// <summary>
					/// Returns 22
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_mise_en_commun_Display via shared members
				/// </summary>
				public sealed class Column_Compte_mise_en_commun_Display {

					/// <summary>
					/// Returns "Compte_mise_en_commun_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_mise_en_commun_Display";
					/// <summary>
					/// Returns 24
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_surcharge_Display via shared members
				/// </summary>
				public sealed class Column_Compte_surcharge_Display {

					/// <summary>
					/// Returns "Compte_surcharge_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_surcharge_Display";
					/// <summary>
					/// Returns 26
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_indexation_carburant_Display via shared members
				/// </summary>
				public sealed class Column_Compte_indexation_carburant_Display {

					/// <summary>
					/// Returns "Compte_indexation_carburant_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_indexation_carburant_Display";
					/// <summary>
					/// Returns 28
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaysID_Display via shared members
				/// </summary>
				public sealed class Column_PaysID_Display {

					/// <summary>
					/// Returns "PaysID_Display"
					/// </summary>
					public const System.String ColumnName = "PaysID_Display";
					/// <summary>
					/// Returns 40
					/// </summary>
