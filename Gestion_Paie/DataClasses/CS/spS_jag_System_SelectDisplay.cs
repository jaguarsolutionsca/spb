...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spS_jag_System_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:24", SqlObjectDependancyName="spS_jag_System_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spS_jag_System_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_jag_System_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_jag_System_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_jag_System_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_jag_System_SelectDisplay(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_jag_System_SelectDisplay'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_jag_System_SelectDisplay", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_jag_System_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_jag_System_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_jag_System_SelectDisplay");
			}
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_jag_System_SelectDisplay' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:24", SqlObjectDependancyName="spS_jag_System_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spS_jag_System_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_jag_System_SelectDisplay() : this(false) {
		...
		public spS_jag_System_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_jag_System_SelectDisplay";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_jag_System_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_jag_System_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_jag_System_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_jag_System_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["Fournisseur_PlanConjoint_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Fournisseur_Surcharge_Display"].Caption = "Fournisseur_Record";
				...
				dataset.Tables[tableName].Columns["Compte_Paiements_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_ARecevoir_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_APayer_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_DuAuxProducteurs_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_TPSpercues_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_TPSpayees_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_TVQpercues_Display"].Caption = "Compte_Record";
				...
				dataset.Tables[tableName].Columns["Compte_TVQpayees_Display"].Caption = "Compte_Record";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spS_jag_System_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_jag_System_SelectDisplay' class.
		/// </summary>
		public sealed class Resultset1 {
			...
			public sealed class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Fournisseur_PlanConjoint_Display via shared members
				/// </summary>
				public sealed class Column_Fournisseur_PlanConjoint_Display {

					/// <summary>
					/// Returns "Fournisseur_PlanConjoint_Display"
					/// </summary>
					public const System.String ColumnName = "Fournisseur_PlanConjoint_Display";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Fournisseur_Surcharge_Display via shared members
				/// </summary>
				public sealed class Column_Fournisseur_Surcharge_Display {

					/// <summary>
					/// Returns "Fournisseur_Surcharge_Display"
					/// </summary>
					public const System.String ColumnName = "Fournisseur_Surcharge_Display";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_Paiements_Display via shared members
				/// </summary>
				public sealed class Column_Compte_Paiements_Display {

					/// <summary>
					/// Returns "Compte_Paiements_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_Paiements_Display";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_ARecevoir_Display via shared members
				/// </summary>
				public sealed class Column_Compte_ARecevoir_Display {

					/// <summary>
					/// Returns "Compte_ARecevoir_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_ARecevoir_Display";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_APayer_Display via shared members
				/// </summary>
				public sealed class Column_Compte_APayer_Display {

					/// <summary>
					/// Returns "Compte_APayer_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_APayer_Display";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_DuAuxProducteurs_Display via shared members
				/// </summary>
				public sealed class Column_Compte_DuAuxProducteurs_Display {

					/// <summary>
					/// Returns "Compte_DuAuxProducteurs_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_DuAuxProducteurs_Display";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_TPSpercues_Display via shared members
				/// </summary>
				public sealed class Column_Compte_TPSpercues_Display {

					/// <summary>
					/// Returns "Compte_TPSpercues_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_TPSpercues_Display";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_TPSpayees_Display via shared members
				/// </summary>
				public sealed class Column_Compte_TPSpayees_Display {

					/// <summary>
					/// Returns "Compte_TPSpayees_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_TPSpayees_Display";
					/// <summary>
					/// Returns 15
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_TVQpercues_Display via shared members
				/// </summary>
				public sealed class Column_Compte_TVQpercues_Display {

					/// <summary>
					/// Returns "Compte_TVQpercues_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_TVQpercues_Display";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Compte_TVQpayees_Display via shared members
				/// </summary>
				public sealed class Column_Compte_TVQpayees_Display {

					/// <summary>
					/// Returns "Compte_TVQpayees_Display"
					/// </summary>
					public const System.String ColumnName = "Compte_TVQpayees_Display";
					/// <summary>
					/// Returns 19
					/// </summary>
