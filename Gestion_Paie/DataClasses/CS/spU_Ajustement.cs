...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Ajustement'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_Ajustement : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Ajustement class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Ajustement() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Ajustement class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Ajustement(bool useDefaultValue) {
			...
			this.internal_Param_DateAjustement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DateAjustement_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_UsePeriodes_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_IsRistourne_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsRistourne_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Ajustement'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Ajustement", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_DateAjustement = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_DateAjustement = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_UsePeriodes = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_UsePeriodes = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_IsRistourne = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsRistourne = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Ajustement'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Ajustement");
			}
		}
		...
		private System.Data.SqlTypes.SqlDateTime internal_Param_DateAjustement;
		internal bool internal_Param_DateAjustement_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DateAjustement;
		internal bool internal_Param_ConsiderNull_DateAjustement_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_UsePeriodes;
		internal bool internal_Param_UsePeriodes_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_UsePeriodes;
		internal bool internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_IsRistourne;
		internal bool internal_Param_IsRistourne_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsRistourne;
		internal bool internal_Param_ConsiderNull_IsRistourne_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateAjustement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateAjustement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateAjustement {

			get {

				if (this.internal_Param_DateAjustement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateAjustement);
			}

			set {

				this.internal_Param_DateAjustement_UseDefaultValue = false;
				this.internal_Param_DateAjustement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateAjustement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateAjustement_UseDefaultValue() {

			this.internal_Param_DateAjustement_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DateAjustement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DateAjustement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DateAjustement {

			get {

				if (this.internal_Param_ConsiderNull_DateAjustement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DateAjustement);
			}

			set {

				this.internal_Param_ConsiderNull_DateAjustement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DateAjustement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DateAjustement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DateAjustement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DateAjustement_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@UsePeriodes'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_UsePeriodes_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_UsePeriodes {

			get {

				if (this.internal_Param_UsePeriodes_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_UsePeriodes);
			}

			set {

				this.internal_Param_UsePeriodes_UseDefaultValue = false;
				this.internal_Param_UsePeriodes = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@UsePeriodes' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_UsePeriodes_UseDefaultValue() {

			this.internal_Param_UsePeriodes_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_UsePeriodes'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_UsePeriodes_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_UsePeriodes {

			get {

				if (this.internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_UsePeriodes);
			}

			set {

				this.internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_UsePeriodes = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_UsePeriodes' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_UsePeriodes_UseDefaultValue() {

			this.internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@IsRistourne'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_IsRistourne_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_IsRistourne {

			get {

				if (this.internal_Param_IsRistourne_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_IsRistourne);
			}

			set {

				this.internal_Param_IsRistourne_UseDefaultValue = false;
				this.internal_Param_IsRistourne = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@IsRistourne' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_IsRistourne_UseDefaultValue() {

			this.internal_Param_IsRistourne_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsRistourne'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsRistourne_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsRistourne {

			get {

				if (this.internal_Param_ConsiderNull_IsRistourne_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsRistourne);
			}

			set {

				this.internal_Param_ConsiderNull_IsRistourne_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsRistourne = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsRistourne' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsRistourne_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsRistourne_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Ajustement' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_Ajustement : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Ajustement() : this(false) {
		...
		public spU_Ajustement(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Ajustement parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Ajustement parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Ajustement object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Ajustement object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Ajustement object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Ajustement)");
						}
				...
				sqlCommand.CommandText = "spU_Ajustement";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Ajustement parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateAjustement", System.Data.SqlDbType.DateTime, 16);
				sqlParameter.SourceColumn = "DateAjustement";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateAjustement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateAjustement.IsNull) {

					sqlParameter.Value = parameters.Param_DateAjustement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DateAjustement", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DateAjustement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DateAjustement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DateAjustement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@UsePeriodes", System.Data.SqlDbType.Bit, 1);
				sqlParameter.SourceColumn = "UsePeriodes";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_UsePeriodes_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_UsePeriodes.IsNull) {

					sqlParameter.Value = parameters.Param_UsePeriodes;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_UsePeriodes", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_UsePeriodes_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_UsePeriodes.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_UsePeriodes;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@IsRistourne", System.Data.SqlDbType.Bit, 1);
				sqlParameter.SourceColumn = "IsRistourne";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_IsRistourne_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_IsRistourne.IsNull) {

					sqlParameter.Value = parameters.Param_IsRistourne;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_IsRistourne", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsRistourne_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsRistourne.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsRistourne;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Ajustement parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Ajustement] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Ajustement parameters) {
