...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Cert_Proprietaire'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_Cert_Proprietaire : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Cert_Proprietaire class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Cert_Proprietaire() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Cert_Proprietaire class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Cert_Proprietaire(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_Representant_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ADRESSE_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_ADRESSE_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_CODE_POST_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_TEL_RES_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_TEL_RES_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_TEL_BUR_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Traite_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Traite_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Methode_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Methode_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Cert_Proprietaire'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Cert_Proprietaire", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_Representant = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ADRESSE = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_ADRESSE = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_CODE_POST = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_TEL_RES = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_TEL_RES = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_TEL_BUR = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_TEL_BUR = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_FournisseurNom = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Traite = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Traite = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Methode = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Methode = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_Cert_Proprietaire() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Cert_Proprietaire'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Cert_Proprietaire");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Representant;
		internal bool internal_Param_ConsiderNull_Representant_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_ADRESSE;
		internal bool internal_Param_ADRESSE_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ADRESSE;
		internal bool internal_Param_ConsiderNull_ADRESSE_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_CODE_POST;
		internal bool internal_Param_ConsiderNull_CODE_POST_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_TEL_RES;
		internal bool internal_Param_TEL_RES_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TEL_RES;
		internal bool internal_Param_ConsiderNull_TEL_RES_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_TEL_BUR;
		internal bool internal_Param_TEL_BUR_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TEL_BUR;
		internal bool internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_FournisseurNom;
		internal bool internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_Traite;
		internal bool internal_Param_Traite_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Traite;
		internal bool internal_Param_ConsiderNull_Traite_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Methode;
		internal bool internal_Param_Methode_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Methode;
		internal bool internal_Param_ConsiderNull_Methode_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Representant'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Representant_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Representant {

			get {

				if (this.internal_Param_ConsiderNull_Representant_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Representant);
			}

			set {

				this.internal_Param_ConsiderNull_Representant_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Representant = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Representant' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Representant_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Representant_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ADRESSE'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ADRESSE_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ADRESSE {

			get {

				if (this.internal_Param_ConsiderNull_ADRESSE_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ADRESSE);
			}

			set {

				this.internal_Param_ConsiderNull_ADRESSE_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ADRESSE = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ADRESSE' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ADRESSE_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ADRESSE_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_CODE_POST'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_CODE_POST_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_CODE_POST {

			get {

				if (this.internal_Param_ConsiderNull_CODE_POST_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_CODE_POST);
			}

			set {

				this.internal_Param_ConsiderNull_CODE_POST_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_CODE_POST = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_CODE_POST' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_CODE_POST_UseDefaultValue() {

			this.internal_Param_ConsiderNull_CODE_POST_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TEL_RES'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TEL_RES_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TEL_RES {

			get {

				if (this.internal_Param_ConsiderNull_TEL_RES_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TEL_RES);
			}

			set {

				this.internal_Param_ConsiderNull_TEL_RES_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TEL_RES = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TEL_RES' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TEL_RES_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TEL_RES_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TEL_BUR'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TEL_BUR_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TEL_BUR {

			get {

				if (this.internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TEL_BUR);
			}

			set {

				this.internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TEL_BUR = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TEL_BUR' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TEL_BUR_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_FournisseurNom'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_FournisseurNom_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_FournisseurNom {

			get {

				if (this.internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_FournisseurNom);
			}

			set {

				this.internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_FournisseurNom = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_FournisseurNom' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_FournisseurNom_UseDefaultValue() {

			this.internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Traite'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Traite_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Traite {

			get {

				if (this.internal_Param_ConsiderNull_Traite_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Traite);
			}

			set {

				this.internal_Param_ConsiderNull_Traite_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Traite = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Traite' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Traite_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Traite_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Methode'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Methode_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Methode {

			get {

				if (this.internal_Param_ConsiderNull_Methode_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Methode);
			}

			set {

				this.internal_Param_ConsiderNull_Methode_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Methode = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Methode' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Methode_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Methode_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Cert_Proprietaire' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_Cert_Proprietaire : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Cert_Proprietaire() : this(false) {
		...
		public spU_Cert_Proprietaire(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire)");
						}
				...
				sqlCommand.CommandText = "spU_Cert_Proprietaire";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Representant", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Representant_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Representant.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Representant;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_ADRESSE", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ADRESSE_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ADRESSE.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ADRESSE;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_CODE_POST", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_CODE_POST_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_CODE_POST.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_CODE_POST;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TEL_RES", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TEL_RES_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TEL_RES.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TEL_RES;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TEL_BUR", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TEL_BUR_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TEL_BUR.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TEL_BUR;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_FournisseurNom", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_FournisseurNom_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_FournisseurNom.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_FournisseurNom;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Traite", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Traite_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Traite.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Traite;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Methode", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Methode_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Methode.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Methode;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Cert_Proprietaire] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Cert_Proprietaire parameters) {
