...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Contingentement'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_Contingentement : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Contingentement class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Contingentement() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Contingentement class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Contingentement(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_UsineID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_UsineID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_RegroupementID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_RegroupementID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PeriodeDebut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PeriodeFin_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Facteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Facteur_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_CalculAccepte_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Volume_RegroupementPourcentage_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_MaxVolumeFixe_Pourcentage_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_MaxVolumeFixe_ContingentementID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_UseVolumeFixeUnique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_MasseContingentVoyageDefaut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Contingentement'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Contingentement", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_ContingentUsine = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_UsineID = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_UsineID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_RegroupementID = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_RegroupementID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_PeriodeContingentement = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PeriodeDebut = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_PeriodeDebut = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PeriodeFin = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_PeriodeFin = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Volume_Usine = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Facteur = System.Data.SqlTypes.SqlSingle.Null;
				this.internal_Param_ConsiderNull_Facteur = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Date_Calcul = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_CalculAccepte = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_CalculAccepte = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Volume_Regroupement = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Volume_RegroupementPourcentage = System.Data.SqlTypes.SqlSingle.Null;
				this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_MaxVolumeFixe_Pourcentage = System.Data.SqlTypes.SqlSingle.Null;
				this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_MaxVolumeFixe_ContingentementID = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_UseVolumeFixeUnique = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_UseVolumeFixeUnique = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_MasseContingentVoyageDefaut = System.Data.SqlTypes.SqlSingle.Null;
				this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Contingentement'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Contingentement");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ContingentUsine;
		internal bool internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_UsineID;
		internal bool internal_Param_UsineID_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_UsineID;
		internal bool internal_Param_ConsiderNull_UsineID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_RegroupementID;
		internal bool internal_Param_ConsiderNull_RegroupementID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PeriodeContingentement;
		internal bool internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PeriodeDebut;
		internal bool internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PeriodeFin;
		internal bool internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Volume_Usine;
		internal bool internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlSingle internal_Param_Facteur;
		internal bool internal_Param_Facteur_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Facteur;
		internal bool internal_Param_ConsiderNull_Facteur_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Date_Calcul;
		internal bool internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_CalculAccepte;
		internal bool internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Volume_Regroupement;
		internal bool internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Volume_RegroupementPourcentage;
		internal bool internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage;
		internal bool internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID;
		internal bool internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_UseVolumeFixeUnique;
		internal bool internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_MasseContingentVoyageDefaut;
		internal bool internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ContingentUsine'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ContingentUsine_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ContingentUsine {

			get {

				if (this.internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ContingentUsine);
			}

			set {

				this.internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ContingentUsine = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ContingentUsine' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ContingentUsine_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_UsineID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_UsineID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_UsineID {

			get {

				if (this.internal_Param_ConsiderNull_UsineID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_UsineID);
			}

			set {

				this.internal_Param_ConsiderNull_UsineID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_UsineID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_UsineID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_UsineID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_UsineID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_RegroupementID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_RegroupementID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_RegroupementID {

			get {

				if (this.internal_Param_ConsiderNull_RegroupementID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_RegroupementID);
			}

			set {

				this.internal_Param_ConsiderNull_RegroupementID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_RegroupementID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_RegroupementID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_RegroupementID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_RegroupementID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PeriodeContingentement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PeriodeContingentement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PeriodeContingentement {

			get {

				if (this.internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PeriodeContingentement);
			}

			set {

				this.internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PeriodeContingentement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PeriodeContingentement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PeriodeContingentement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PeriodeDebut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PeriodeDebut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PeriodeDebut {

			get {

				if (this.internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PeriodeDebut);
			}

			set {

				this.internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PeriodeDebut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PeriodeDebut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PeriodeDebut_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PeriodeFin'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PeriodeFin_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PeriodeFin {

			get {

				if (this.internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PeriodeFin);
			}

			set {

				this.internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PeriodeFin = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PeriodeFin' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PeriodeFin_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Volume_Usine'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Volume_Usine_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Volume_Usine {

			get {

				if (this.internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Volume_Usine);
			}

			set {

				this.internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Volume_Usine = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Volume_Usine' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Volume_Usine_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Facteur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Facteur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Facteur {

			get {

				if (this.internal_Param_ConsiderNull_Facteur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Facteur);
			}

			set {

				this.internal_Param_ConsiderNull_Facteur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Facteur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Facteur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Facteur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Facteur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Date_Calcul'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Date_Calcul_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Date_Calcul {

			get {

				if (this.internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Date_Calcul);
			}

			set {

				this.internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Date_Calcul = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Date_Calcul' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Date_Calcul_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_CalculAccepte'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_CalculAccepte_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_CalculAccepte {

			get {

				if (this.internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_CalculAccepte);
			}

			set {

				this.internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_CalculAccepte = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_CalculAccepte' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_CalculAccepte_UseDefaultValue() {

			this.internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Volume_Regroupement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Volume_Regroupement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Volume_Regroupement {

			get {

				if (this.internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Volume_Regroupement);
			}

			set {

				this.internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Volume_Regroupement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Volume_Regroupement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Volume_Regroupement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Volume_RegroupementPourcentage'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Volume_RegroupementPourcentage {

			get {

				if (this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage);
			}

			set {

				this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Volume_RegroupementPourcentage' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_MaxVolumeFixe_Pourcentage'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_MaxVolumeFixe_Pourcentage {

			get {

				if (this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage);
			}

			set {

				this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_MaxVolumeFixe_Pourcentage' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue() {

			this.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_MaxVolumeFixe_ContingentementID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_MaxVolumeFixe_ContingentementID {

			get {

				if (this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID);
			}

			set {

				this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_MaxVolumeFixe_ContingentementID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_UseVolumeFixeUnique'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_UseVolumeFixeUnique {

			get {

				if (this.internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_UseVolumeFixeUnique);
			}

			set {

				this.internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_UseVolumeFixeUnique = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_UseVolumeFixeUnique' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue() {

			this.internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_MasseContingentVoyageDefaut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_MasseContingentVoyageDefaut {

			get {

				if (this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut);
			}

			set {

				this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_MasseContingentVoyageDefaut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue() {

			this.internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Contingentement' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_Contingentement : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Contingentement() : this(false) {
		...
		public spU_Contingentement(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Contingentement)");
						}
				...
				sqlCommand.CommandText = "spU_Contingentement";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ContingentUsine_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ContingentUsine.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ContingentUsine;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_UsineID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_UsineID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_UsineID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_RegroupementID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_RegroupementID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_RegroupementID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PeriodeContingentement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PeriodeContingentement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PeriodeContingentement;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PeriodeDebut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PeriodeDebut.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PeriodeDebut;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PeriodeFin_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PeriodeFin.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PeriodeFin;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Volume_Usine_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Volume_Usine.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Volume_Usine;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Facteur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Facteur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Facteur;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Date_Calcul_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Date_Calcul.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Date_Calcul;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_CalculAccepte_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_CalculAccepte.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_CalculAccepte;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Volume_Regroupement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Volume_Regroupement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Volume_Regroupement;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Volume_RegroupementPourcentage_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Volume_RegroupementPourcentage.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Volume_RegroupementPourcentage;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_MaxVolumeFixe_Pourcentage_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_MaxVolumeFixe_Pourcentage.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_MaxVolumeFixe_Pourcentage;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_MaxVolumeFixe_ContingentementID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_MaxVolumeFixe_ContingentementID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_MaxVolumeFixe_ContingentementID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_UseVolumeFixeUnique_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_UseVolumeFixeUnique.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_UseVolumeFixeUnique;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_MasseContingentVoyageDefaut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_MasseContingentVoyageDefaut.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_MasseContingentVoyageDefaut;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Contingentement] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement parameters) {
