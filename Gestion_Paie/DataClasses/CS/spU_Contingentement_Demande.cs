...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Contingentement_Demande'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_Contingentement_Demande : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Contingentement_Demande class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Contingentement_Demande() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Contingentement_Demande class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Contingentement_Demande(bool useDefaultValue) {
			...
			this.internal_Param_DateModification_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DateModification_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Contingentement_Demande'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Contingentement_Demande", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_DateModification = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_DateModification = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_Contingentement_Demande() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Contingentement_Demande'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Contingentement_Demande");
			}
		}
		...
		private System.Data.SqlTypes.SqlDateTime internal_Param_DateModification;
		internal bool internal_Param_DateModification_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DateModification;
		internal bool internal_Param_ConsiderNull_DateModification_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@DateModification'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_DateModification_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_DateModification {

			get {

				if (this.internal_Param_DateModification_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_DateModification);
			}

			set {

				this.internal_Param_DateModification_UseDefaultValue = false;
				this.internal_Param_DateModification = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@DateModification' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_DateModification_UseDefaultValue() {

			this.internal_Param_DateModification_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DateModification'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DateModification_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DateModification {

			get {

				if (this.internal_Param_ConsiderNull_DateModification_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DateModification);
			}

			set {

				this.internal_Param_ConsiderNull_DateModification_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DateModification = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DateModification' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DateModification_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DateModification_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Contingentement_Demande' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_Contingentement_Demande : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Contingentement_Demande() : this(false) {
		...
		public spU_Contingentement_Demande(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande)");
						}
				...
				sqlCommand.CommandText = "spU_Contingentement_Demande";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@DateModification", System.Data.SqlDbType.SmallDateTime, 16);
				sqlParameter.SourceColumn = "DateModification";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_DateModification_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_DateModification.IsNull) {

					sqlParameter.Value = parameters.Param_DateModification;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DateModification", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DateModification_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DateModification.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DateModification;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Contingentement_Demande] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Contingentement_Demande parameters) {
