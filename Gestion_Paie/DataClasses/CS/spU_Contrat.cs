/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 13/09/2006 11:57:24 AM
...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Contrat'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:24", SqlObjectDependancyName="spU_Contrat", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Contrat : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Contrat class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Contrat() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Contrat class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Contrat(bool useDefaultValue) {
			...
			this.internal_Param_Taux_Surcharge_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_TxTransSameProd_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Contrat'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_Taux_Surcharge = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Taux_Surcharge = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_TxTransSameProd = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_TxTransSameProd = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Contrat'.
		/// </summary>
		...
		private System.Data.SqlTypes.SqlDouble internal_Param_Taux_Surcharge;
		internal bool internal_Param_Taux_Surcharge_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Surcharge;
		internal bool internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_TxTransSameProd;
		internal bool internal_Param_TxTransSameProd_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TxTransSameProd;
		internal bool internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Taux_Surcharge'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Taux_Surcharge_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Taux_Surcharge {

			get {

				if (this.internal_Param_Taux_Surcharge_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Taux_Surcharge);
			}

			set {

				this.internal_Param_Taux_Surcharge_UseDefaultValue = false;
				this.internal_Param_Taux_Surcharge = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Taux_Surcharge' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Taux_Surcharge_UseDefaultValue() {

			this.internal_Param_Taux_Surcharge_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Surcharge'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Surcharge_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Surcharge {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Surcharge);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Surcharge = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Surcharge' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Surcharge_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@TxTransSameProd'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_TxTransSameProd_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_TxTransSameProd {

			get {

				if (this.internal_Param_TxTransSameProd_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_TxTransSameProd);
			}

			set {

				this.internal_Param_TxTransSameProd_UseDefaultValue = false;
				this.internal_Param_TxTransSameProd = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@TxTransSameProd' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_TxTransSameProd_UseDefaultValue() {

			this.internal_Param_TxTransSameProd_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TxTransSameProd'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TxTransSameProd_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TxTransSameProd {

			get {

				if (this.internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TxTransSameProd);
			}

			set {

				this.internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TxTransSameProd = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TxTransSameProd' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TxTransSameProd_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Contrat' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:24", SqlObjectDependancyName="spU_Contrat", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Contrat : MarshalByRefObject, IDisposable {
		...
		public spU_Contrat(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Contrat)");
						}
				...
				sqlCommand.CommandText = "spU_Contrat";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ID", System.Data.SqlDbType.VarChar, 10);
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Taux_Surcharge", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Taux_Surcharge";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Taux_Surcharge_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Taux_Surcharge.IsNull) {

					sqlParameter.Value = parameters.Param_Taux_Surcharge;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Surcharge", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Surcharge_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Surcharge.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Surcharge;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@TxTransSameProd", System.Data.SqlDbType.Bit, 1);
				sqlParameter.SourceColumn = "TxTransSameProd";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_TxTransSameProd_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_TxTransSameProd.IsNull) {

					sqlParameter.Value = parameters.Param_TxTransSameProd;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TxTransSameProd", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TxTransSameProd_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TxTransSameProd.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TxTransSameProd;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Contrat] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat parameters) {
