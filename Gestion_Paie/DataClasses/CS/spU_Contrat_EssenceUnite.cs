...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Contrat_EssenceUnite'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:24", SqlObjectDependancyName="spU_Contrat_EssenceUnite", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Contrat_EssenceUnite : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Contrat_EssenceUnite class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Contrat_EssenceUnite() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Contrat_EssenceUnite class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Contrat_EssenceUnite(bool useDefaultValue) {
			...
			this.internal_Param_Quantite_prevue_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Contrat_EssenceUnite'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_Quantite_prevue = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Quantite_prevue = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_Taux_producteur = System.Data.SqlTypes.SqlSingle.Null;
		...
		/// </summary>
		~spU_Contrat_EssenceUnite() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Contrat_EssenceUnite'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Contrat_EssenceUnite");
			}
		}
		...
		private System.Data.SqlTypes.SqlDouble internal_Param_Quantite_prevue;
		internal bool internal_Param_Quantite_prevue_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Quantite_prevue;
		internal bool internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlSingle internal_Param_Taux_producteur;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Quantite_prevue'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Quantite_prevue_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Quantite_prevue {

			get {

				if (this.internal_Param_Quantite_prevue_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Quantite_prevue);
			}

			set {

				this.internal_Param_Quantite_prevue_UseDefaultValue = false;
				this.internal_Param_Quantite_prevue = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Quantite_prevue' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Quantite_prevue_UseDefaultValue() {

			this.internal_Param_Quantite_prevue_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Quantite_prevue'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Quantite_prevue_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Quantite_prevue {

			get {

				if (this.internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Quantite_prevue);
			}

			set {

				this.internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Quantite_prevue = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Quantite_prevue' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Quantite_prevue_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue = true;
		}
		...
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlSingle Param_Taux_producteur {
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Contrat_EssenceUnite' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:24", SqlObjectDependancyName="spU_Contrat_EssenceUnite", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Contrat_EssenceUnite : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Contrat_EssenceUnite() : this(false) {
		...
		public spU_Contrat_EssenceUnite(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite)");
						}
				...
				sqlCommand.CommandText = "spU_Contrat_EssenceUnite";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Quantite_prevue", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Quantite_prevue";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Quantite_prevue_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Quantite_prevue.IsNull) {

					sqlParameter.Value = parameters.Param_Quantite_prevue;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Quantite_prevue", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Quantite_prevue_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Quantite_prevue.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Quantite_prevue;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Taux_producteur", System.Data.SqlDbType.Real, 4);
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Contrat_EssenceUnite] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Contrat_EssenceUnite parameters) {
