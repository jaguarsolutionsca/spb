...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_FactureClient'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:25", SqlObjectDependancyName="spU_FactureClient", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_FactureClient : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_FactureClient class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_FactureClient() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_FactureClient class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_FactureClient(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ClientID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_ClientID_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_FactureClient'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_FactureClient", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ClientID = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_ClientID = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_FactureClient'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_FactureClient");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TypeInvoiceClientAcomba;
		internal bool internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_ClientID;
		internal bool internal_Param_ClientID_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ClientID;
		internal bool internal_Param_ConsiderNull_ClientID_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TypeInvoiceClientAcomba'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TypeInvoiceClientAcomba {

			get {

				if (this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba);
			}

			set {

				this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TypeInvoiceClientAcomba' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ClientID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ClientID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ClientID {

			get {

				if (this.internal_Param_ConsiderNull_ClientID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ClientID);
			}

			set {

				this.internal_Param_ConsiderNull_ClientID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ClientID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ClientID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ClientID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ClientID_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_FactureClient' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:25", SqlObjectDependancyName="spU_FactureClient", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_FactureClient : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_FactureClient() : this(false) {
		...
		public spU_FactureClient(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_FactureClient parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_FactureClient parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureClient object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureClient object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureClient object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_FactureClient)");
						}
				...
				sqlCommand.CommandText = "spU_FactureClient";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureClient parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TypeInvoiceClientAcomba", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TypeInvoiceClientAcomba_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TypeInvoiceClientAcomba.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TypeInvoiceClientAcomba;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_ClientID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ClientID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ClientID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ClientID;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureClient parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_FactureClient] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_FactureClient parameters) {
