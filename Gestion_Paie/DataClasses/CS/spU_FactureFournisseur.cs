...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_FactureFournisseur'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:27", SqlObjectDependancyName="spU_FactureFournisseur", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_FactureFournisseur : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_FactureFournisseur class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_FactureFournisseur() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_FactureFournisseur class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_FactureFournisseur(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_NoFacture_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DateFacture_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DateFacture_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_TypeFacture_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_TypeFacture_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_TypeInvoiceAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_FournisseurID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_FournisseurID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Montant_Total_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Montant_TPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Montant_TVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_StatusDescription_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_NumeroCheque_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_NumeroPaiement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_NumeroPaiementUnique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DateFactureAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DatePaiementAcomba_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_FactureFournisseur'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_NoFacture = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DateFacture = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_DateFacture = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_TypeFactureFournisseur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_TypeFacture = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_TypeFacture = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_TypeInvoiceAcomba = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_TypeInvoiceAcomba = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_FournisseurID = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_FournisseurID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Montant_Total = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Montant_TPS = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Montant_TPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Montant_TVQ = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Montant_TVQ = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_StatusDescription = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_NumeroCheque = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_NumeroCheque = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_NumeroPaiement = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_NumeroPaiement = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_NumeroPaiementUnique = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_NumeroPaiementUnique = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DateFactureAcomba = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_DateFactureAcomba = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DatePaiementAcomba = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_DatePaiementAcomba = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_FactureFournisseur() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_FactureFournisseur'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_FactureFournisseur");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_NoFacture;
		internal bool internal_Param_ConsiderNull_NoFacture_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DateFacture;
		internal bool internal_Param_ConsiderNull_DateFacture_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TypeFactureFournisseur;
		internal bool internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TypeFacture;
		internal bool internal_Param_ConsiderNull_TypeFacture_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_TypeInvoiceAcomba;
		internal bool internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_FournisseurID;
		internal bool internal_Param_ConsiderNull_FournisseurID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_Total;
		internal bool internal_Param_ConsiderNull_Montant_Total_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_TPS;
		internal bool internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_TVQ;
		internal bool internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_StatusDescription;
		internal bool internal_Param_ConsiderNull_StatusDescription_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_NumeroCheque;
		internal bool internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_NumeroPaiement;
		internal bool internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_NumeroPaiementUnique;
		internal bool internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DateFactureAcomba;
		internal bool internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DatePaiementAcomba;
		internal bool internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_NoFacture'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_NoFacture_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_NoFacture {

			get {

				if (this.internal_Param_ConsiderNull_NoFacture_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_NoFacture);
			}

			set {

				this.internal_Param_ConsiderNull_NoFacture_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_NoFacture = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_NoFacture' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_NoFacture_UseDefaultValue() {

			this.internal_Param_ConsiderNull_NoFacture_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DateFacture'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DateFacture_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DateFacture {

			get {

				if (this.internal_Param_ConsiderNull_DateFacture_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DateFacture);
			}

			set {

				this.internal_Param_ConsiderNull_DateFacture_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DateFacture = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DateFacture' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DateFacture_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DateFacture_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TypeFactureFournisseur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TypeFactureFournisseur {

			get {

				if (this.internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TypeFactureFournisseur);
			}

			set {

				this.internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TypeFactureFournisseur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TypeFactureFournisseur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TypeFacture'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TypeFacture_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TypeFacture {

			get {

				if (this.internal_Param_ConsiderNull_TypeFacture_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TypeFacture);
			}

			set {

				this.internal_Param_ConsiderNull_TypeFacture_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TypeFacture = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TypeFacture' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TypeFacture_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TypeFacture_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_TypeInvoiceAcomba'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_TypeInvoiceAcomba {

			get {

				if (this.internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_TypeInvoiceAcomba);
			}

			set {

				this.internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_TypeInvoiceAcomba = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_TypeInvoiceAcomba' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue() {

			this.internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_FournisseurID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_FournisseurID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_FournisseurID {

			get {

				if (this.internal_Param_ConsiderNull_FournisseurID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_FournisseurID);
			}

			set {

				this.internal_Param_ConsiderNull_FournisseurID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_FournisseurID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_FournisseurID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_FournisseurID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_FournisseurID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_Total'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_Total_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_Total {

			get {

				if (this.internal_Param_ConsiderNull_Montant_Total_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_Total);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_Total_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_Total = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_Total' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_Total_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_Total_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_TPS'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_TPS_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_TPS {

			get {

				if (this.internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_TPS);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_TPS = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_TPS' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_TPS_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_TVQ'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_TVQ_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_TVQ {

			get {

				if (this.internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_TVQ);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_TVQ = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_TVQ' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_TVQ_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_StatusDescription'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_StatusDescription_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_StatusDescription {

			get {

				if (this.internal_Param_ConsiderNull_StatusDescription_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_StatusDescription);
			}

			set {

				this.internal_Param_ConsiderNull_StatusDescription_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_StatusDescription = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_StatusDescription' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_StatusDescription_UseDefaultValue() {

			this.internal_Param_ConsiderNull_StatusDescription_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_NumeroCheque'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_NumeroCheque_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_NumeroCheque {

			get {

				if (this.internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_NumeroCheque);
			}

			set {

				this.internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_NumeroCheque = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_NumeroCheque' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_NumeroCheque_UseDefaultValue() {

			this.internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_NumeroPaiement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_NumeroPaiement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_NumeroPaiement {

			get {

				if (this.internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_NumeroPaiement);
			}

			set {

				this.internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_NumeroPaiement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_NumeroPaiement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_NumeroPaiement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_NumeroPaiementUnique'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_NumeroPaiementUnique {

			get {

				if (this.internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_NumeroPaiementUnique);
			}

			set {

				this.internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_NumeroPaiementUnique = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_NumeroPaiementUnique' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue() {

			this.internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DateFactureAcomba'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DateFactureAcomba_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DateFactureAcomba {

			get {

				if (this.internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DateFactureAcomba);
			}

			set {

				this.internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DateFactureAcomba = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DateFactureAcomba' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DateFactureAcomba_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DatePaiementAcomba'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DatePaiementAcomba {

			get {

				if (this.internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DatePaiementAcomba);
			}

			set {

				this.internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DatePaiementAcomba = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DatePaiementAcomba' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_FactureFournisseur' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:27", SqlObjectDependancyName="spU_FactureFournisseur", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_FactureFournisseur : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_FactureFournisseur() : this(false) {
		...
		public spU_FactureFournisseur(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur)");
						}
				...
				sqlCommand.CommandText = "spU_FactureFournisseur";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_NoFacture", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_NoFacture_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_NoFacture.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_NoFacture;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DateFacture", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DateFacture_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DateFacture.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DateFacture;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TypeFactureFournisseur", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TypeFactureFournisseur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TypeFactureFournisseur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TypeFactureFournisseur;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TypeFacture", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TypeFacture_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TypeFacture.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TypeFacture;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_TypeInvoiceAcomba", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_TypeInvoiceAcomba_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_TypeInvoiceAcomba.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_TypeInvoiceAcomba;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_FournisseurID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_FournisseurID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_FournisseurID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_FournisseurID;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_Total", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_Total_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_Total.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_Total;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_TPS", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_TPS_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_TPS.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_TPS;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_TVQ", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_TVQ_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_TVQ.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_TVQ;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_StatusDescription", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_StatusDescription_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_StatusDescription.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_StatusDescription;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_NumeroCheque", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_NumeroCheque_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_NumeroCheque.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_NumeroCheque;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_NumeroPaiement", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_NumeroPaiement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_NumeroPaiement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_NumeroPaiement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_NumeroPaiementUnique", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_NumeroPaiementUnique_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_NumeroPaiementUnique.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_NumeroPaiementUnique;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DateFactureAcomba", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DateFactureAcomba_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DateFactureAcomba.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DateFactureAcomba;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DatePaiementAcomba", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DatePaiementAcomba_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DatePaiementAcomba.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DatePaiementAcomba;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_FactureFournisseur] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_FactureFournisseur parameters) {
