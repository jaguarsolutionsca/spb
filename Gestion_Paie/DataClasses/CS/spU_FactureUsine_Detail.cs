...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_FactureUsine_Detail'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_FactureUsine_Detail : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_FactureUsine_Detail class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_FactureUsine_Detail() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_FactureUsine_Detail class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_FactureUsine_Detail(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_PermisID_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_FactureUsine_Detail'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_FactureUsine_Detail", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_FactureUsineID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_PermisID = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_FactureUsine_Detail() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_FactureUsine_Detail'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_FactureUsine_Detail");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_FactureUsineID;
		internal bool internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PermisID;
		internal bool internal_Param_ConsiderNull_PermisID_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_FactureUsineID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_FactureUsineID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_FactureUsineID {

			get {

				if (this.internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_FactureUsineID);
			}

			set {

				this.internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_FactureUsineID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_FactureUsineID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_FactureUsineID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PermisID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PermisID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PermisID {

			get {

				if (this.internal_Param_ConsiderNull_PermisID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PermisID);
			}

			set {

				this.internal_Param_ConsiderNull_PermisID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PermisID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PermisID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PermisID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PermisID_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_FactureUsine_Detail' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_FactureUsine_Detail : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_FactureUsine_Detail() : this(false) {
		...
		public spU_FactureUsine_Detail(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail)");
						}
				...
				sqlCommand.CommandText = "spU_FactureUsine_Detail";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_FactureUsineID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_FactureUsineID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_FactureUsineID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_FactureUsineID;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_PermisID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PermisID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PermisID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PermisID;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_FactureUsine_Detail] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_FactureUsine_Detail parameters) {
