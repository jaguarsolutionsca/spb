...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Fournisseur'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
	public sealed class spU_Fournisseur : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Fournisseur class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Fournisseur() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Fournisseur class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Fournisseur(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_CleTri_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Nom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Nom_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_No_membre_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Resident_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Resident_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_WWW_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Commentaires_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Commentaires_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_AfficherCommentaires_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DepotDirect_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DepotDirect_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_InstitutionBanquaireID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Banque_transit_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Banque_transit_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Banque_folio_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Banque_folio_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_No_TPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_No_TPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_No_TVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_No_TVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PayerA_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PayerA_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PayerAID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PayerAID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Statut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Statut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep_Nom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep_Telephone_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep_Telephone_Poste_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep_Email_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep_Email_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_EnAnglais_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_EnAnglais_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PaiementManuel_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Journal_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Journal_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_RecoitTPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_RecoitTVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ModifierTrigger_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IsProducteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsProducteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IsTransporteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IsChargeur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsChargeur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IsAutre_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsAutre_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_AfficherCommentairesSurPermit_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PasEmissionPermis_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Generique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Generique_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Membre_OGC_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_InscritTPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_InscritTPS_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_InscritTVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IsOGC_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IsOGC_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep2_Nom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep2_Telephone_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep2_Telephone_Poste_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep2_Email_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Rep2_Commentaires_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Fournisseur'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_Fournisseur", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_CleTri = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Nom = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Nom = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_No_membre = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Resident = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Resident = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_WWW = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Commentaires = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Commentaires = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_AfficherCommentaires = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_AfficherCommentaires = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DepotDirect = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_DepotDirect = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_InstitutionBanquaireID = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_InstitutionBanquaireID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Banque_transit = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Banque_transit = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Banque_folio = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Banque_folio = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_No_TPS = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_No_TPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_No_TVQ = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_No_TVQ = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PayerA = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_PayerA = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PayerAID = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_PayerAID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Statut = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Statut = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep_Nom = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep_Nom = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep_Telephone = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep_Telephone = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep_Telephone_Poste = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep_Telephone_Poste = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep_Email = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep_Email = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_EnAnglais = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_EnAnglais = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_MRCProducteurID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PaiementManuel = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_PaiementManuel = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Journal = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Journal = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_RecoitTPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_RecoitTPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_RecoitTVQ = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_RecoitTVQ = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ModifierTrigger = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_ModifierTrigger = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IsProducteur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsProducteur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IsTransporteur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsTransporteur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IsChargeur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsChargeur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IsAutre = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsAutre = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_AfficherCommentairesSurPermit = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PasEmissionPermis = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_PasEmissionPermis = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Generique = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Generique = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Membre_OGC = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Membre_OGC = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_InscritTPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_InscritTPS = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_InscritTVQ = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_InscritTVQ = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IsOGC = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_IsOGC = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep2_Nom = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep2_Nom = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep2_Telephone = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep2_Telephone = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep2_Telephone_Poste = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep2_Telephone_Poste = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep2_Email = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep2_Email = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Rep2_Commentaires = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_Rep2_Commentaires = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Fournisseur'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Fournisseur");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_CleTri;
		internal bool internal_Param_ConsiderNull_CleTri_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Nom;
		internal bool internal_Param_Nom_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Nom;
		internal bool internal_Param_ConsiderNull_Nom_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_No_membre;
		internal bool internal_Param_ConsiderNull_No_membre_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Resident;
		internal bool internal_Param_Resident_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Resident;
		internal bool internal_Param_ConsiderNull_Resident_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_WWW;
		internal bool internal_Param_ConsiderNull_WWW_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Commentaires;
		internal bool internal_Param_ConsiderNull_Commentaires_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_AfficherCommentaires;
		internal bool internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DepotDirect;
		internal bool internal_Param_ConsiderNull_DepotDirect_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_InstitutionBanquaireID;
		internal bool internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Banque_transit;
		internal bool internal_Param_ConsiderNull_Banque_transit_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Banque_folio;
		internal bool internal_Param_ConsiderNull_Banque_folio_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_No_TPS;
		internal bool internal_Param_No_TPS_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_No_TPS;
		internal bool internal_Param_ConsiderNull_No_TPS_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_No_TVQ;
		internal bool internal_Param_No_TVQ_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_No_TVQ;
		internal bool internal_Param_ConsiderNull_No_TVQ_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_PayerA;
		internal bool internal_Param_PayerA_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PayerA;
		internal bool internal_Param_ConsiderNull_PayerA_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_PayerAID;
		internal bool internal_Param_PayerAID_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PayerAID;
		internal bool internal_Param_ConsiderNull_PayerAID_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Statut;
		internal bool internal_Param_Statut_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Statut;
		internal bool internal_Param_ConsiderNull_Statut_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Rep_Nom;
		internal bool internal_Param_Rep_Nom_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep_Nom;
		internal bool internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep_Telephone;
		internal bool internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep_Telephone_Poste;
		internal bool internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep_Email;
		internal bool internal_Param_ConsiderNull_Rep_Email_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_EnAnglais;
		internal bool internal_Param_ConsiderNull_EnAnglais_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_MRCProducteurID;
		internal bool internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PaiementManuel;
		internal bool internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_Journal;
		internal bool internal_Param_Journal_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Journal;
		internal bool internal_Param_ConsiderNull_Journal_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_RecoitTPS;
		internal bool internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_RecoitTVQ;
		internal bool internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ModifierTrigger;
		internal bool internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsProducteur;
		internal bool internal_Param_ConsiderNull_IsProducteur_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsTransporteur;
		internal bool internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsChargeur;
		internal bool internal_Param_ConsiderNull_IsChargeur_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_IsAutre;
		internal bool internal_Param_IsAutre_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsAutre;
		internal bool internal_Param_ConsiderNull_IsAutre_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_AfficherCommentairesSurPermit;
		internal bool internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PasEmissionPermis;
		internal bool internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Generique;
		internal bool internal_Param_ConsiderNull_Generique_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Membre_OGC;
		internal bool internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_InscritTPS;
		internal bool internal_Param_ConsiderNull_InscritTPS_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_InscritTVQ;
		internal bool internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_IsOGC;
		internal bool internal_Param_IsOGC_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IsOGC;
		internal bool internal_Param_ConsiderNull_IsOGC_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_Rep2_Nom;
		internal bool internal_Param_Rep2_Nom_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep2_Nom;
		internal bool internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep2_Telephone;
		internal bool internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep2_Telephone_Poste;
		internal bool internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep2_Email;
		internal bool internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Rep2_Commentaires;
		internal bool internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_CleTri'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_CleTri_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_CleTri {

			get {

				if (this.internal_Param_ConsiderNull_CleTri_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_CleTri);
			}

			set {

				this.internal_Param_ConsiderNull_CleTri_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_CleTri = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_CleTri' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_CleTri_UseDefaultValue() {

			this.internal_Param_ConsiderNull_CleTri_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Nom'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Nom_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Nom {

			get {

				if (this.internal_Param_ConsiderNull_Nom_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Nom);
			}

			set {

				this.internal_Param_ConsiderNull_Nom_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Nom = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Nom' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Nom_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Nom_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_No_membre'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_No_membre_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_No_membre {

			get {

				if (this.internal_Param_ConsiderNull_No_membre_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_No_membre);
			}

			set {

				this.internal_Param_ConsiderNull_No_membre_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_No_membre = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_No_membre' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_No_membre_UseDefaultValue() {

			this.internal_Param_ConsiderNull_No_membre_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Resident'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Resident_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Resident {

			get {

				if (this.internal_Param_ConsiderNull_Resident_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Resident);
			}

			set {

				this.internal_Param_ConsiderNull_Resident_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Resident = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Resident' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Resident_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Resident_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_WWW'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_WWW_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_WWW {

			get {

				if (this.internal_Param_ConsiderNull_WWW_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_WWW);
			}

			set {

				this.internal_Param_ConsiderNull_WWW_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_WWW = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_WWW' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_WWW_UseDefaultValue() {

			this.internal_Param_ConsiderNull_WWW_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Commentaires'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Commentaires_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Commentaires {

			get {

				if (this.internal_Param_ConsiderNull_Commentaires_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Commentaires);
			}

			set {

				this.internal_Param_ConsiderNull_Commentaires_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Commentaires = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Commentaires' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Commentaires_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Commentaires_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_AfficherCommentaires'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_AfficherCommentaires_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_AfficherCommentaires {

			get {

				if (this.internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_AfficherCommentaires);
			}

			set {

				this.internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_AfficherCommentaires = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_AfficherCommentaires' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_AfficherCommentaires_UseDefaultValue() {

			this.internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DepotDirect'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DepotDirect_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DepotDirect {

			get {

				if (this.internal_Param_ConsiderNull_DepotDirect_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DepotDirect);
			}

			set {

				this.internal_Param_ConsiderNull_DepotDirect_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DepotDirect = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DepotDirect' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DepotDirect_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DepotDirect_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_InstitutionBanquaireID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_InstitutionBanquaireID {

			get {

				if (this.internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_InstitutionBanquaireID);
			}

			set {

				this.internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_InstitutionBanquaireID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_InstitutionBanquaireID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Banque_transit'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Banque_transit_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Banque_transit {

			get {

				if (this.internal_Param_ConsiderNull_Banque_transit_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Banque_transit);
			}

			set {

				this.internal_Param_ConsiderNull_Banque_transit_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Banque_transit = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Banque_transit' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Banque_transit_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Banque_transit_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Banque_folio'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Banque_folio_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Banque_folio {

			get {

				if (this.internal_Param_ConsiderNull_Banque_folio_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Banque_folio);
			}

			set {

				this.internal_Param_ConsiderNull_Banque_folio_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Banque_folio = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Banque_folio' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Banque_folio_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Banque_folio_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_No_TPS'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_No_TPS_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_No_TPS {

			get {

				if (this.internal_Param_ConsiderNull_No_TPS_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_No_TPS);
			}

			set {

				this.internal_Param_ConsiderNull_No_TPS_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_No_TPS = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_No_TPS' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_No_TPS_UseDefaultValue() {

			this.internal_Param_ConsiderNull_No_TPS_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_No_TVQ'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_No_TVQ_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_No_TVQ {

			get {

				if (this.internal_Param_ConsiderNull_No_TVQ_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_No_TVQ);
			}

			set {

				this.internal_Param_ConsiderNull_No_TVQ_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_No_TVQ = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_No_TVQ' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_No_TVQ_UseDefaultValue() {

			this.internal_Param_ConsiderNull_No_TVQ_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PayerA'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PayerA_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PayerA {

			get {

				if (this.internal_Param_ConsiderNull_PayerA_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PayerA);
			}

			set {

				this.internal_Param_ConsiderNull_PayerA_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PayerA = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PayerA' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PayerA_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PayerA_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PayerAID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PayerAID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PayerAID {

			get {

				if (this.internal_Param_ConsiderNull_PayerAID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PayerAID);
			}

			set {

				this.internal_Param_ConsiderNull_PayerAID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PayerAID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PayerAID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PayerAID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PayerAID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Statut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Statut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Statut {

			get {

				if (this.internal_Param_ConsiderNull_Statut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Statut);
			}

			set {

				this.internal_Param_ConsiderNull_Statut_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Statut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Statut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Statut_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Statut_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep_Nom'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep_Nom_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep_Nom {

			get {

				if (this.internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep_Nom);
			}

			set {

				this.internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep_Nom = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep_Nom' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep_Nom_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep_Telephone'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep_Telephone_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep_Telephone {

			get {

				if (this.internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep_Telephone);
			}

			set {

				this.internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep_Telephone = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep_Telephone' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep_Telephone_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep_Telephone_Poste'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep_Telephone_Poste {

			get {

				if (this.internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep_Telephone_Poste);
			}

			set {

				this.internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep_Telephone_Poste = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep_Telephone_Poste' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep_Email'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep_Email_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep_Email {

			get {

				if (this.internal_Param_ConsiderNull_Rep_Email_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep_Email);
			}

			set {

				this.internal_Param_ConsiderNull_Rep_Email_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep_Email = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep_Email' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep_Email_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep_Email_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_EnAnglais'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_EnAnglais_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_EnAnglais {

			get {

				if (this.internal_Param_ConsiderNull_EnAnglais_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_EnAnglais);
			}

			set {

				this.internal_Param_ConsiderNull_EnAnglais_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_EnAnglais = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_EnAnglais' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_EnAnglais_UseDefaultValue() {

			this.internal_Param_ConsiderNull_EnAnglais_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_MRCProducteurID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_MRCProducteurID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_MRCProducteurID {

			get {

				if (this.internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_MRCProducteurID);
			}

			set {

				this.internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_MRCProducteurID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_MRCProducteurID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_MRCProducteurID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PaiementManuel'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PaiementManuel_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PaiementManuel {

			get {

				if (this.internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PaiementManuel);
			}

			set {

				this.internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PaiementManuel = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PaiementManuel' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PaiementManuel_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Journal'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Journal_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Journal {

			get {

				if (this.internal_Param_ConsiderNull_Journal_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Journal);
			}

			set {

				this.internal_Param_ConsiderNull_Journal_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Journal = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Journal' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Journal_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Journal_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_RecoitTPS'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_RecoitTPS_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_RecoitTPS {

			get {

				if (this.internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_RecoitTPS);
			}

			set {

				this.internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_RecoitTPS = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_RecoitTPS' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_RecoitTPS_UseDefaultValue() {

			this.internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_RecoitTVQ'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_RecoitTVQ_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_RecoitTVQ {

			get {

				if (this.internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_RecoitTVQ);
			}

			set {

				this.internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_RecoitTVQ = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_RecoitTVQ' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_RecoitTVQ_UseDefaultValue() {

			this.internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ModifierTrigger'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ModifierTrigger_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ModifierTrigger {

			get {

				if (this.internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ModifierTrigger);
			}

			set {

				this.internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ModifierTrigger = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ModifierTrigger' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ModifierTrigger_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsProducteur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsProducteur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsProducteur {

			get {

				if (this.internal_Param_ConsiderNull_IsProducteur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsProducteur);
			}

			set {

				this.internal_Param_ConsiderNull_IsProducteur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsProducteur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsProducteur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsProducteur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsProducteur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsTransporteur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsTransporteur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsTransporteur {

			get {

				if (this.internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsTransporteur);
			}

			set {

				this.internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsTransporteur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsTransporteur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsTransporteur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsChargeur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsChargeur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsChargeur {

			get {

				if (this.internal_Param_ConsiderNull_IsChargeur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsChargeur);
			}

			set {

				this.internal_Param_ConsiderNull_IsChargeur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsChargeur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsChargeur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsChargeur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsChargeur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsAutre'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsAutre_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsAutre {

			get {

				if (this.internal_Param_ConsiderNull_IsAutre_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsAutre);
			}

			set {

				this.internal_Param_ConsiderNull_IsAutre_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsAutre = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsAutre' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsAutre_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsAutre_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_AfficherCommentairesSurPermit'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_AfficherCommentairesSurPermit {

			get {

				if (this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit);
			}

			set {

				this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_AfficherCommentairesSurPermit' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue() {

			this.internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PasEmissionPermis'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PasEmissionPermis_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PasEmissionPermis {

			get {

				if (this.internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PasEmissionPermis);
			}

			set {

				this.internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PasEmissionPermis = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PasEmissionPermis' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PasEmissionPermis_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Generique'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Generique_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Generique {

			get {

				if (this.internal_Param_ConsiderNull_Generique_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Generique);
			}

			set {

				this.internal_Param_ConsiderNull_Generique_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Generique = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Generique' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Generique_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Generique_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Membre_OGC'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Membre_OGC_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Membre_OGC {

			get {

				if (this.internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Membre_OGC);
			}

			set {

				this.internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Membre_OGC = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Membre_OGC' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Membre_OGC_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_InscritTPS'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_InscritTPS_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_InscritTPS {

			get {

				if (this.internal_Param_ConsiderNull_InscritTPS_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_InscritTPS);
			}

			set {

				this.internal_Param_ConsiderNull_InscritTPS_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_InscritTPS = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_InscritTPS' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_InscritTPS_UseDefaultValue() {

			this.internal_Param_ConsiderNull_InscritTPS_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_InscritTVQ'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_InscritTVQ_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_InscritTVQ {

			get {

				if (this.internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_InscritTVQ);
			}

			set {

				this.internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_InscritTVQ = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_InscritTVQ' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_InscritTVQ_UseDefaultValue() {

			this.internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IsOGC'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IsOGC_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IsOGC {

			get {

				if (this.internal_Param_ConsiderNull_IsOGC_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IsOGC);
			}

			set {

				this.internal_Param_ConsiderNull_IsOGC_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IsOGC = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IsOGC' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IsOGC_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IsOGC_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep2_Nom'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep2_Nom_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep2_Nom {

			get {

				if (this.internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep2_Nom);
			}

			set {

				this.internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep2_Nom = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep2_Nom' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep2_Nom_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep2_Telephone'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep2_Telephone_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep2_Telephone {

			get {

				if (this.internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep2_Telephone);
			}

			set {

				this.internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep2_Telephone = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep2_Telephone' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep2_Telephone_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep2_Telephone_Poste'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep2_Telephone_Poste {

			get {

				if (this.internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep2_Telephone_Poste);
			}

			set {

				this.internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep2_Telephone_Poste = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep2_Telephone_Poste' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep2_Email'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep2_Email_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep2_Email {

			get {

				if (this.internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep2_Email);
			}

			set {

				this.internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep2_Email = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep2_Email' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep2_Email_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Rep2_Commentaires'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Rep2_Commentaires {

			get {

				if (this.internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Rep2_Commentaires);
			}

			set {

				this.internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Rep2_Commentaires = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Rep2_Commentaires' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Fournisseur' stored procedure;
	...
	/// </list>
	/// </summary>
	public sealed class spU_Fournisseur : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Fournisseur() : this(false) {
		...
		public spU_Fournisseur(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Fournisseur parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Fournisseur parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Fournisseur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Fournisseur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Fournisseur object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Fournisseur)");
						}
				...
				sqlCommand.CommandText = "spU_Fournisseur";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Fournisseur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_CleTri_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_CleTri.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_CleTri;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Nom_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Nom.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Nom;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_No_membre_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_No_membre.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_No_membre;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Resident_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Resident.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Resident;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_WWW_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_WWW.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_WWW;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Commentaires_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Commentaires.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Commentaires;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_AfficherCommentaires_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_AfficherCommentaires.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_AfficherCommentaires;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DepotDirect_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DepotDirect.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DepotDirect;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_InstitutionBanquaireID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_InstitutionBanquaireID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_InstitutionBanquaireID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Banque_transit_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Banque_transit.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Banque_transit;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Banque_folio_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Banque_folio.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Banque_folio;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_No_TPS_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_No_TPS.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_No_TPS;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_No_TVQ_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_No_TVQ.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_No_TVQ;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PayerA_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PayerA.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PayerA;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PayerAID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PayerAID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PayerAID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Statut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Statut.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Statut;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep_Nom_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep_Nom.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep_Nom;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep_Telephone_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep_Telephone.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep_Telephone;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep_Telephone_Poste_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep_Telephone_Poste.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep_Telephone_Poste;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep_Email_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep_Email.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep_Email;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_EnAnglais_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_EnAnglais.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_EnAnglais;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_MRCProducteurID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_MRCProducteurID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_MRCProducteurID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PaiementManuel_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PaiementManuel.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PaiementManuel;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Journal_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Journal.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Journal;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_RecoitTPS_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_RecoitTPS.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_RecoitTPS;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_RecoitTVQ_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_RecoitTVQ.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_RecoitTVQ;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ModifierTrigger_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ModifierTrigger.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ModifierTrigger;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsProducteur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsProducteur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsProducteur;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsTransporteur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsTransporteur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsTransporteur;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsChargeur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsChargeur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsChargeur;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsAutre_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsAutre.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsAutre;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_AfficherCommentairesSurPermit_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_AfficherCommentairesSurPermit.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_AfficherCommentairesSurPermit;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PasEmissionPermis_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PasEmissionPermis.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PasEmissionPermis;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Generique_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Generique.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Generique;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Membre_OGC_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Membre_OGC.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Membre_OGC;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_InscritTPS_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_InscritTPS.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_InscritTPS;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_InscritTVQ_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_InscritTVQ.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_InscritTVQ;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IsOGC_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IsOGC.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IsOGC;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep2_Nom_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep2_Nom.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep2_Nom;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep2_Telephone_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep2_Telephone.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep2_Telephone;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep2_Telephone_Poste_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep2_Telephone_Poste.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep2_Telephone_Poste;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep2_Email_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep2_Email.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep2_Email;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Rep2_Commentaires_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Rep2_Commentaires.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Rep2_Commentaires;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Fournisseur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Fournisseur] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Fournisseur parameters) {
