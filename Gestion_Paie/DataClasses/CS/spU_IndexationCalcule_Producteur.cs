/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 30/03/2007 9:55:28 AM
...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_IndexationCalcule_Producteur'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:28", SqlObjectDependancyName="spU_IndexationCalcule_Producteur", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_IndexationCalcule_Producteur : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_IndexationCalcule_Producteur class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_IndexationCalcule_Producteur() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_IndexationCalcule_Producteur class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_IndexationCalcule_Producteur(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_IndexationID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_IndexationDetailID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Volume_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_MontantDejaPaye_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_FactureID_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_IndexationCalcule_Producteur'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_IndexationCalcule_Producteur", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_IndexationID = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_IndexationDetailID = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_IndexationDetailID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_LivraisonDetailID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Volume = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_MontantDejaPaye = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_MontantDejaPaye = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PourcentageDuMontant = System.Data.SqlTypes.SqlDouble.Null;
				...
				this.internal_Param_ConsiderNull_Taux = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_FactureID = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_IndexationCalcule_Producteur() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_IndexationCalcule_Producteur'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_IndexationCalcule_Producteur");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IndexationID;
		internal bool internal_Param_ConsiderNull_IndexationID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_IndexationDetailID;
		internal bool internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_LivraisonDetailID;
		internal bool internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Volume;
		internal bool internal_Param_ConsiderNull_Volume_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_MontantDejaPaye;
		internal bool internal_Param_MontantDejaPaye_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_MontantDejaPaye;
		internal bool internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_PourcentageDuMontant;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux;
		internal bool internal_Param_ConsiderNull_Taux_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_FactureID;
		internal bool internal_Param_ConsiderNull_FactureID_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IndexationID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IndexationID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IndexationID {

			get {

				if (this.internal_Param_ConsiderNull_IndexationID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IndexationID);
			}

			set {

				this.internal_Param_ConsiderNull_IndexationID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IndexationID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IndexationID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IndexationID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IndexationID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_IndexationDetailID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_IndexationDetailID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_IndexationDetailID {

			get {

				if (this.internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_IndexationDetailID);
			}

			set {

				this.internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_IndexationDetailID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_IndexationDetailID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_IndexationDetailID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_LivraisonDetailID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_LivraisonDetailID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_LivraisonDetailID {

			get {

				if (this.internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_LivraisonDetailID);
			}

			set {

				this.internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_LivraisonDetailID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_LivraisonDetailID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_LivraisonDetailID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Volume'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Volume_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Volume {

			get {

				if (this.internal_Param_ConsiderNull_Volume_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Volume);
			}

			set {

				this.internal_Param_ConsiderNull_Volume_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Volume = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Volume' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Volume_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Volume_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@MontantDejaPaye'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_MontantDejaPaye_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_MontantDejaPaye {

			get {

				if (this.internal_Param_MontantDejaPaye_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_MontantDejaPaye);
			}

			set {

				this.internal_Param_MontantDejaPaye_UseDefaultValue = false;
				this.internal_Param_MontantDejaPaye = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@MontantDejaPaye' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_MontantDejaPaye_UseDefaultValue() {

			this.internal_Param_MontantDejaPaye_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_MontantDejaPaye'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_MontantDejaPaye_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_MontantDejaPaye {

			get {

				if (this.internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_MontantDejaPaye);
			}

			set {

				this.internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_MontantDejaPaye = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_MontantDejaPaye' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_MontantDejaPaye_UseDefaultValue() {

			this.internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue = true;
		}
		...
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_PourcentageDuMontant {
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux {

			get {

				if (this.internal_Param_ConsiderNull_Taux_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_FactureID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_FactureID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_FactureID {

			get {

				if (this.internal_Param_ConsiderNull_FactureID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_FactureID);
			}

			set {

				this.internal_Param_ConsiderNull_FactureID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_FactureID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_FactureID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_FactureID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_FactureID_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_IndexationCalcule_Producteur' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:28", SqlObjectDependancyName="spU_IndexationCalcule_Producteur", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_IndexationCalcule_Producteur : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_IndexationCalcule_Producteur() : this(false) {
		...
		public spU_IndexationCalcule_Producteur(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur)");
						}
				...
				sqlCommand.CommandText = "spU_IndexationCalcule_Producteur";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_IndexationID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IndexationID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IndexationID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IndexationID;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_IndexationDetailID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_IndexationDetailID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_IndexationDetailID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_IndexationDetailID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_LivraisonDetailID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_LivraisonDetailID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_LivraisonDetailID;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Volume_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Volume.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Volume;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@MontantDejaPaye", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "MontantDejaPaye";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_MontantDejaPaye_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_MontantDejaPaye.IsNull) {

					sqlParameter.Value = parameters.Param_MontantDejaPaye;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_MontantDejaPaye", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_MontantDejaPaye_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_MontantDejaPaye.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_MontantDejaPaye;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@PourcentageDuMontant", System.Data.SqlDbType.Float, 8);
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_FactureID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_FactureID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_FactureID;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_IndexationCalcule_Producteur] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_IndexationCalcule_Producteur parameters) {
