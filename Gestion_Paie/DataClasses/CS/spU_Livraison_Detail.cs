...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_Livraison_Detail'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:29", SqlObjectDependancyName="spU_Livraison_Detail", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Livraison_Detail : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_Livraison_Detail class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_Livraison_Detail() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_Livraison_Detail class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_Livraison_Detail(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_LivraisonID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_VolumeNet_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_VolumeNet_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_VolumeContingente_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ContingentementID_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_ContingentementID_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Montant_ProducteurBrut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Taux_TransporteurMoyen_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Taux_TransporteurMoyen_Override_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Montant_TransporteurMoyen_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Taux_Preleve_Plan_Conjoint_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Taux_Producteur_Override_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Taux_Usine_Override_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_Livraison_Detail'";
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_LivraisonID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Droit_Coupe = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_VolumeReduction = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_VolumeNet = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_VolumeNet = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_VolumeContingente = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_VolumeContingente = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ContingentementID = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_ContingentementID = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Taux_Usine = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Taux_Producteur = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Montant_ProducteurBrut = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Montant_ProducteurBrut = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Taux_TransporteurMoyen = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Taux_TransporteurMoyen_Override = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Montant_TransporteurMoyen = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Montant_TransporteurMoyen = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Taux_Preleve_Plan_Conjoint = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Taux_Preleve_Divers = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Montant_ProducteurNet = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Taux_Producteur_Override = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Taux_Producteur_Override = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Taux_Usine_Override = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_ConsiderNull_Taux_Usine_Override = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_UsePreleveMontant = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_Livraison_Detail() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_Livraison_Detail'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_Livraison_Detail");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_LivraisonID;
		internal bool internal_Param_ConsiderNull_LivraisonID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Droit_Coupe;
		internal bool internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_VolumeReduction;
		internal bool internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_VolumeNet;
		internal bool internal_Param_ConsiderNull_VolumeNet_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_VolumeContingente;
		internal bool internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ContingentementID;
		internal bool internal_Param_ConsiderNull_ContingentementID_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Usine;
		internal bool internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Producteur;
		internal bool internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_ProducteurBrut;
		internal bool internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_TransporteurMoyen;
		internal bool internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override;
		internal bool internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_TransporteurMoyen;
		internal bool internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint;
		internal bool internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement;
		internal bool internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier;
		internal bool internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Preleve_Divers;
		internal bool internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Montant_ProducteurNet;
		internal bool internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Producteur_Override;
		internal bool internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Taux_Usine_Override;
		internal bool internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_UsePreleveMontant;
		internal bool internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_LivraisonID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_LivraisonID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_LivraisonID {

			get {

				if (this.internal_Param_ConsiderNull_LivraisonID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_LivraisonID);
			}

			set {

				this.internal_Param_ConsiderNull_LivraisonID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_LivraisonID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_LivraisonID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_LivraisonID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_LivraisonID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Droit_Coupe'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Droit_Coupe_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Droit_Coupe {

			get {

				if (this.internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Droit_Coupe);
			}

			set {

				this.internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Droit_Coupe = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Droit_Coupe' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Droit_Coupe_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_VolumeReduction'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_VolumeReduction_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_VolumeReduction {

			get {

				if (this.internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_VolumeReduction);
			}

			set {

				this.internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_VolumeReduction = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_VolumeReduction' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_VolumeReduction_UseDefaultValue() {

			this.internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_VolumeNet'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_VolumeNet_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_VolumeNet {

			get {

				if (this.internal_Param_ConsiderNull_VolumeNet_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_VolumeNet);
			}

			set {

				this.internal_Param_ConsiderNull_VolumeNet_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_VolumeNet = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_VolumeNet' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_VolumeNet_UseDefaultValue() {

			this.internal_Param_ConsiderNull_VolumeNet_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_VolumeContingente'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_VolumeContingente_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_VolumeContingente {

			get {

				if (this.internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_VolumeContingente);
			}

			set {

				this.internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_VolumeContingente = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_VolumeContingente' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_VolumeContingente_UseDefaultValue() {

			this.internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ContingentementID'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ContingentementID_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ContingentementID {

			get {

				if (this.internal_Param_ConsiderNull_ContingentementID_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ContingentementID);
			}

			set {

				this.internal_Param_ConsiderNull_ContingentementID_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ContingentementID = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ContingentementID' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ContingentementID_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ContingentementID_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Usine'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Usine_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Usine {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Usine);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Usine = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Usine' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Usine_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Producteur'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Producteur_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Producteur {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Producteur);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Producteur = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Producteur' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Producteur_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_ProducteurBrut'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_ProducteurBrut {

			get {

				if (this.internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_ProducteurBrut);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_ProducteurBrut = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_ProducteurBrut' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_TransporteurMoyen'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_TransporteurMoyen {

			get {

				if (this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_TransporteurMoyen);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_TransporteurMoyen' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_TransporteurMoyen_Override'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_TransporteurMoyen_Override {

			get {

				if (this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_TransporteurMoyen_Override' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_TransporteurMoyen'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_TransporteurMoyen {

			get {

				if (this.internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_TransporteurMoyen);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_TransporteurMoyen = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_TransporteurMoyen' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Preleve_Plan_Conjoint'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Preleve_Plan_Conjoint {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Preleve_Plan_Conjoint' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Preleve_Fond_Roulement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Preleve_Fond_Roulement {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Preleve_Fond_Roulement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Preleve_Fond_Forestier'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Preleve_Fond_Forestier {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Preleve_Fond_Forestier' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Preleve_Divers'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Preleve_Divers {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Preleve_Divers);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Preleve_Divers = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Preleve_Divers' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Montant_ProducteurNet'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Montant_ProducteurNet {

			get {

				if (this.internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Montant_ProducteurNet);
			}

			set {

				this.internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Montant_ProducteurNet = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Montant_ProducteurNet' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Producteur_Override'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Producteur_Override {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Producteur_Override);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Producteur_Override = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Producteur_Override' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Taux_Usine_Override'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Taux_Usine_Override {

			get {

				if (this.internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Taux_Usine_Override);
			}

			set {

				this.internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Taux_Usine_Override = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Taux_Usine_Override' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_UsePreleveMontant'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_UsePreleveMontant_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_UsePreleveMontant {

			get {

				if (this.internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_UsePreleveMontant);
			}

			set {

				this.internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_UsePreleveMontant = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_UsePreleveMontant' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_UsePreleveMontant_UseDefaultValue() {

			this.internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_Livraison_Detail' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2007/03/30 13:55:29", SqlObjectDependancyName="spU_Livraison_Detail", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_Livraison_Detail : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_Livraison_Detail() : this(false) {
		...
		public spU_Livraison_Detail(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail)");
						}
				...
				sqlCommand.CommandText = "spU_Livraison_Detail";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_LivraisonID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_LivraisonID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_LivraisonID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_LivraisonID;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Droit_Coupe", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Droit_Coupe_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Droit_Coupe.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Droit_Coupe;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_VolumeReduction_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_VolumeReduction.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_VolumeReduction;
				}
				else {
				...
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_VolumeNet_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_VolumeNet.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_VolumeNet;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_VolumeContingente", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_VolumeContingente_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_VolumeContingente.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_VolumeContingente;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_ContingentementID", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ContingentementID_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ContingentementID.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ContingentementID;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Usine", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Usine_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Usine.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Usine;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Producteur", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Producteur_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Producteur.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Producteur;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_ProducteurBrut", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_ProducteurBrut_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_ProducteurBrut.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_ProducteurBrut;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_TransporteurMoyen", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_TransporteurMoyen_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_TransporteurMoyen.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_TransporteurMoyen;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_TransporteurMoyen_Override", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_TransporteurMoyen_Override_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_TransporteurMoyen_Override.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_TransporteurMoyen_Override;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_TransporteurMoyen", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_TransporteurMoyen_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_TransporteurMoyen.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_TransporteurMoyen;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Preleve_Plan_Conjoint", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Preleve_Plan_Conjoint_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Preleve_Plan_Conjoint.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Preleve_Plan_Conjoint;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Preleve_Fond_Roulement", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Preleve_Fond_Roulement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Preleve_Fond_Roulement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Preleve_Fond_Roulement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Preleve_Fond_Forestier", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Preleve_Fond_Forestier_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Preleve_Fond_Forestier.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Preleve_Fond_Forestier;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Preleve_Divers", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Preleve_Divers_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Preleve_Divers.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Preleve_Divers;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Montant_ProducteurNet", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Montant_ProducteurNet_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Montant_ProducteurNet.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Montant_ProducteurNet;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Producteur_Override", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Producteur_Override_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Producteur_Override.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Producteur_Override;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Taux_Usine_Override", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Taux_Usine_Override_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Taux_Usine_Override.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Taux_Usine_Override;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_UsePreleveMontant", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_UsePreleveMontant_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_UsePreleveMontant.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_UsePreleveMontant;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_Livraison_Detail] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_Livraison_Detail parameters) {
