...
namespace Gestion_Paie.DataClasses.Parameters {
	...
	/// stored procedure 'spU_UniteMesure'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:29", SqlObjectDependancyName="spU_UniteMesure", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_UniteMesure : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_UniteMesure class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_UniteMesure() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_UniteMesure class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_UniteMesure(bool useDefaultValue) {
			...
			this.internal_Param_Nb_decimale_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_Pourc_Preleve_divers_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_UniteMesure'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_UniteMesure", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_Nb_decimale = System.Data.SqlTypes.SqlInt32.Null;
				this.internal_Param_ConsiderNull_Nb_decimale = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_Pourc_Preleve_plan_conjoint = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Pourc_Preleve_fond_roulement = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Pourc_Preleve_fond_forestier = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_Pourc_Preleve_divers = System.Data.SqlTypes.SqlDouble.Null;
				this.internal_Param_ConsiderNull_Pourc_Preleve_divers = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_UniteMesure'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_UniteMesure");
			}
		}
		...
		private System.Data.SqlTypes.SqlInt32 internal_Param_Nb_decimale;
		internal bool internal_Param_Nb_decimale_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Nb_decimale;
		internal bool internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlDouble internal_Param_Pourc_Preleve_plan_conjoint;
		internal bool internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint;
		internal bool internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_Pourc_Preleve_fond_roulement;
		internal bool internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement;
		internal bool internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_Pourc_Preleve_fond_forestier;
		internal bool internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier;
		internal bool internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlDouble internal_Param_Pourc_Preleve_divers;
		internal bool internal_Param_Pourc_Preleve_divers_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Pourc_Preleve_divers;
		internal bool internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Nb_decimale'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Nb_decimale_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlInt32 Param_Nb_decimale {

			get {

				if (this.internal_Param_Nb_decimale_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Nb_decimale);
			}

			set {

				this.internal_Param_Nb_decimale_UseDefaultValue = false;
				this.internal_Param_Nb_decimale = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Nb_decimale' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Nb_decimale_UseDefaultValue() {

			this.internal_Param_Nb_decimale_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Nb_decimale'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Nb_decimale_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Nb_decimale {

			get {

				if (this.internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Nb_decimale);
			}

			set {

				this.internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Nb_decimale = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Nb_decimale' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Nb_decimale_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Pourc_Preleve_plan_conjoint'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Pourc_Preleve_plan_conjoint_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Pourc_Preleve_plan_conjoint {

			get {

				if (this.internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Pourc_Preleve_plan_conjoint);
			}

			set {

				this.internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue = false;
				this.internal_Param_Pourc_Preleve_plan_conjoint = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Pourc_Preleve_plan_conjoint' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Pourc_Preleve_plan_conjoint_UseDefaultValue() {

			this.internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Pourc_Preleve_plan_conjoint'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Pourc_Preleve_plan_conjoint {

			get {

				if (this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint);
			}

			set {

				this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Pourc_Preleve_plan_conjoint' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Pourc_Preleve_fond_roulement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Pourc_Preleve_fond_roulement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Pourc_Preleve_fond_roulement {

			get {

				if (this.internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Pourc_Preleve_fond_roulement);
			}

			set {

				this.internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue = false;
				this.internal_Param_Pourc_Preleve_fond_roulement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Pourc_Preleve_fond_roulement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Pourc_Preleve_fond_roulement_UseDefaultValue() {

			this.internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Pourc_Preleve_fond_roulement'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Pourc_Preleve_fond_roulement {

			get {

				if (this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement);
			}

			set {

				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Pourc_Preleve_fond_roulement' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Pourc_Preleve_fond_forestier'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Pourc_Preleve_fond_forestier_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Pourc_Preleve_fond_forestier {

			get {

				if (this.internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Pourc_Preleve_fond_forestier);
			}

			set {

				this.internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue = false;
				this.internal_Param_Pourc_Preleve_fond_forestier = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Pourc_Preleve_fond_forestier' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Pourc_Preleve_fond_forestier_UseDefaultValue() {

			this.internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Pourc_Preleve_fond_forestier'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Pourc_Preleve_fond_forestier {

			get {

				if (this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier);
			}

			set {

				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Pourc_Preleve_fond_forestier' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@Pourc_Preleve_divers'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_Pourc_Preleve_divers_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDouble Param_Pourc_Preleve_divers {

			get {

				if (this.internal_Param_Pourc_Preleve_divers_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_Pourc_Preleve_divers);
			}

			set {

				this.internal_Param_Pourc_Preleve_divers_UseDefaultValue = false;
				this.internal_Param_Pourc_Preleve_divers = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@Pourc_Preleve_divers' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_Pourc_Preleve_divers_UseDefaultValue() {

			this.internal_Param_Pourc_Preleve_divers_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Pourc_Preleve_divers'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Pourc_Preleve_divers {

			get {

				if (this.internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Pourc_Preleve_divers);
			}

			set {

				this.internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Pourc_Preleve_divers = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Pourc_Preleve_divers' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue = true;
		}
...
namespace Gestion_Paie.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_UniteMesure' stored procedure;
	...
	[OlymarsInformation(DeveloperName="<Developer Name Here>", GeneratedOn="2006/09/13 15:57:29", SqlObjectDependancyName="spU_UniteMesure", SqlObjectDependancyRevision=0)]
#endif
	public sealed class spU_UniteMesure : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_UniteMesure() : this(false) {
		...
		public spU_UniteMesure(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Gestion_Paie.DataClasses.Parameters.spU_UniteMesure parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Gestion_Paie.DataClasses.Parameters.spU_UniteMesure parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_UniteMesure object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_UniteMesure object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Gestion_Paie.DataClasses.Parameters.spU_UniteMesure object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.DataClasses.Parameters.spU_UniteMesure)");
						}
				...
				sqlCommand.CommandText = "spU_UniteMesure";
		...
		private bool DeclareParameters(ref Gestion_Paie.DataClasses.Parameters.spU_UniteMesure parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Description", System.Data.SqlDbType.VarChar, 25);
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Nb_decimale", System.Data.SqlDbType.Int, 4);
				sqlParameter.SourceColumn = "Nb_decimale";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Nb_decimale_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Nb_decimale.IsNull) {

					sqlParameter.Value = parameters.Param_Nb_decimale;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Nb_decimale", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Nb_decimale_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Nb_decimale.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Nb_decimale;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Pourc_Preleve_plan_conjoint", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Pourc_Preleve_plan_conjoint";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Pourc_Preleve_plan_conjoint_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Pourc_Preleve_plan_conjoint.IsNull) {

					sqlParameter.Value = parameters.Param_Pourc_Preleve_plan_conjoint;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Pourc_Preleve_plan_conjoint", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Pourc_Preleve_plan_conjoint_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Pourc_Preleve_plan_conjoint.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Pourc_Preleve_plan_conjoint;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Pourc_Preleve_fond_roulement", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Pourc_Preleve_fond_roulement";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Pourc_Preleve_fond_roulement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Pourc_Preleve_fond_roulement.IsNull) {

					sqlParameter.Value = parameters.Param_Pourc_Preleve_fond_roulement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Pourc_Preleve_fond_roulement", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Pourc_Preleve_fond_roulement_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Pourc_Preleve_fond_roulement.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Pourc_Preleve_fond_roulement;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Pourc_Preleve_fond_forestier", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Pourc_Preleve_fond_forestier";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Pourc_Preleve_fond_forestier_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Pourc_Preleve_fond_forestier.IsNull) {

					sqlParameter.Value = parameters.Param_Pourc_Preleve_fond_forestier;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Pourc_Preleve_fond_forestier", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Pourc_Preleve_fond_forestier_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Pourc_Preleve_fond_forestier.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Pourc_Preleve_fond_forestier;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@Pourc_Preleve_divers", System.Data.SqlDbType.Float, 8);
				sqlParameter.SourceColumn = "Pourc_Preleve_divers";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_Pourc_Preleve_divers_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_Pourc_Preleve_divers.IsNull) {

					sqlParameter.Value = parameters.Param_Pourc_Preleve_divers;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Pourc_Preleve_divers", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Pourc_Preleve_divers_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Pourc_Preleve_divers.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Pourc_Preleve_divers;
				}
				else {
		...
		private bool RetrieveParameters(ref Gestion_Paie.DataClasses.Parameters.spU_UniteMesure parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_UniteMesure] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Gestion_Paie.DataClasses.Parameters.spU_UniteMesure parameters) {
