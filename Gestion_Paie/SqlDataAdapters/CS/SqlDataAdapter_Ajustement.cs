...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Ajustement] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Ajustement {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Ajustement class.
		...
		public SqlDataAdapter_Ajustement(string connectionString) {
		...
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Ajustement class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Ajustement(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(connectionString) {

			this.Configure(FK_ContratID, tableName);
		}
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Ajustement class.
		/// The table name in the DataSet will be: Ajustement
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID) : this(connectionString) {

			this.Configure(FK_ContratID, "Ajustement");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Ajustement)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Ajustement";
			...
			sqlInsertCommand.CommandText = "spI_Ajustement";
			...
			sqlUpdateCommand.CommandText = "spU_Ajustement";
			...
			sqlDeleteCommand.CommandText = "spD_Ajustement";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("DateAjustement", "DateAjustement")
							,new System.Data.Common.DataColumnMapping("Periode_Debut", "Periode_Debut")
							,new System.Data.Common.DataColumnMapping("Periode_Fin", "Periode_Fin")
							,new System.Data.Common.DataColumnMapping("Facture", "Facture")
							,new System.Data.Common.DataColumnMapping("UsePeriodes", "UsePeriodes")
							,new System.Data.Common.DataColumnMapping("Date_Debut", "Date_Debut")
							,new System.Data.Common.DataColumnMapping("Date_Fin", "Date_Fin")
							...
							,new System.Data.Common.DataColumnMapping("IsRistourne", "IsRistourne")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Ajustement.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Ajustement", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Ajustement", startRecord, maxRecords);
		}
