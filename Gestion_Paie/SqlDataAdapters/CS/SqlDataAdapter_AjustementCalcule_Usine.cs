...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [AjustementCalcule_Usine] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_AjustementCalcule_Usine {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AjustementCalcule_Usine class.
		...
		public SqlDataAdapter_AjustementCalcule_Usine(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "AjustementCalcule_Usine", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AjustementCalcule_Usine class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_AjustementCalcule_Usine(string connectionString, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(connectionString) {

			this.Configure(FK_AjustementID, FK_EssenceID, FK_UniteID, FK_LivraisonDetailID, FK_UsineID, FK_FactureID, FK_Code, tableName);
		}
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AjustementCalcule_Usine class.
		/// The table name in the DataSet will be: AjustementCalcule_Usine
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AjustementID">Value for this foreign key.</param>
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_AjustementCalcule_Usine(string connectionString, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code) : this(connectionString) {

			this.Configure(FK_AjustementID, FK_EssenceID, FK_UniteID, FK_LivraisonDetailID, FK_UsineID, FK_FactureID, FK_Code, "AjustementCalcule_Usine");
		}
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code) : this(sqlConnection) {
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_AjustementCalcule_Usine(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code) : this(sqlTransaction) {
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlInt32 FK_LivraisonDetailID, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlString FK_Code, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_AjustementCalcule_Usine)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AjustementCalcule_Usine";
			...
			sqlInsertCommand.CommandText = "spI_AjustementCalcule_Usine";
			...
			sqlUpdateCommand.CommandText = "spU_AjustementCalcule_Usine";
			...
			sqlDeleteCommand.CommandText = "spD_AjustementCalcule_Usine";
		...
		///the populated table name in the DataSet will be: AjustementCalcule_Usine.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AjustementCalcule_Usine", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AjustementCalcule_Usine", startRecord, maxRecords);
		}
