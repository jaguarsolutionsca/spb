...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Ajustement_EssenceUnite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Ajustement_EssenceUnite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Ajustement_EssenceUnite class.
		...
		public SqlDataAdapter_Ajustement_EssenceUnite(string connectionString) {
		...
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Ajustement_EssenceUnite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Ajustement_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(connectionString) {

			this.Configure(FK_AjustementID, FK_EssenceID, FK_UniteID, FK_ContratID, FK_Code, tableName);
		}
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Ajustement_EssenceUnite class.
		/// The table name in the DataSet will be: Ajustement_EssenceUnite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AjustementID">Value for this foreign key.</param>
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code) : this(connectionString) {

			this.Configure(FK_AjustementID, FK_EssenceID, FK_UniteID, FK_ContratID, FK_Code, "Ajustement_EssenceUnite");
		}
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code) : this(sqlConnection) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public SqlDataAdapter_Ajustement_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code) : this(sqlTransaction) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_Code">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_AjustementID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_Code, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Ajustement_EssenceUnite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Ajustement_EssenceUnite";
			...
			sqlInsertCommand.CommandText = "spI_Ajustement_EssenceUnite";
			...
			sqlUpdateCommand.CommandText = "spU_Ajustement_EssenceUnite";
			...
			sqlDeleteCommand.CommandText = "spD_Ajustement_EssenceUnite";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Date_Modification", "Date_Modification")
		...
		///the populated table name in the DataSet will be: Ajustement_EssenceUnite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Ajustement_EssenceUnite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Ajustement_EssenceUnite", startRecord, maxRecords);
		}
