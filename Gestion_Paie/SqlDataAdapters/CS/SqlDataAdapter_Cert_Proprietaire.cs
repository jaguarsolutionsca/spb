...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Cert_Proprietaire] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Cert_Proprietaire {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Cert_Proprietaire class.
		...
		public SqlDataAdapter_Cert_Proprietaire(string connectionString) {
		...
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Cert_Proprietaire class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Cert_Proprietaire(string connectionString, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(connectionString) {

			this.Configure(FK_FournisseurID, tableName);
		}
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Cert_Proprietaire class.
		/// The table name in the DataSet will be: Cert_Proprietaire
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Cert_Proprietaire(string connectionString, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(connectionString) {

			this.Configure(FK_FournisseurID, "Cert_Proprietaire");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Cert_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_FournisseurID) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Cert_Proprietaire)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Cert_Proprietaire";
			...
			sqlInsertCommand.CommandText = "spI_Cert_Proprietaire";
			...
			sqlUpdateCommand.CommandText = "spU_Cert_Proprietaire";
			...
			sqlDeleteCommand.CommandText = "spD_Cert_Proprietaire";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Agence", "Agence")
							,new System.Data.Common.DataColumnMapping("NO_ACT", "NO_ACT")
							,new System.Data.Common.DataColumnMapping("Nom", "Nom")
							,new System.Data.Common.DataColumnMapping("Representant", "Representant")
							,new System.Data.Common.DataColumnMapping("ADRESSE", "ADRESSE")
							,new System.Data.Common.DataColumnMapping("Ville", "Ville")
							,new System.Data.Common.DataColumnMapping("CODE_POST", "CODE_POST")
							,new System.Data.Common.DataColumnMapping("TEL_RES", "TEL_RES")
							,new System.Data.Common.DataColumnMapping("TEL_BUR", "TEL_BUR")
							,new System.Data.Common.DataColumnMapping("FournisseurID", "FournisseurID")
							,new System.Data.Common.DataColumnMapping("FournisseurNom", "FournisseurNom")
							,new System.Data.Common.DataColumnMapping("Traite", "Traite")
							,new System.Data.Common.DataColumnMapping("Methode", "Methode")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Cert_Proprietaire.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Cert_Proprietaire", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Cert_Proprietaire", startRecord, maxRecords);
		}
