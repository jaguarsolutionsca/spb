...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Compte] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Compte {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Compte class.
		...
		public SqlDataAdapter_Compte(string connectionString) {
		...
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Compte class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Compte(string connectionString, System.Data.SqlTypes.SqlInt32 FK_CategoryID, string tableName) : this(connectionString) {

			this.Configure(FK_CategoryID, tableName);
		}
		...
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_CategoryID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_CategoryID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Compte class.
		/// The table name in the DataSet will be: Compte
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		public SqlDataAdapter_Compte(string connectionString, System.Data.SqlTypes.SqlInt32 FK_CategoryID) : this(connectionString) {

			this.Configure(FK_CategoryID, "Compte");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_CategoryID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		public SqlDataAdapter_Compte(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_CategoryID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_CategoryID) {
		...
		/// <param name="FK_CategoryID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_CategoryID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Compte)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Compte";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_CategoryID.IsNull) {

				sqlParameter.Value = FK_CategoryID;
			}
			...
			sqlInsertCommand.CommandText = "spI_Compte";
			...
			sqlUpdateCommand.CommandText = "spU_Compte";
			...
			sqlDeleteCommand.CommandText = "spD_Compte";
		...
		///the populated table name in the DataSet will be: Compte.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Compte", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Compte", startRecord, maxRecords);
		}
