...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contingentement_Demande] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contingentement_Demande {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contingentement_Demande class.
		...
		public SqlDataAdapter_Contingentement_Demande(string connectionString) {
		...
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_Demande class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Contingentement_Demande(string connectionString, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID, string tableName) : this(connectionString) {

			this.Configure(FK_ProducteurID, FK_TransporteurID, tableName);
		}
		...
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_Demande class.
		/// The table name in the DataSet will be: Contingentement_Demande
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Demande(string connectionString, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID) : this(connectionString) {

			this.Configure(FK_ProducteurID, FK_TransporteurID, "Contingentement_Demande");
		}
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID) : this(sqlConnection) {
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Demande(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID) : this(sqlTransaction) {
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID) {
		...
		/// <param name="FK_TransporteurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlString FK_TransporteurID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contingentement_Demande)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contingentement_Demande";
			...
			sqlInsertCommand.CommandText = "spI_Contingentement_Demande";
			...
			sqlUpdateCommand.CommandText = "spU_Contingentement_Demande";
			...
			sqlDeleteCommand.CommandText = "spD_Contingentement_Demande";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("DateModification", "DateModification")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Contingentement_Demande.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_Demande", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_Demande", startRecord, maxRecords);
		}
