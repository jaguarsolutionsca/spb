...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contingentement_Unite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contingentement_Unite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contingentement_Unite class.
		...
		public SqlDataAdapter_Contingentement_Unite(string connectionString) {
		...
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_Unite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Contingentement_Unite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(connectionString) {

			this.Configure(FK_ContingentementID, FK_UniteID, tableName);
		}
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_Unite class.
		/// The table name in the DataSet will be: Contingentement_Unite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Unite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID) : this(connectionString) {

			this.Configure(FK_ContingentementID, FK_UniteID, "Contingentement_Unite");
		}
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlConnection) {
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlTransaction) {
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ContingentementID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contingentement_Unite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contingentement_Unite";
			...
			sqlInsertCommand.CommandText = "spI_Contingentement_Unite";
			...
			sqlUpdateCommand.CommandText = "spU_Contingentement_Unite";
			...
			sqlDeleteCommand.CommandText = "spD_Contingentement_Unite";
		...
		///the populated table name in the DataSet will be: Contingentement_Unite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_Unite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_Unite", startRecord, maxRecords);
		}
