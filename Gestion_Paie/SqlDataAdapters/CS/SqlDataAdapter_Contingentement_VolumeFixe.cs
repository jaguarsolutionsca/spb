...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contingentement_VolumeFixe] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contingentement_VolumeFixe {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contingentement_VolumeFixe class.
		...
		public SqlDataAdapter_Contingentement_VolumeFixe(string connectionString) {
		...
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_VolumeFixe class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Contingentement_VolumeFixe(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, string tableName) : this(connectionString) {

			this.Configure(FK_ContingentementID, tableName);
		}
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ContingentementID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contingentement_VolumeFixe class.
		/// The table name in the DataSet will be: Contingentement_VolumeFixe
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_VolumeFixe(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ContingentementID) : this(connectionString) {

			this.Configure(FK_ContingentementID, "Contingentement_VolumeFixe");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ContingentementID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		public SqlDataAdapter_Contingentement_VolumeFixe(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ContingentementID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ContingentementID) {
		...
		/// <param name="FK_ContingentementID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ContingentementID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contingentement_VolumeFixe)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contingentement_VolumeFixe";
			...
			sqlInsertCommand.CommandText = "spI_Contingentement_VolumeFixe";
			...
			sqlUpdateCommand.CommandText = "spU_Contingentement_VolumeFixe";
			...
			sqlDeleteCommand.CommandText = "spD_Contingentement_VolumeFixe";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "Contingentement_VolumeFixe"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("ContingentementID", "ContingentementID")
							,new System.Data.Common.DataColumnMapping("Superficie_Min", "Superficie_Min")
							,new System.Data.Common.DataColumnMapping("Volume_Fixe", "Volume_Fixe")
							,new System.Data.Common.DataColumnMapping("NombreMois", "NombreMois")
							,new System.Data.Common.DataColumnMapping("UseNombreMois", "UseNombreMois")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Contingentement_VolumeFixe.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_VolumeFixe", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contingentement_VolumeFixe", startRecord, maxRecords);
		}
