...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contrat] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contrat {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contrat class.
		...
		public SqlDataAdapter_Contrat(string connectionString) {
		...
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat(string connectionString, System.Data.SqlTypes.SqlString FK_UsineID, string tableName) : this(connectionString) {

			this.Configure(FK_UsineID, tableName);
		}
		...
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_UsineID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_UsineID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat class.
		/// The table name in the DataSet will be: Contrat
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat(string connectionString, System.Data.SqlTypes.SqlString FK_UsineID) : this(connectionString) {

			this.Configure(FK_UsineID, "Contrat");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_UsineID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_UsineID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_UsineID) {
		...
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_UsineID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contrat)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contrat";
			...
			sqlInsertCommand.CommandText = "spI_Contrat";
			...
			sqlUpdateCommand.CommandText = "spU_Contrat";
			...
			sqlDeleteCommand.CommandText = "spD_Contrat";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Taux_Surcharge", "Taux_Surcharge")
							,new System.Data.Common.DataColumnMapping("SurchargeManuel", "SurchargeManuel")
							,new System.Data.Common.DataColumnMapping("TxTransSameProd", "TxTransSameProd")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Contrat.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contrat", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contrat", startRecord, maxRecords);
		}
