...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contrat_EssenceUnite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contrat_EssenceUnite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contrat_EssenceUnite class.
		...
		public SqlDataAdapter_Contrat_EssenceUnite(string connectionString) {
		...
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat_EssenceUnite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Contrat_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(connectionString) {

			this.Configure(FK_ContratID, FK_EssenceID, FK_UniteID, tableName);
		}
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat_EssenceUnite class.
		/// The table name in the DataSet will be: Contrat_EssenceUnite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(connectionString) {

			this.Configure(FK_ContratID, FK_EssenceID, FK_UniteID, "Contrat_EssenceUnite");
		}
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlConnection) {
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlTransaction) {
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contrat_EssenceUnite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contrat_EssenceUnite";
			...
			sqlInsertCommand.CommandText = "spI_Contrat_EssenceUnite";
			...
			sqlUpdateCommand.CommandText = "spU_Contrat_EssenceUnite";
			...
			sqlDeleteCommand.CommandText = "spD_Contrat_EssenceUnite";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Quantite_prevue", "Quantite_prevue")
		...
		///the populated table name in the DataSet will be: Contrat_EssenceUnite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contrat_EssenceUnite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contrat_EssenceUnite", startRecord, maxRecords);
		}
