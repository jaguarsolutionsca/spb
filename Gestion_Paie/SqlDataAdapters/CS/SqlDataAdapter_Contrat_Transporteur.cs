...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Contrat_Transporteur] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Contrat_Transporteur {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Contrat_Transporteur class.
		...
		public SqlDataAdapter_Contrat_Transporteur(string connectionString) {
		...
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat_Transporteur class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Contrat_Transporteur(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(connectionString) {

			this.Configure(FK_ContratID, FK_UniteID, FK_MunicipaliteID, FK_ZoneID, tableName);
		}
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Contrat_Transporteur class.
		/// The table name in the DataSet will be: Contrat_Transporteur
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_Transporteur(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(connectionString) {

			this.Configure(FK_ContratID, FK_UniteID, FK_MunicipaliteID, FK_ZoneID, "Contrat_Transporteur");
		}
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(sqlConnection) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Contrat_Transporteur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(sqlTransaction) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) {
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_UniteID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Contrat_Transporteur)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Contrat_Transporteur";
			...
			sqlInsertCommand.CommandText = "spI_Contrat_Transporteur";
			...
			sqlUpdateCommand.CommandText = "spU_Contrat_Transporteur";
			...
			sqlDeleteCommand.CommandText = "spD_Contrat_Transporteur";
		...
		///the populated table name in the DataSet will be: Contrat_Transporteur.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Contrat_Transporteur", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Contrat_Transporteur", startRecord, maxRecords);
		}
