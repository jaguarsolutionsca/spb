...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Essence] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Essence {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Essence class.
		...
		public SqlDataAdapter_Essence(string connectionString) {
		...
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Essence class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_RegroupementID">Value for this foreign key.</param>
		/// <param name="FK_ContingentID">Value for this foreign key.</param>
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Essence(string connectionString, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID, string tableName) : this(connectionString) {

			this.Configure(FK_RegroupementID, FK_ContingentID, FK_RepartitionID, tableName);
		}
		...
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Essence class.
		/// The table name in the DataSet will be: Essence
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_RegroupementID">Value for this foreign key.</param>
		/// <param name="FK_ContingentID">Value for this foreign key.</param>
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence(string connectionString, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID) : this(connectionString) {

			this.Configure(FK_RegroupementID, FK_ContingentID, FK_RepartitionID, "Essence");
		}
		...
		/// <param name="FK_ContingentID">Value for this foreign key.</param>
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID) : this(sqlConnection) {
		...
		/// <param name="FK_ContingentID">Value for this foreign key.</param>
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID) : this(sqlTransaction) {
		...
		/// <param name="FK_ContingentID">Value for this foreign key.</param>
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID) {
		...
		/// <param name="FK_RepartitionID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_RegroupementID, System.Data.SqlTypes.SqlInt32 FK_ContingentID, System.Data.SqlTypes.SqlInt32 FK_RepartitionID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Essence)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Essence";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_RepartitionID.IsNull) {

				sqlParameter.Value = FK_RepartitionID;
			}
			...
			sqlInsertCommand.CommandText = "spI_Essence";
			...
			sqlUpdateCommand.CommandText = "spU_Essence";
			...
			sqlDeleteCommand.CommandText = "spD_Essence";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("RepartitionID", "RepartitionID")
		...
		///the populated table name in the DataSet will be: Essence.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Essence", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Essence", startRecord, maxRecords);
		}
