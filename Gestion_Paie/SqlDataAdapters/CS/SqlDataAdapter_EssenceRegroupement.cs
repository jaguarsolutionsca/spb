...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [EssenceRegroupement] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_EssenceRegroupement {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_EssenceRegroupement class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_EssenceRegroupement(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "EssenceRegroupement", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif

			this.Configure("EssenceRegroupement");
		}
		...
		public SqlDataAdapter_EssenceRegroupement(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_EssenceRegroupement(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_EssenceRegroupement class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_EssenceRegroupement(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_EssenceRegroupement(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_EssenceRegroupement(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: EssenceRegroupement
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_EssenceRegroupement)");
					}
			...
			sqlSelectCommand.CommandText = "spS_EssenceRegroupement";
			...
			sqlInsertCommand.CommandText = "spI_EssenceRegroupement";
			...
			sqlUpdateCommand.CommandText = "spU_EssenceRegroupement";
			...
			sqlDeleteCommand.CommandText = "spD_EssenceRegroupement";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Ordre", "Ordre")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: EssenceRegroupement.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "EssenceRegroupement", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "EssenceRegroupement", startRecord, maxRecords);
		}
