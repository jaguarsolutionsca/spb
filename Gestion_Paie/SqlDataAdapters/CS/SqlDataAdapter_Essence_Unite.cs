...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Essence_Unite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Essence_Unite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Essence_Unite class.
		...
		public SqlDataAdapter_Essence_Unite(string connectionString) {
		...
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Essence_Unite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Essence_Unite(string connectionString, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(connectionString) {

			this.Configure(FK_EssenceID, FK_UniteID, tableName);
		}
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Essence_Unite class.
		/// The table name in the DataSet will be: Essence_Unite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence_Unite(string connectionString, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(connectionString) {

			this.Configure(FK_EssenceID, FK_UniteID, "Essence_Unite");
		}
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlConnection) {
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Essence_Unite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlTransaction) {
		...
		/// <param name="FK_EssenceID">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Essence_Unite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Essence_Unite";
			...
			sqlInsertCommand.CommandText = "spI_Essence_Unite";
			...
			sqlUpdateCommand.CommandText = "spU_Essence_Unite";
			...
			sqlDeleteCommand.CommandText = "spD_Essence_Unite";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Facteur_M3app", "Facteur_M3app")
							,new System.Data.Common.DataColumnMapping("Facteur_M3sol", "Facteur_M3sol")
							,new System.Data.Common.DataColumnMapping("Facteur_FPBQ", "Facteur_FPBQ")
							,new System.Data.Common.DataColumnMapping("Actif", "Actif")
							,new System.Data.Common.DataColumnMapping("Preleve_plan_conjoint", "Preleve_plan_conjoint")
							,new System.Data.Common.DataColumnMapping("Preleve_plan_conjoint_Override", "Preleve_plan_conjoint_Override")
							,new System.Data.Common.DataColumnMapping("Preleve_fond_roulement", "Preleve_fond_roulement")
							,new System.Data.Common.DataColumnMapping("Preleve_fond_roulement_Override", "Preleve_fond_roulement_Override")
							,new System.Data.Common.DataColumnMapping("Preleve_fond_forestier", "Preleve_fond_forestier")
							,new System.Data.Common.DataColumnMapping("Preleve_fond_forestier_Override", "Preleve_fond_forestier_Override")
							,new System.Data.Common.DataColumnMapping("Preleve_divers", "Preleve_divers")
							,new System.Data.Common.DataColumnMapping("Preleve_divers_Override", "Preleve_divers_Override")
							,new System.Data.Common.DataColumnMapping("UseMontant", "UseMontant")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: Essence_Unite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Essence_Unite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Essence_Unite", startRecord, maxRecords);
		}
