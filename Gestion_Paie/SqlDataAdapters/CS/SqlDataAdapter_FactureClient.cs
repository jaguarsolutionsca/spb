...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [FactureClient] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_FactureClient {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_FactureClient class.
		...
		public SqlDataAdapter_FactureClient(string connectionString) {
		...
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TypeFacture">Value for this foreign key.</param>
		/// <param name="FK_TypeInvoiceClientAcomba">Value for this foreign key.</param>
		/// <param name="FK_ClientID">Value for this foreign key.</param>
		...
		public SqlDataAdapter_FactureClient(string connectionString, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status, string tableName) : this(connectionString) {

			this.Configure(FK_TypeFacture, FK_TypeInvoiceClientAcomba, FK_ClientID, FK_PayerAID, FK_Status, tableName);
		}
		...
		/// <param name="FK_Status">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Status">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient class.
		/// The table name in the DataSet will be: FactureClient
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TypeFacture">Value for this foreign key.</param>
		/// <param name="FK_TypeInvoiceClientAcomba">Value for this foreign key.</param>
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="FK_Status">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient(string connectionString, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status) : this(connectionString) {

			this.Configure(FK_TypeFacture, FK_TypeInvoiceClientAcomba, FK_ClientID, FK_PayerAID, FK_Status, "FactureClient");
		}
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="FK_Status">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status) : this(sqlConnection) {
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="FK_Status">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status) : this(sqlTransaction) {
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="FK_Status">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status) {
		...
		/// <param name="FK_Status">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceClientAcomba, System.Data.SqlTypes.SqlString FK_ClientID, System.Data.SqlTypes.SqlString FK_PayerAID, System.Data.SqlTypes.SqlString FK_Status, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_FactureClient)");
					}
			...
			sqlSelectCommand.CommandText = "spS_FactureClient";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TypeInvoiceClientAcomba.IsNull) {

				sqlParameter.Value = FK_TypeInvoiceClientAcomba;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ClientID.IsNull) {

				sqlParameter.Value = FK_ClientID;
			}
			...
			sqlInsertCommand.CommandText = "spI_FactureClient";
			...
			sqlUpdateCommand.CommandText = "spU_FactureClient";
			...
			sqlDeleteCommand.CommandText = "spD_FactureClient";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("TypeInvoiceClientAcomba", "TypeInvoiceClientAcomba")
		...
		///the populated table name in the DataSet will be: FactureClient.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "FactureClient", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "FactureClient", startRecord, maxRecords);
		}
