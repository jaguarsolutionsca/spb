...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [FactureClient_Details] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_FactureClient_Details {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_FactureClient_Details class.
		...
		public SqlDataAdapter_FactureClient_Details(string connectionString) {
		...
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient_Details class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_FactureClient_Details(string connectionString, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(connectionString) {
		...
		/// <param name="FK_Compte">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Compte">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient_Details class.
		/// The table name in the DataSet will be: FactureClient_Details
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Details(string connectionString, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(connectionString) {

			this.Configure(FK_FactureID, FK_Compte, "FactureClient_Details");
		}
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(sqlConnection) {
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Details(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_FactureClient_Details)");
					}
			...
			sqlSelectCommand.CommandText = "spS_FactureClient_Details";
			...
			sqlInsertCommand.CommandText = "spI_FactureClient_Details";
			...
			sqlUpdateCommand.CommandText = "spU_FactureClient_Details";
			...
			sqlDeleteCommand.CommandText = "spD_FactureClient_Details";
		...
		///the populated table name in the DataSet will be: FactureClient_Details.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "FactureClient_Details", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "FactureClient_Details", startRecord, maxRecords);
		}
