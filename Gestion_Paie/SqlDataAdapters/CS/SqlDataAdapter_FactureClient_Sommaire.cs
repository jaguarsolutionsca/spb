...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [FactureClient_Sommaire] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_FactureClient_Sommaire {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_FactureClient_Sommaire class.
		...
		public SqlDataAdapter_FactureClient_Sommaire(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "FactureClient_Sommaire", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient_Sommaire class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_FactureClient_Sommaire(string connectionString, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(connectionString) {
		...
		/// <param name="FK_Compte">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Compte">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureClient_Sommaire class.
		/// The table name in the DataSet will be: FactureClient_Sommaire
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Sommaire(string connectionString, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(connectionString) {

			this.Configure(FK_FactureID, FK_Compte, "FactureClient_Sommaire");
		}
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(sqlConnection) {
		...
		/// <param name="FK_FactureID">Value for this foreign key.</param>
		/// <param name="FK_Compte">Value for this foreign key.</param>
		public SqlDataAdapter_FactureClient_Sommaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_FactureID, System.Data.SqlTypes.SqlInt32 FK_Compte, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_FactureClient_Sommaire)");
					}
			...
			sqlSelectCommand.CommandText = "spS_FactureClient_Sommaire";
			...
			sqlInsertCommand.CommandText = "spI_FactureClient_Sommaire";
			...
			sqlUpdateCommand.CommandText = "spU_FactureClient_Sommaire";
			...
			sqlDeleteCommand.CommandText = "spD_FactureClient_Sommaire";
		...
		///the populated table name in the DataSet will be: FactureClient_Sommaire.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "FactureClient_Sommaire", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "FactureClient_Sommaire", startRecord, maxRecords);
		}
