...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [FactureFournisseur] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_FactureFournisseur {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_FactureFournisseur class.
		...
		public SqlDataAdapter_FactureFournisseur(string connectionString) {
		...
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureFournisseur class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TypeFactureFournisseur">Value for this foreign key.</param>
		/// <param name="FK_TypeFacture">Value for this foreign key.</param>
		/// <param name="FK_TypeInvoiceAcomba">Value for this foreign key.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureFournisseur(string connectionString, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID, string tableName) : this(connectionString) {

			this.Configure(FK_TypeFactureFournisseur, FK_TypeFacture, FK_TypeInvoiceAcomba, FK_FournisseurID, FK_PayerAID, tableName);
		}
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureFournisseur class.
		/// The table name in the DataSet will be: FactureFournisseur
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TypeFactureFournisseur">Value for this foreign key.</param>
		/// <param name="FK_TypeFacture">Value for this foreign key.</param>
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureFournisseur(string connectionString, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID) : this(connectionString) {

			this.Configure(FK_TypeFactureFournisseur, FK_TypeFacture, FK_TypeInvoiceAcomba, FK_FournisseurID, FK_PayerAID, "FactureFournisseur");
		}
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID) : this(sqlConnection) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureFournisseur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID) : this(sqlTransaction) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID) {
		...
		/// <param name="FK_PayerAID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_TypeFactureFournisseur, System.Data.SqlTypes.SqlString FK_TypeFacture, System.Data.SqlTypes.SqlInt32 FK_TypeInvoiceAcomba, System.Data.SqlTypes.SqlString FK_FournisseurID, System.Data.SqlTypes.SqlString FK_PayerAID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_FactureFournisseur)");
					}
			...
			sqlSelectCommand.CommandText = "spS_FactureFournisseur";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TypeFactureFournisseur.IsNull) {

				sqlParameter.Value = FK_TypeFactureFournisseur;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TypeFacture.IsNull) {

				sqlParameter.Value = FK_TypeFacture;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TypeInvoiceAcomba.IsNull) {

				sqlParameter.Value = FK_TypeInvoiceAcomba;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_PayerAID.IsNull) {

				sqlParameter.Value = FK_PayerAID;
			}
			...
			sqlInsertCommand.CommandText = "spI_FactureFournisseur";
			...
			sqlUpdateCommand.CommandText = "spU_FactureFournisseur";
			...
			sqlDeleteCommand.CommandText = "spD_FactureFournisseur";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("NoFacture", "NoFacture")
							,new System.Data.Common.DataColumnMapping("DateFacture", "DateFacture")
							,new System.Data.Common.DataColumnMapping("Annee", "Annee")
							,new System.Data.Common.DataColumnMapping("TypeFactureFournisseur", "TypeFactureFournisseur")
							,new System.Data.Common.DataColumnMapping("TypeFacture", "TypeFacture")
							,new System.Data.Common.DataColumnMapping("TypeInvoiceAcomba", "TypeInvoiceAcomba")
							...
							,new System.Data.Common.DataColumnMapping("Montant_Total", "Montant_Total")
							,new System.Data.Common.DataColumnMapping("Montant_TPS", "Montant_TPS")
							,new System.Data.Common.DataColumnMapping("Montant_TVQ", "Montant_TVQ")
							,new System.Data.Common.DataColumnMapping("Description", "Description")
							,new System.Data.Common.DataColumnMapping("Status", "Status")
							,new System.Data.Common.DataColumnMapping("StatusDescription", "StatusDescription")
							,new System.Data.Common.DataColumnMapping("NumeroCheque", "NumeroCheque")
							,new System.Data.Common.DataColumnMapping("NumeroPaiement", "NumeroPaiement")
							,new System.Data.Common.DataColumnMapping("NumeroPaiementUnique", "NumeroPaiementUnique")
							,new System.Data.Common.DataColumnMapping("DateFactureAcomba", "DateFactureAcomba")
							,new System.Data.Common.DataColumnMapping("DatePaiementAcomba", "DatePaiementAcomba")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: FactureFournisseur.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "FactureFournisseur", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "FactureFournisseur", startRecord, maxRecords);
		}
