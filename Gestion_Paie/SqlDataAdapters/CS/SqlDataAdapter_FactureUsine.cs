...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [FactureUsine] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_FactureUsine {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_FactureUsine class.
		...
		public SqlDataAdapter_FactureUsine(string connectionString) {
		...
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureUsine class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_FactureUsine(string connectionString, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(connectionString) {

			this.Configure(FK_Annee, FK_Periode, FK_ContratID, tableName);
		}
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_FactureUsine class.
		/// The table name in the DataSet will be: FactureUsine
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_Annee">Value for this foreign key.</param>
		/// <param name="FK_Periode">Value for this foreign key.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureUsine(string connectionString, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID) : this(connectionString) {

			this.Configure(FK_Annee, FK_Periode, FK_ContratID, "FactureUsine");
		}
		...
		/// <param name="FK_Periode">Value for this foreign key.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID) : this(sqlConnection) {
		...
		/// <param name="FK_Periode">Value for this foreign key.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public SqlDataAdapter_FactureUsine(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID) : this(sqlTransaction) {
		...
		/// <param name="FK_Periode">Value for this foreign key.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_Annee, System.Data.SqlTypes.SqlInt32 FK_Periode, System.Data.SqlTypes.SqlString FK_ContratID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_FactureUsine)");
					}
			...
			sqlSelectCommand.CommandText = "spS_FactureUsine";
			...
			sqlInsertCommand.CommandText = "spI_FactureUsine";
			...
			sqlUpdateCommand.CommandText = "spU_FactureUsine";
			...
			sqlDeleteCommand.CommandText = "spD_FactureUsine";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("DatePermis", "DatePermis")
							...
							,new System.Data.Common.DataColumnMapping("Livraison", "Livraison")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: FactureUsine.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "FactureUsine", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "FactureUsine", startRecord, maxRecords);
		}
