...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Fournisseur_Camion] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Fournisseur_Camion {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Fournisseur_Camion class.
		...
		public SqlDataAdapter_Fournisseur_Camion(string connectionString) {
		...
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Fournisseur_Camion class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Fournisseur_Camion(string connectionString, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(connectionString) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Fournisseur_Camion class.
		/// The table name in the DataSet will be: Fournisseur_Camion
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Fournisseur_Camion(string connectionString, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(connectionString) {

			this.Configure(FK_FournisseurID, "Fournisseur_Camion");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_FournisseurID">Value for this foreign key.</param>
		public SqlDataAdapter_Fournisseur_Camion(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_FournisseurID) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlString FK_FournisseurID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Fournisseur_Camion)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Fournisseur_Camion";
			...
			sqlInsertCommand.CommandText = "spI_Fournisseur_Camion";
			...
			sqlUpdateCommand.CommandText = "spU_Fournisseur_Camion";
			...
			sqlDeleteCommand.CommandText = "spD_Fournisseur_Camion";
		...
		///the populated table name in the DataSet will be: Fournisseur_Camion.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Fournisseur_Camion", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Fournisseur_Camion", startRecord, maxRecords);
		}
