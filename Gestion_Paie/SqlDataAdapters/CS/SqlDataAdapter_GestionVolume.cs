...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [GestionVolume] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_GestionVolume {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_GestionVolume class.
		...
		public SqlDataAdapter_GestionVolume(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "GestionVolume", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_GestionVolume class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_GestionVolume(string connectionString, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(connectionString) {

			this.Configure(FK_UsineID, FK_UniteMesureID, FK_ProducteurID, FK_LotID, tableName);
		}
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_GestionVolume class.
		/// The table name in the DataSet will be: GestionVolume
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UsineID">Value for this foreign key.</param>
		/// <param name="FK_UniteMesureID">Value for this foreign key.</param>
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_GestionVolume(string connectionString, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(connectionString) {

			this.Configure(FK_UsineID, FK_UniteMesureID, FK_ProducteurID, FK_LotID, "GestionVolume");
		}
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(sqlConnection) {
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_GestionVolume(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(sqlTransaction) {
		...
		/// <param name="FK_ProducteurID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID) {
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_UsineID, System.Data.SqlTypes.SqlString FK_UniteMesureID, System.Data.SqlTypes.SqlString FK_ProducteurID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_GestionVolume)");
					}
			...
			sqlSelectCommand.CommandText = "spS_GestionVolume";
			...
			sqlInsertCommand.CommandText = "spI_GestionVolume";
			...
			sqlUpdateCommand.CommandText = "spU_GestionVolume";
			...
			sqlDeleteCommand.CommandText = "spD_GestionVolume";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("DateEntree", "DateEntree")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: GestionVolume.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "GestionVolume", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "GestionVolume", startRecord, maxRecords);
		}
