...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Indexation] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Indexation {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Indexation class.
		...
		public SqlDataAdapter_Indexation(string connectionString) {
		...
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Indexation(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation, string tableName) : this(connectionString) {

			this.Configure(FK_ContratID, FK_TypeIndexation, tableName);
		}
		...
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation class.
		/// The table name in the DataSet will be: Indexation
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation(string connectionString, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation) : this(connectionString) {

			this.Configure(FK_ContratID, FK_TypeIndexation, "Indexation");
		}
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation) : this(sqlConnection) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation) : this(sqlTransaction) {
		...
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation) {
		...
		/// <param name="FK_TypeIndexation">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_TypeIndexation, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Indexation)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Indexation";
			...
			sqlInsertCommand.CommandText = "spI_Indexation";
			...
			sqlUpdateCommand.CommandText = "spU_Indexation";
			...
			sqlDeleteCommand.CommandText = "spD_Indexation";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("DateIndexation", "DateIndexation")
							...
							,new System.Data.Common.DataColumnMapping("IndexationTransporteur", "IndexationTransporteur")
		...
		///the populated table name in the DataSet will be: Indexation.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Indexation", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Indexation", startRecord, maxRecords);
		}
