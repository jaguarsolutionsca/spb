...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Indexation_EssenceUnite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Indexation_EssenceUnite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Indexation_EssenceUnite class.
		...
		public SqlDataAdapter_Indexation_EssenceUnite(string connectionString) {
		...
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation_EssenceUnite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Indexation_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(connectionString) {

			this.Configure(FK_IndexationID, FK_ContratID, FK_EssenceID, FK_Code, FK_UniteID, tableName);
		}
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation_EssenceUnite class.
		/// The table name in the DataSet will be: Indexation_EssenceUnite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_IndexationID">Value for this foreign key.</param>
		/// <param name="FK_ContratID">Value for this foreign key.</param>
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_EssenceUnite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID) : this(connectionString) {

			this.Configure(FK_IndexationID, FK_ContratID, FK_EssenceID, FK_Code, FK_UniteID, "Indexation_EssenceUnite");
		}
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlConnection) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_EssenceUnite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID) : this(sqlTransaction) {
		...
		/// <param name="FK_Code">Value for this foreign key.</param>
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID) {
		...
		/// <param name="FK_UniteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_ContratID, System.Data.SqlTypes.SqlString FK_EssenceID, System.Data.SqlTypes.SqlString FK_Code, System.Data.SqlTypes.SqlString FK_UniteID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Indexation_EssenceUnite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Indexation_EssenceUnite";
			...
			sqlInsertCommand.CommandText = "spI_Indexation_EssenceUnite";
			...
			sqlUpdateCommand.CommandText = "spU_Indexation_EssenceUnite";
			...
			sqlDeleteCommand.CommandText = "spD_Indexation_EssenceUnite";
		...
		///the populated table name in the DataSet will be: Indexation_EssenceUnite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Indexation_EssenceUnite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Indexation_EssenceUnite", startRecord, maxRecords);
		}
