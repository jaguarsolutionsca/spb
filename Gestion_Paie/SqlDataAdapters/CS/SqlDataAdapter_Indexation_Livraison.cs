...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Indexation_Livraison] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Indexation_Livraison {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Indexation_Livraison class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_Indexation_Livraison(string connectionString) {
			...
			this.Configure("Indexation_Livraison");
		}
		...
		public SqlDataAdapter_Indexation_Livraison(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Indexation_Livraison(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation_Livraison class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_Livraison(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_Livraison(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_Livraison(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: Indexation_Livraison
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Indexation_Livraison)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Indexation_Livraison";
			...
			sqlInsertCommand.CommandText = "spI_Indexation_Livraison";
			...
			sqlUpdateCommand.CommandText = "spU_Indexation_Livraison";
			...
			sqlDeleteCommand.CommandText = "spD_Indexation_Livraison";
		...
		///the populated table name in the DataSet will be: Indexation_Livraison.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Indexation_Livraison", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Indexation_Livraison", startRecord, maxRecords);
		}
