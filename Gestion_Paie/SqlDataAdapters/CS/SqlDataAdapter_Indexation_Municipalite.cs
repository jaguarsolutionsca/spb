...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Indexation_Municipalite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Indexation_Municipalite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Indexation_Municipalite class.
		...
		public SqlDataAdapter_Indexation_Municipalite(string connectionString) {
		...
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation_Municipalite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Indexation_Municipalite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(connectionString) {

			this.Configure(FK_IndexationID, FK_MunicipaliteID, FK_ZoneID, tableName);
		}
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Indexation_Municipalite class.
		/// The table name in the DataSet will be: Indexation_Municipalite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_IndexationID">Value for this foreign key.</param>
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_Municipalite(string connectionString, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(connectionString) {

			this.Configure(FK_IndexationID, FK_MunicipaliteID, FK_ZoneID, "Indexation_Municipalite");
		}
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(sqlConnection) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public SqlDataAdapter_Indexation_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) : this(sqlTransaction) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID) {
		...
		/// <param name="FK_ZoneID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_IndexationID, System.Data.SqlTypes.SqlString FK_MunicipaliteID, System.Data.SqlTypes.SqlString FK_ZoneID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Indexation_Municipalite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Indexation_Municipalite";
			...
			sqlInsertCommand.CommandText = "spI_Indexation_Municipalite";
			...
			sqlUpdateCommand.CommandText = "spU_Indexation_Municipalite";
			...
			sqlDeleteCommand.CommandText = "spD_Indexation_Municipalite";
		...
		///the populated table name in the DataSet will be: Indexation_Municipalite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Indexation_Municipalite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Indexation_Municipalite", startRecord, maxRecords);
		}
