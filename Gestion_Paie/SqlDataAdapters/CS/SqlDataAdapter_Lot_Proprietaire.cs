...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Lot_Proprietaire] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Lot_Proprietaire {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Lot_Proprietaire class.
		...
		public SqlDataAdapter_Lot_Proprietaire(string connectionString) {
		...
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Lot_Proprietaire class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Lot_Proprietaire(string connectionString, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(connectionString) {

			this.Configure(FK_ProprietaireID, FK_LotID, tableName);
		}
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Lot_Proprietaire class.
		/// The table name in the DataSet will be: Lot_Proprietaire
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ProprietaireID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_Lot_Proprietaire(string connectionString, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(connectionString) {

			this.Configure(FK_ProprietaireID, FK_LotID, "Lot_Proprietaire");
		}
		...
		/// <param name="FK_ProprietaireID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(sqlConnection) {
		...
		/// <param name="FK_ProprietaireID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public SqlDataAdapter_Lot_Proprietaire(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID) : this(sqlTransaction) {
		...
		/// <param name="FK_ProprietaireID">Value for this foreign key.</param>
		/// <param name="FK_LotID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID) {
		...
		/// <param name="FK_LotID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_ProprietaireID, System.Data.SqlTypes.SqlInt32 FK_LotID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Lot_Proprietaire)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Lot_Proprietaire";
			...
			sqlInsertCommand.CommandText = "spI_Lot_Proprietaire";
			...
			sqlUpdateCommand.CommandText = "spU_Lot_Proprietaire";
			...
			sqlDeleteCommand.CommandText = "spD_Lot_Proprietaire";
		...
		///the populated table name in the DataSet will be: Lot_Proprietaire.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Lot_Proprietaire", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Lot_Proprietaire", startRecord, maxRecords);
		}
