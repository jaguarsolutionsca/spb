...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Municipalite] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Municipalite {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Municipalite class.
		...
		public SqlDataAdapter_Municipalite(string connectionString) {
		...
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Municipalite class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_MrcID">Value for this foreign key.</param>
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Municipalite(string connectionString, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID, string tableName) : this(connectionString) {

			this.Configure(FK_MrcID, FK_AgenceID, tableName);
		}
		...
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Municipalite class.
		/// The table name in the DataSet will be: Municipalite
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_MrcID">Value for this foreign key.</param>
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite(string connectionString, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID) : this(connectionString) {

			this.Configure(FK_MrcID, FK_AgenceID, "Municipalite");
		}
		...
		/// <param name="FK_MrcID">Value for this foreign key.</param>
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID) : this(sqlConnection) {
		...
		/// <param name="FK_MrcID">Value for this foreign key.</param>
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID) : this(sqlTransaction) {
		...
		/// <param name="FK_MrcID">Value for this foreign key.</param>
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID) {
		...
		/// <param name="FK_AgenceID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_MrcID, System.Data.SqlTypes.SqlString FK_AgenceID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Municipalite)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Municipalite";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_AgenceID.IsNull) {

				sqlParameter.Value = FK_AgenceID;
			}
			...
			sqlInsertCommand.CommandText = "spI_Municipalite";
			...
			sqlUpdateCommand.CommandText = "spU_Municipalite";
			...
			sqlDeleteCommand.CommandText = "spD_Municipalite";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("MrcID", "MrcID")
							,new System.Data.Common.DataColumnMapping("AgenceID", "AgenceID")
		...
		///the populated table name in the DataSet will be: Municipalite.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Municipalite", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Municipalite", startRecord, maxRecords);
		}
