...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [Municipalite_Secteur] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_Municipalite_Secteur {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_Municipalite_Secteur class.
		...
		public SqlDataAdapter_Municipalite_Secteur(string connectionString) {
		...
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Municipalite_Secteur class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_Municipalite_Secteur(string connectionString, System.Data.SqlTypes.SqlString FK_MunicipaliteID, string tableName) : this(connectionString) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_MunicipaliteID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_MunicipaliteID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_Municipalite_Secteur class.
		/// The table name in the DataSet will be: Municipalite_Secteur
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite_Secteur(string connectionString, System.Data.SqlTypes.SqlString FK_MunicipaliteID) : this(connectionString) {

			this.Configure(FK_MunicipaliteID, "Municipalite_Secteur");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_MunicipaliteID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_MunicipaliteID">Value for this foreign key.</param>
		public SqlDataAdapter_Municipalite_Secteur(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_MunicipaliteID) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlString FK_MunicipaliteID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_Municipalite_Secteur)");
					}
			...
			sqlSelectCommand.CommandText = "spS_Municipalite_Secteur";
			...
			sqlInsertCommand.CommandText = "spI_Municipalite_Secteur";
			...
			sqlUpdateCommand.CommandText = "spU_Municipalite_Secteur";
			...
			sqlDeleteCommand.CommandText = "spD_Municipalite_Secteur";
		...
		///the populated table name in the DataSet will be: Municipalite_Secteur.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "Municipalite_Secteur", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "Municipalite_Secteur", startRecord, maxRecords);
		}
