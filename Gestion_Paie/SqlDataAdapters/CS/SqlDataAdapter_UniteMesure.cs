...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [UniteMesure] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_UniteMesure {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_UniteMesure class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_UniteMesure(string connectionString) {
		...
		public SqlDataAdapter_UniteMesure(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_UniteMesure(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_UniteMesure class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UniteMesure(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UniteMesure(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UniteMesure(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: UniteMesure
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_UniteMesure)");
					}
			...
			sqlSelectCommand.CommandText = "spS_UniteMesure";
			...
			sqlInsertCommand.CommandText = "spI_UniteMesure";
			...
			sqlUpdateCommand.CommandText = "spU_UniteMesure";
			...
			sqlDeleteCommand.CommandText = "spD_UniteMesure";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("Nb_decimale", "Nb_decimale")
							...
							,new System.Data.Common.DataColumnMapping("Pourc_Preleve_plan_conjoint", "Pourc_Preleve_plan_conjoint")
							,new System.Data.Common.DataColumnMapping("Pourc_Preleve_fond_roulement", "Pourc_Preleve_fond_roulement")
							,new System.Data.Common.DataColumnMapping("Pourc_Preleve_fond_forestier", "Pourc_Preleve_fond_forestier")
							,new System.Data.Common.DataColumnMapping("Pourc_Preleve_divers", "Pourc_Preleve_divers")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: UniteMesure.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "UniteMesure", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "UniteMesure", startRecord, maxRecords);
		}
