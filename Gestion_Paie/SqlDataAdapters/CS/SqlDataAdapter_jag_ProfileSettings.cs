...
namespace Gestion_Paie.SqlDataAdapters {
	...
	/// used against the [jag_ProfileSettings] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
	public sealed class SqlDataAdapter_jag_ProfileSettings {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_jag_ProfileSettings class.
		...
		public SqlDataAdapter_jag_ProfileSettings(string connectionString) {
		...
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_jag_ProfileSettings class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_jag_ProfileSettings(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ProfileID, string tableName) : this(connectionString) {

			this.Configure(FK_ProfileID, tableName);
		}
		...
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ProfileID, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ProfileID, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_jag_ProfileSettings class.
		/// The table name in the DataSet will be: jag_ProfileSettings
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		public SqlDataAdapter_jag_ProfileSettings(string connectionString, System.Data.SqlTypes.SqlInt32 FK_ProfileID) : this(connectionString) {

			this.Configure(FK_ProfileID, "jag_ProfileSettings");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlInt32 FK_ProfileID) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		public SqlDataAdapter_jag_ProfileSettings(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlInt32 FK_ProfileID) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ProfileID) {
		...
		/// <param name="FK_ProfileID">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlInt32 FK_ProfileID, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Gestion_Paie.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Gestion_Paie.SqlDataAdapters.SqlDataAdapter_jag_ProfileSettings)");
					}
			...
			sqlSelectCommand.CommandText = "spS_jag_ProfileSettings";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ProfileID.IsNull) {

				sqlParameter.Value = FK_ProfileID;
			}
			...
			sqlInsertCommand.CommandText = "spI_jag_ProfileSettings";
			...
			sqlUpdateCommand.CommandText = "spU_jag_ProfileSettings";
			...
			sqlDeleteCommand.CommandText = "spD_jag_ProfileSettings";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("ProfileID", "ProfileID")
		...
		///the populated table name in the DataSet will be: jag_ProfileSettings.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "jag_ProfileSettings", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "jag_ProfileSettings", startRecord, maxRecords);
		}
