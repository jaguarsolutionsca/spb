...
namespace BaseApp.Common
{
    internal class Crypto
    {
        ...
        public Crypto(string key)
        {
            ...
            Salt = "JaguarSolutions";               /// Salt value used along with passphrase to generate password. Salt can be any string.
            InitialVector = "@4$dGi*7/;{0jHNr";  /// For RijndaelManaged class IV must be exactly 16 ASCII characters long.
